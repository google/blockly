...
Blockly.utils.string.longestString = function(a) {
    return a.length ? a.reduce(function(a, c) {
        return a.length > c.length ? a : c
    }) : 0
};
Blockly.utils.string.commonWordPrefix = function(a, b) {
    ...
    for (var c = 0, d = b || Blockly.utils.string.shortestStringLength(a), e = 0; e < d; e++) {
        for (var g = a[0][e], h = 1; h < a.length; h++)
            if (g != a[h][e]) return c;
        " " == g && (c = e + 1)
    }
    for (h = 1; h < a.length; h++)
        if ((g = a[h][e]) && " " != g) return c;
    return d
};
Blockly.utils.string.commonWordSuffix = function(a, b) {
    ...
    if (1 == a.length) return a[0].length;
    for (var c = 0, d = b || Blockly.utils.string.shortestStringLength(a), e = 0; e < d; e++) {
        for (var g = a[0].substr(-e - 1, 1), h = 1; h < a.length; h++)
            if (g != a[h].substr(-e - 1, 1)) return c;
        " " == g && (c = e + 1)
    }
    for (h = 1; h < a.length; h++)
        if ((g = a[h].charAt(a[h].length - e - 1)) && " " != g) return c;
    return d
};
...
Blockly.utils.string.wrapLine_ = function(a, b) {
    ...
    do {
        ...
        var k = [],
            l = c.length / e,
            m = 1;
        for (d = 0; d < c.length - 1; d++) m < (d + 1.5) / l ? (m++, k[d] = !0) : k[d] = !1;
        k = Blockly.utils.string.wrapMutate_(c, k, b);
        d = Blockly.utils.string.wrapScore_(c, k, b);
        a = Blockly.utils.string.wrapToText_(c, k);
        e++
    } while (d > g);
    return h
};
Blockly.utils.string.wrapScore_ = function(a, b, c) {
    for (var d = [0], e = [], g = 0; g < a.length; g++) d[d.length - 1] += a[g].length, !0 === b[g] ? (d.push(0), e.push(a[g].charAt(a[g].length - 1))) : !1 === b[g] && d[d.length - 1]++;
    a = Math.max.apply(Math, d);
    for (g = b = 0; g < d.length; g++) b -= 2 * Math.pow(Math.abs(c - d[g]), 1.5), b -= Math.pow(a - d[g], 1.5), -1 != ".?!".indexOf(e[g]) ? b += c / 3 : -1 != ",;)]}".indexOf(e[g]) && (b += c / 4);
    1 < d.length && d[d.length - 1] <= d[d.length - 2] && (b += .5);
    return b
};
Blockly.utils.string.wrapMutate_ = function(a, b, c) {
    for (var d = Blockly.utils.string.wrapScore_(a, b, c), e, g = 0; g < b.length - 1; g++)
        if (b[g] != b[g + 1]) {
            var h = [].concat(b);
            h[g] = !h[g];
            h[g + 1] = !h[g + 1];
            var k = Blockly.utils.string.wrapScore_(a, h, c);
            k > d && (d = k, e = h)
...
Blockly.utils.style.getSize = function(a) {
    ...
    b.position = e;
    b.visibility = d;
    return new Blockly.utils.Size(g, a)
};
...
Blockly.utils.style.getContainerOffsetToScrollInto = function(a, b, c) {
    var d = Blockly.utils.style.getPageOffset(a),
        ...
        g = Blockly.utils.style.getBorderBox(b),
        h = d.x - e.x - g.left;
    d = d.y - e.y - g.top;
    ...
    g = b.scrollLeft;
    b = b.scrollTop;
    c ? (g += h - a / 2, b += d - e / 2) : (g += Math.min(h, Math.max(h - a, 0)), b += Math.min(d, Math.max(d - e, 0)));
    return new Blockly.utils.Coordinate(g, b)
};
...
Blockly.utils.checkMessageReferences = function(a) {
    for (var b = !0, c = Blockly.Msg, d = a.match(/%{BKY_[A-Z]\w*}/ig), e = 0; e < d.length; e++) {
        var g = d[e].toUpperCase();
        void 0 == c[g.slice(6, -1)] && (console.log("WARNING: No message string for " + d[e] + " in " + a), b = !1)
    }
    return b
};
Blockly.utils.tokenizeInterpolation_ = function(a, b) {
    var c = [],
        d = a.split("");
    d.push("");
    for (var e = 0, g = [], h = null, k = 0; k < d.length; k++) {
        var l = d[k];
        0 == e ? "%" == l ? ((l = g.join("")) && c.push(l), g.length = 0, e = 1) : g.push(l) : 1 == e ? "%" == l ? (g.push(l), e = 0) : b && "0" <= l && "9" >= l ? (e = 2, h = l, (l = g.join("")) && c.push(l), g.length = 0) : "{" == l ? e = 3 : (g.push("%", l), e = 0) : 2 == e ? "0" <= l && "9" >= l ? h += l : (c.push(parseInt(h, 10)), k--, e = 0) : 3 == e && ("" == l ? (g.splice(0, 0, "%{"), k--, e = 0) : "}" != l ? g.push(l) : (e = g.join(""), /[A-Z]\w*/i.test(e) ? (l = e.toUpperCase(), (l =
            Blockly.utils.string.startsWith(l, "BKY_") ? l.substring(4) : null) && l in Blockly.Msg ? (e = Blockly.Msg[l], "string" == typeof e ? Array.prototype.push.apply(c, Blockly.utils.tokenizeInterpolation_(e, b)) : b ? c.push(String(e)) : c.push(e)) : c.push("%{" + e + "}")) : c.push("%{" + e + "}"), e = g.length = 0))
    }(l = g.join("")) && c.push(l);
    d = [];
    for (k = g.length = 0; k < c.length; ++k) "string" == typeof c[k] ? g.push(c[k]) : ((l = g.join("")) && d.push(l), g.length = 0, d.push(c[k]));
    (l = g.join("")) && d.push(l);
    g.length = 0;
    return d
};
...
Blockly.utils.getBlockTypeCounts = function(a, b) {
    ...
    e = 0;
    for (var g; g = d[e]; e++) c[g.type] ? c[g.type]++ : c[g.type] = 1;
    return c
};
...
Blockly.Events.filter = function(a, b) {
    var c = a.slice();
    b || c.reverse();
    for (var d = [], e = Object.create(null), g = 0, h; h = c[g]; g++)
        if (!h.isNull()) {
            var k = [h.type, h.blockId, h.workspaceId].join(" "),
                l = e[k],
                m = l ? l.event : null;
            if (!l) e[k] = {
                event: h,
            ...
            else if (h.type == Blockly.Events.MOVE && l.index == g - 1) m.newParentId = h.newParentId, m.newInputName = h.newInputName, m.newCoordinate = h.newCoordinate, l.index = g;
            else if (h.type == Blockly.Events.CHANGE && h.element == m.element && h.name == m.name) m.newValue = h.newValue;
            else if (h.type !=
                Blockly.Events.UI || "click" != h.element || "commentOpen" != m.element && "mutatorOpen" != m.element && "warningOpen" != m.element) e[k] = {
                event: h,
                index: 1
            }, d.push(h)
    ...
    b || c.reverse();
    for (g = 1; h = c[g]; g++) h.type == Blockly.Events.CHANGE && "mutation" == h.element && c.unshift(c.splice(g, 1)[0]);
    return c
};
...
Blockly.Events.Move.prototype.run = function(a) {
    ...
    if (c) {
        ...
        if (a) e = c.getRelativeToSurfaceXY(), c.moveBy(a.x - e.x, a.y - e.y);
            ...
            if (e) {
                if (b = g.getInput(e)) var h =
                    b.connection
            } else c.type == Blockly.PREVIOUS_STATEMENT && (h = g.nextConnection);
            h ? c.connect(h) : console.warn("Can't connect to non-existent input: " + e)
        }
...
Blockly.Xml.workspaceToDom = function(a, b) {
    ...
    d = 0;
    for (var g; g = e[d]; d++) c.appendChild(g.toXmlWithXY(b));
    e = a.getTopBlocks(!0);
    for (d = 0; g = e[d]; d++) c.appendChild(Blockly.Xml.blockToDomWithXY(g, b));
    return c
};
...
Blockly.Xml.allFieldsToDom_ = function(a, b) {
    for (var c = 0, d; d = a.inputList[c]; c++)
        for (var e = 0, g; g = d.fieldRow[e]; e++)(g = Blockly.Xml.fieldToDom_(g)) && b.appendChild(g)
};
Blockly.Xml.blockToDom = function(a, b) {
    ...
    if (d = a.getCommentText()) {
        var e = a.commentModel.size,
            ...
            h = Blockly.utils.xml.createElement("comment");
        h.appendChild(Blockly.utils.xml.createTextNode(d));
        h.setAttribute("pinned", g);
        h.setAttribute("h",
            e.height);
        h.setAttribute("w", e.width);
        c.appendChild(h)
    }
    a.data && (d = Blockly.utils.xml.createElement("data"), d.appendChild(Blockly.utils.xml.createTextNode(a.data)), c.appendChild(d));
    for (e = 0; g = a.inputList[e]; e++) {
        var k;
        h = !0;
        if (g.type != Blockly.DUMMY_INPUT) {
            var l = g.connection.targetBlock();
            g.type == Blockly.INPUT_VALUE ? k = Blockly.utils.xml.createElement("value") : g.type == Blockly.NEXT_STATEMENT && (k = Blockly.utils.xml.createElement("statement"));
            d = g.connection.getShadowDom();
            !d || l && l.isShadow() || k.appendChild(Blockly.Xml.cloneShadow_(d,
                b));
            l && (k.appendChild(Blockly.Xml.blockToDom(l, b)), h = !1);
            k.setAttribute("name", g.name);
            h || c.appendChild(k)
        }
    }
    ...
    if (e = a.getNextBlock()) k = Blockly.utils.xml.createElement("next"),
        k.appendChild(Blockly.Xml.blockToDom(e, b)), c.appendChild(k);
    d = a.nextConnection && a.nextConnection.getShadowDom();
    !d || e && e.isShadow() || k.appendChild(Blockly.Xml.cloneShadow_(d, b));
    return c
};
...
Blockly.Xml.domToWorkspace = function(a, b) {
    ...
    try {
        for (var k = 0; k < e; k++) {
            ...
            if ("block" == m || "shadow" == m && !Blockly.Events.recordUndo) {
                var n =
                    Blockly.Xml.domToBlock(l, b);
                c.push(n.id);
                var p = l.hasAttribute("x") ? parseInt(l.getAttribute("x"), 10) : 10,
                    q = l.hasAttribute("y") ? parseInt(l.getAttribute("y"), 10) : 10;
                isNaN(p) || isNaN(q) || n.moveBy(b.RTL ? d - p : p, q);
                h = !1
            } else {
                if ("shadow" == m) throw TypeError("Shadow block cannot be a top-level block.");
                if ("comment" == m) b.rendered ? Blockly.WorkspaceCommentSvg ? Blockly.WorkspaceCommentSvg.fromXml(l, b, d) : console.warn("Missing require for Blockly.WorkspaceCommentSvg, ignoring workspace comment.") : Blockly.WorkspaceComment ?
                    ...
                    if (h) Blockly.Xml.domToVariables(l, b);
        ...
        g || Blockly.Events.setGroup(!1), Blockly.utils.dom.stopTextWidthCache()
    }
...
Blockly.Xml.appendDomToWorkspace = function(a, b) {
    ...
    if (d && d.top != d.bottom) {
        ...
        for (d = 0; d < c.length; d++) {
            var l = b.getBlockById(c[d]).getRelativeToSurfaceXY();
            l.y < k && (k = l.y);
            l.x < h && (h = l.x)
        }
        e = e - k + Blockly.BlockSvg.SEP_SPACE_Y;
        g -= h;
        var m;
        b.RTL && (m = b.getWidth());
        for (d =
            0; d < c.length; d++) b.getBlockById(c[d]).moveBy(b.RTL ? m - g : g, e)
    }
    return c
};
Blockly.Xml.domToBlock = function(a, b) {
    ...
    try {
        ...
        if (b.rendered) {
            ...
            for (var g = e.length - 1; 0 <= g; g--) e[g].initSvg();
            for (g = e.length - 1; 0 <= g; g--) e[g].render(!1);
            setTimeout(function() {
            ...
            for (g =
                e.length - 1; 0 <= g; g--) e[g].initModel()
    } finally {
        Blockly.Events.enable()
    }
    if (Blockly.Events.isEnabled()) {
        e = Blockly.Variables.getAddedVariables(b, c);
        for (g = 0; g < e.length; g++) Blockly.Events.fire(new Blockly.Events.VarCreate(e[g]));
    ...
    for (var c = 0, d; d = a.childNodes[c]; c++)
        if (d.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE) {
            var e = d.getAttribute("type"),
                g = d.getAttribute("id");
            b.createVariable(d.textContent, e, g)
        }
};
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
    ...
    var g = null;
    e = 0;
    for (var h; h = a.childNodes[e]; e++)
        if (h.nodeType != Blockly.utils.dom.Node.TEXT_NODE) {
            for (var k = g = null, l = 0, m; m = h.childNodes[l]; l++) m.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE && ("block" == m.nodeName.toLowerCase() ? g = m : "shadow" == m.nodeName.toLowerCase() && (k = m));
            !g && k && (g = k);
            ...
            switch (h.nodeName.toLowerCase()) {
                ...
                case "comment":
                    ...
                    g = h.textContent;
                    k = "true" == h.getAttribute("pinned");
                    l = parseInt(h.getAttribute("w"), 10);
                    h = parseInt(h.getAttribute("h"), 10);
                    c.setCommentText(g);
                    c.commentModel.pinned = k;
                    isNaN(l) || isNaN(h) || (c.commentModel.size = new Blockly.utils.Size(l, h));
                    k && c.getCommentIcon && !c.isInFlyout && setTimeout(function() {
                ...
                case "statement":
                    ...
                    if (g)
                        if (g = Blockly.Xml.domToBlockHeadless_(g, b), g.outputConnection) h.connection.connect(g.outputConnection);
                ...
                case "next":
                    ...
                    if (g) {
                        ...
                        g = Blockly.Xml.domToBlockHeadless_(g, b);
                        if (!g.previousConnection) throw TypeError("Next block does not have previous statement.");
                        c.nextConnection.connect(g.previousConnection)
                    }
                    break;
                default:
    ...
    if ("shadow" == a.nodeName.toLowerCase()) {
        d = c.getChildren(!1);
        for (e = 0; h = d[e]; e++)
            if (!h.isShadow()) throw TypeError("Shadow block not allowed non-shadow child.");
...
Blockly.Connection.prototype.connect_ = function(a) {
    ...
    if (b.isConnected()) {
        var e = b.targetBlock(),
            g = b.getShadowDom();
        b.setShadowDom(null);
        if (e.isShadow()) g = Blockly.Xml.blockToDom(e), e.dispose(), e = null;
        else if (b.type == Blockly.INPUT_VALUE) {
            if (!e.outputConnection) throw Error("Orphan block does not have an output connection.");
            var h = Blockly.Connection.lastConnectionInRow_(d, e);
            h && (e.outputConnection.connect(h), e = null)
        } else if (b.type ==
            Blockly.NEXT_STATEMENT) {
            if (!e.previousConnection) throw Error("Orphan block does not have a previous connection.");
            for (h = d; h.nextConnection;) {
                var k = h.getNextBlock();
                if (k && !k.isShadow()) h = k;
                else {
                    e.previousConnection.checkType_(h.nextConnection) && (h.nextConnection.connect(e.previousConnection), e = null);
                    break
                }
            }
        }
    ...
    var m;
    Blockly.Events.isEnabled() && (m = new Blockly.Events.BlockMove(d));
...
Blockly.Extensions.registerMutator = function(a, b, c, d) {
    ...
    var g = Blockly.Extensions.checkMutatorDialog_(b, e);
...
Blockly.InsertionMarkerManager.prototype.createMarkerBlock_ = function(a) {
    ...
    try {
        ...
        for (b = 0; b < a.inputList.length; b++) {
            var e = a.inputList[b],
                g = c.inputList[b];
            for (d = 0; d < e.fieldRow.length; d++) g.fieldRow[d].setValue(e.fieldRow[d].getValue())
        }
        c.initSvg();
...
Blockly.InsertionMarkerManager.prototype.shouldUpdatePreviews_ = function(a, b) {
    ...
    if (c && d) {
        if (this.localConnection_ && this.closestConnection_) {
            ...
            var g = this.localConnection_.y_ + b.y - this.closestConnection_.y_;
            c = Math.sqrt(c * c + g * g);
...
Blockly.InsertionMarkerManager.prototype.getCandidate_ = function(a) {
    for (var b = this.getStartRadius_(), c = null, d = null, e = 0; e < this.availableConnections_.length; e++) {
        var g = this.availableConnections_[e],
            h = g.closest(b, a);
        h.connection && (c = h.connection, d = g, b = h.radius)
    }
    return {
        closest: c,
        local: d,
...
Blockly.ScrollbarPair.prototype.set = function(a, b) {
    var c = {},
        ...
        g = this.vScroll.scrollViewSize_;
    ...
    if (this.theme_ !== a) {
        ...
        for (var c; c = b[a]; a++)
            for (var d = 0, e; e = this.componentDB_[c][d]; d++) {
                var g = e.element;
                e = e.propertyName;
                var h = this.theme_ && this.theme_.getComponentStyle(c);
                g.style[e] = h || ""
            }
    }
};
...
Blockly.ThemeManager.prototype.unsubscribe = function(a) {
    if (a)
        for (var b = Object.keys(this.componentDB_), c = 0, d; d = b[c]; c++) {
            for (var e = this.componentDB_[d], g = e.length - 1; 0 <= g; g--) e[g].element === a && e.splice(g, 1);
...
Blockly.VariableMap.prototype.getVariableById = function(a) {
    for (var b = Object.keys(this.variableMap_), c = 0; c < b.length; c++)
        for (var d = b[c], e = 0, g; g = this.variableMap_[d][e]; e++)
...
Blockly.VariableMap.prototype.getVariableUsesById = function(a) {
    for (var b = [], c = this.workspace.getAllBlocks(!1), d = 0; d < c.length; d++) {
        ...
        if (e)
            for (var g = 0; g < e.length; g++) e[g].getId() == a && b.push(c[d])
    }
    return b
};
Blockly.Map = function(a, b) {
    this.map_ = {};
    this.keys_ = [];
...
Blockly.Map.prototype.containsKey = function(a) {
    return Blockly.Map.hasKey_(this.map_, a)
};
Blockly.Map.prototype.containsValue = function(a) {
    for (var b = 0; b < this.keys_.length; b++) {
        var c = this.keys_[b];
        if (Blockly.Map.hasKey_(this.map_, c) && this.map_[c] == a) return !0
    }
    return !1
};
Blockly.Map.prototype.equals = function(a, b) {
    if (this === a) return !0;
    if (this.count_ != a.getCount()) return !1;
    var c = b || Blockly.Map.defaultEquals;
    this.cleanupKeysArray_();
...
Blockly.Map.prototype.remove = function(a) {
    return Blockly.Map.hasKey_(this.map_, a) ? (delete this.map_[a], this.count_--, this.version_++, this.keys_.length > 2 * this.count_ && this.cleanupKeysArray_(), !0) : !1
};
Blockly.Map.prototype.cleanupKeysArray_ = function() {
    if (this.count_ != this.keys_.length) {
        for (var a = 0, b = 0; a < this.keys_.length;) {
            var c = this.keys_[a];
            Blockly.Map.hasKey_(this.map_, c) && (this.keys_[b++] = c);
            a++
        }
        this.keys_.length = b
    }
    if (this.count_ != this.keys_.length) {
        var d = {};
        for (b = a = 0; a < this.keys_.length;) c = this.keys_[a], Blockly.Map.hasKey_(d, c) || (this.keys_[b++] = c, d[c] = 1), a++;
        this.keys_.length = b
    }
};
Blockly.Map.prototype.get = function(a, b) {
    return Blockly.Map.hasKey_(this.map_, a) ? this.map_[a] : b
};
Blockly.Map.prototype.set = function(a, b) {
    Blockly.Map.hasKey_(this.map_, a) || (this.count_++, this.keys_.push(a), this.version_++);
    this.map_[a] = b
};
Blockly.Map.prototype.addAll = function(a) {
    if (a instanceof Blockly.Map) {
        var b = a.getKeys();
        a = a.getValues()
    } else b = Blockly.Map.getKeys(a), a = Blockly.Map.getValues(a);
    for (var c = 0; c < b.length; c++) this.set(b[c], a[c])
};
Blockly.Map.prototype.forEach = function(a, b) {
...
Blockly.Map.prototype.transpose = function() {
    for (var a = new Blockly.Map, b = 0; b < this.keys_.length; b++) {
        var c = this.keys_[b];
        a.set(this.map_[c], c)
    }
    return a
...
Blockly.Map.hasKey_ = function(a, b) {
    return Object.prototype.hasOwnProperty.call(a, b)
};
Blockly.Map.getKeys = function(a) {
    var b = [],
        c = 0,
        d;
    for (d in a) b[c++] = d;
...
Blockly.Map.getValues = function(a) {
    var b = [],
        c = 0,
        d;
    for (d in a) b[c++] = a[d];
...
Blockly.Set = function(a) {
    this.map_ = new Blockly.Map;
    a && this.addAll(a)
};
Blockly.Set.getKey_ = function(a) {
    var b = typeof a;
    return "object" == b && a || "function" == b ? a : b.substr(0, 1) + a
};
Blockly.Set.getUid = function(a) {};
Blockly.Set.prototype.getCount = function() {
    return this.map_.getCount()
};
Blockly.Set.prototype.add = function(a) {
    this.map_.set(Blockly.Set.getKey_(a), a)
};
Blockly.Set.prototype.addAll = function(a) {
    a = Blockly.Set.getValues(a);
    for (var b = a.length, c = 0; c < b; c++) this.add(a[c])
};
Blockly.Set.prototype.removeAll = function(a) {
    a = Blockly.Set.getValues(a);
    for (var b = a.length, c = 0; c < b; c++) this.remove(a[c])
};
Blockly.Set.prototype.remove = function(a) {
    return this.map_.remove(Blockly.Set.getKey_(a))
};
...
Blockly.Set.prototype.contains = function(a) {
    return this.map_.containsKey(Blockly.Set.getKey_(a))
};
Blockly.Set.prototype.intersection = function(a) {
    var b = new Blockly.Set;
    a = Blockly.Set.getValues(a);
...
Blockly.Set.prototype.difference = function(a) {
    var b = this.clone();
    b.removeAll(a);
    return b
};
...
Blockly.Set.prototype.equals = function(a) {
    return this.getCount() == Blockly.Set.getCount(a) && this.isSubsetOf(a)
};
Blockly.Set.prototype.isSubsetOf = function(a) {
    var b = Blockly.Set.getCount(a);
    if (this.getCount() > b) return !1;
    !(a instanceof Blockly.Set) && 5 < b && (a = new Blockly.Set(a));
    return Blockly.Set.every(this, function(b) {
        return Blockly.Set.contains(a, b)
    })
};
Blockly.Set.getKeys = function(a) {
    if ("function" == typeof a.getKeys) return a.getKeys();
    if ("function" != typeof a.getValues) {
        try {
            for (var b = [], c = a.length, d = 0; d < c; d++) b.push(d);
            return b
        } catch (g) {
        ...
        b = [];
        d = 0;
        for (var e in a) b[d++] = e;
        return b
    }
};
Blockly.Set.getValues = function(a) {
    ...
    b = [];
    d = 0;
    for (var e in a) b[d++] = a[e];
    return b
};
Blockly.Set.getCount = function(a) {
    if ("function" == typeof a.getCount) return a.getCount();
...
Blockly.Set.every = function(a) {
    for (var b = Blockly.Set.getKeys(a), c = Blockly.Set.getValues(a), d = c.length, e = 0; e < d; e++)
        if (!f.call(opt_obj, c[e], b && b[e], a)) return !1;
    return !0
};
Blockly.Set.containsValue = function(a, b) {
    for (var c in a)
        if (a[c] == b) return !0;
    return !1
};
Blockly.Trie = function() {
    this.value_ = void 0;
    this.childNodes_ = {}
};
Blockly.Trie.prototype.set = function(a, b) {
    this.setOrAdd_(a, b, !1)
};
Blockly.Trie.prototype.add = function(a, b) {
    this.setOrAdd_(a, b, !0)
};
Blockly.Trie.prototype.setOrAdd_ = function(a, b, c) {
    for (var d = this, e = 0; e < a.length; e++) {
        var g = a.charAt(e);
        d.childNodes_[g] || (d.childNodes_[g] = new Blockly.Trie);
        d = d.childNodes_[g]
    }
    if (c && void 0 !== d.value_) throw Error('The collection already contains the key "' + a + '"');
    d.value_ = b
};
Blockly.Trie.prototype.setAll = function(a) {
    var b = Blockly.Trie.getKeys(a);
    a = Blockly.Trie.getValues(a);
    for (var c = 0; c < b.length; c++) this.set(b[c], a[c])
};
Blockly.Trie.prototype.getChildNode_ = function(a) {
...
Blockly.Trie.prototype.get = function(a) {
    return (a = this.getChildNode_(a)) ? a.value_ : void 0
};
Blockly.Trie.prototype.getKeyAndPrefixes = function(a, b) {
    var c = this,
        d = {},
        e = b || 0;
...
Blockly.Trie.prototype.getKeysInternal_ = function(a, b) {
    void 0 !== this.value_ && b.push(a);
    for (var c in this.childNodes_) this.childNodes_[c].getKeysInternal_(a + c, b)
};
Blockly.Trie.prototype.containsKey = function(a) {
    return void 0 !== this.get(a)
};
Blockly.Trie.prototype.containsPrefix = function(a) {
    return 0 == a.length ? !this.isEmpty() : !!this.getChildNode_(a)
};
Blockly.Trie.prototype.containsValue = function(a) {
...
Blockly.Trie.prototype.remove = function(a) {
...
Blockly.Trie.prototype.isEmpty = function() {
    return void 0 === this.value_ && Blockly.Trie.isEmpty(this.childNodes_)
};
Blockly.Trie.getKeys = function(a) {
    if ("function" == typeof a.getKeys) return a.getKeys();
    if ("function" != typeof a.getValues) {
        try {
            for (var b = [], c = a.length, d = 0; d < c; d++) b.push(d);
...
Blockly.Trie.getValues = function(a) {
    if ("function" == typeof a.getValues) return a.getValues();
    if ("string" == typeof a) return a.split("");
    try {
        for (var b = [], c = a.length, d = 0; d < c; d++) b.push(a[d]);
...
Blockly.Trie.getCount = function(a) {
    if ("function" == typeof a.getCount) return a.getCount();
    if (a.length) return a.length;
    var b = 0,
        c;
...
Blockly.Trie.isEmpty = function(a) {
...
*/
Blockly.Search = function(a) {
    this.workspace_ = a;
    this.blockTrie_ = new Blockly.Trie
};
Blockly.Search.prototype.addToTrie = function(a, b) {
    this.blockTrie_.containsKey(a) || this.blockTrie_.add(a, []);
    this.blockTrie_.set(a, this.blockTrie_.get(a).concat(b))
};
Blockly.Search.prototype.removeFromTrie = function(a, b) {
    this.blockTrie_.containsKey(a) && b in this.blockTrie_.get(a) && this.blockTrie_.set(a, this.blockTrie_.get(a).pop(b))
};
Blockly.Search.prototype.onBlockAdded = function(a, b) {
    try {
        if (Blockly.Blocks[a].ensureSearchKeywords(), Blockly.Blocks[a].SearchKeywords)
            for (var c = Blockly.Blocks[a].SearchKeywords, d = 0; d < c.length; d++) this.addToTrie(c[d], b);
        else console.warn("Keywords not found for block " + a)
    } catch (e) {
        console.warn("Block " + a + " has no ensureSearchKeywords function")
    }
};
Blockly.Search.prototype.onBlockRemoved = function(a, b) {
    if (Blockly.Blocks[a].SearchKeywords)
        for (var c = Blockly.Blocks[a].SearchKeywords, d = 0; d < c.length; d++) this.removeFromTrie(c[d], b)
};
Blockly.Search.prototype.blocksMatchingSearchTerm = function(a) {
    if (!this.blockTrie_) return [];
    a = this.blockTrie_.getKeys(a.toLowerCase());
    for (var b = [], c = 0; c < a.length; c++)
        for (var d = this.blockTrie_.get(a[c]), e = 0; e < d.length; e++) b.push(d[e]);
    return b
};
Blockly.Search.prototype.blocksMatchingSearchTerms = function(a) {
    for (var b = null, c = 0; c < a.length; c++)
        if (0 != a[c].length) {
            var d = new Blockly.Set(this.blocksMatchingSearchTerm(a[c]));
            b = b ? b.intersection(d) : d
        } return b.getValues()
};
...
Blockly.Search.preprocessSearchKeywords = function(a, b) {
    if (!(Blockly.Blocks[a].SearchKeywords && 0 < Blockly.Blocks[a].SearchKeywords.length)) {
        Blockly.Blocks[a].SearchKeywords = [];
        for (var c = 0; c < b.length; c++) {
            var d = Blockly.utils.tokenizeInterpolation(b[c])[0];
            if (d) {
                d = d.trim().toLowerCase().replace(/[`~!@#$%^&*()_|+\-=?;:'",.<>\{\}\[\]\\\/]/gi, "").split(" ");
                for (var e = 0; e < d.length; e++) {
                    var g = d[e];
                    g && "" != g && Blockly.Blocks[a].SearchKeywords.push(g)
                }
            }
        }
    }
};
Blockly.SearchWorkspace = function(a) {
    Blockly.SearchWorkspace.superClass_.constructor.call(this, a);
    var b = this;
    ...
    this.resultsNumberHolder_.style.minWidth =
        "0px";
    this.resultsNumberHolder_.style.maxWidth = "0px";
    this.buttonsHolder_.style.maxWidth = "0px";
    this.workspace_.addChangeListener(function(a) {
        b.onNewWorkspaceEvent(a)
    });
    this.searchInput_.addEventListener("keydown", function(a) {
        a.stopPropagation()
    });
    this.searchInput_.addEventListener("click", function(a) {
        a.stopPropagation();
        b.resultsNumberHolder_.style.minWidth = "50px";
        b.resultsNumberHolder_.style.maxWidth = "50px";
        b.buttonsHolder_.style.maxWidth = "140px"
    });
    this.searchInput_.addEventListener("blur", function(a) {
        a.relatedTarget &&
            (a.relatedTarget.id && "workspaceSearchDiv" == a.relatedTarget.id || a.relatedTarget.id && "resultsCount" == a.relatedTarget.id || a.relatedTarget.id && "prevWorkspaceHolder" == a.relatedTarget.id || a.relatedTarget.id && "nextWorkspaceHolder" == a.relatedTarget.id || a.relatedTarget.id && "closeWorkspaceHolder" == a.relatedTarget.id) ? (a.stopPropagation(), b.focusSearchField()) : (b.lastSearchValue_ = "", b.onBlur(a))
    });
    this.searchInput_.addEventListener("search", function(a) {
        a.preventDefault();
        0 == b.searchInput_.value.length && (b.lastSearchValue_ =
            "", b.searchInput_.blur(), b.onBlur(a))
    });
    this.searchInput_.addEventListener("keyup", function(a) {
        b.executeSearchOnKeyUp(a, b)
    });
    this.nextButton_.addEventListener("click", function(a) {
        a.preventDefault();
        b.showNextResult(!0)
    });
    this.prevButton_.addEventListener("click", function(a) {
        a.preventDefault();
        b.showNextResult(!1)
    })
};
Blockly.utils.object.inherits(Blockly.SearchWorkspace, Blockly.Search);
Blockly.SearchWorkspace.prototype.onNewWorkspaceEvent = function(a) {
    if (a.type == Blockly.Events.CREATE) {
        var b = this.decodeXmlBlocks(a.xml);
        for (a = 0; a < b.length; a++) {
            var c = b[a];
            if (c[0] && c[1]) this.onBlockAdded(c[0], c[1])
        }
    } else if (a.type == Blockly.Events.DELETE)
        for (b = this.decodeXmlBlocks(a.oldXml), a = 0; a < b.length; a++)
            if (c = b[a], c[0] && c[1]) this.onBlockRemoved(c[0], c[1])
};
Blockly.SearchWorkspace.prototype.decodeXmlBlocks = function(a) {
    var b = [],
        c = a.nodeName;
    if ("BLOCK" != c.toUpperCase() && "SHADOW" != c.toUpperCase()) return b;
    ...
    for (var e; e = a.childNodes[c]; c++)
        if (3 != e.nodeType) {
            for (var g = null, h = null, k = 0; d = e.childNodes[k]; k++) 1 == d.nodeType && ("block" == d.nodeName.toLowerCase() ? g = d : "shadow" == d.nodeName.toLowerCase() && (h = d));
            !g && h && (g = h);
            switch (e.nodeName.toLowerCase()) {
                ...
                case "next":
                    if (g)
                        for (e =
                            this.decodeXmlBlocks(g), g = 0; d = e[g]; g++) b.push(d)
            }
        } return b
};
Blockly.SearchWorkspace.prototype.executeSearchOnKeyUp = function(a) {
    if (27 == a.keyCode) this.lastSearchValue_ = "", this.searchInput_.blur(), this.onBlur(a);
    else if (13 == a.keyCode) this.showNextResult(!a.shiftKey);
    else if (a = a.target.value, !this.lastSearchValue_ || a != this.lastSearchValue_) {
        this.lastSearchValue_ = a;
        var b = this.lastSearchValue_.trim().toLowerCase().split(/\s+/);
        b = goog.array.filter(b, function(a) {
            return 0 < a.length
        });
        this.finalResults_ = [];
        a = [];
        0 < b.length && (a = this.blocksMatchingSearchTerms(b));
        if (0 <
            a.length)
            for (b = 0; b < a.length;) {
                var c = this.workspace_.getBlockById(a[b]);
                c && this.finalResults_.push(c);
                b++
            }
        this.finalResults_.sort(Blockly.Workspace.prototype.sortObjects_);
        this.currentIndex = -1;
        this.showNextResult(!0)
    }
};
Blockly.SearchWorkspace.prototype.showNextResult = function(a) {
    0 == this.finalResults_.length ? (this.workspace_.highlightBlock(""), this.currentResult && this.currentResult.unselect(), this.resultsNumberHolder_.innerHTML = "0/0") : (a ? this.currentIndex++ : this.currentIndex--, this.finalResults_.length <= this.currentIndex ? this.currentIndex = 0 : 0 > this.currentIndex && (this.currentIndex = this.finalResults_.length - 1), this.resultsNumberHolder_.innerHTML = this.currentIndex + 1 + "/" + this.finalResults_.length, this.currentResult =
        this.finalResults_[this.currentIndex], this.currentResult.select(), this.workspace_.centerOnBlock(this.currentResult.id), this.workspace_.highlightBlock(this.currentResult.id))
};
Blockly.SearchWorkspace.prototype.onBlur = function(a) {
    this.workspace_.highlightBlock("");
    this.currentResult && this.currentResult.unselect();
    this.searchInput_.value = "";
    this.resultsNumberHolder_.innerHTML = "";
...
Blockly.Workspace = function(a) {
    ...
    a.parentWorkspace ? a.isToolbox && (this.search_ = new Blockly.Search(this)) : this.search_ = new Blockly.SearchWorkspace(this)
};
...
Blockly.Bubble = function(a, b, c, d, e, g) {
    this.workspace_ = a;
    this.content_ = b;
    this.shape_ = c;
    ...
    a.getBubbleCanvas().appendChild(this.createDom_(b, !(!e || !g)));
    this.setAnchorLocation(d);
    e && g || (b = this.content_.getBBox(), e = b.width + 2 * Blockly.Bubble.BORDER_WIDTH, g = b.height + 2 * Blockly.Bubble.BORDER_WIDTH);
    this.setBubbleSize(e, g);
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
    ...
    b = d.width < d.height ? c : h;
    d = d.width < d.height ? h : c;
    c = this.getOverlap_(e,
        a);
    h = this.getOverlap_(g, a);
    var k = this.getOverlap_(b, a);
    a = this.getOverlap_(d, a);
    a = Math.max(c, h, k, a);
    c == a ? (this.relativeLeft_ = e.x, this.relativeTop_ = e.y) : h == a ? (this.relativeLeft_ = g.x, this.relativeTop_ = g.y) : k == a ? (this.relativeLeft_ = b.x, this.relativeTop_ = b.y) : (this.relativeLeft_ = d.x, this.relativeTop_ = d.y)
};
...
Blockly.Bubble.prototype.getOptimalRelativeLeft_ = function(a) {
    ...
    if (this.workspace_.RTL) var c = this.anchorXY_.x - b,
        ...
        g = a.viewLeft + Blockly.Scrollbar.scrollbarThickness / this.workspace_.scale;
    else d = b + this.anchorXY_.x, c = d + this.width_, g = a.viewLeft, e = a.viewLeft + a.viewWidth - Blockly.Scrollbar.scrollbarThickness / this.workspace_.scale;
    this.workspace_.RTL ? d < g ? b = -(g - this.anchorXY_.x + this.width_) : c > e && (b = -(e - this.anchorXY_.x)) :
        d < g ? b = g - this.anchorXY_.x : c > e && (b = e - this.anchorXY_.x - this.width_);
    return b
};
Blockly.Bubble.prototype.getOptimalRelativeTop_ = function(a) {
    ...
    c < e ? b = e - g : d > a && (b = a - g - this.height_);
    return b
};
...
Blockly.Bubble.prototype.renderArrow_ = function() {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c);
        ...
        k = (n.width + n.height) / Blockly.Bubble.ARROW_THICKNESS;
        k = Math.min(k, n.width, n.height) / 4;
        n = 1 - Blockly.Bubble.ANCHOR_RADIUS / g;
        d = b +
            n * d;
        e = c + n * e;
        n = b + k * m;
        ...
        b -= k * m;
        c -= k * l;
        l = h + this.arrow_radians_;
        l > 2 * Math.PI && (l -= 2 * Math.PI);
        h = Math.sin(l) * g / Blockly.Bubble.ARROW_BEND;
        g = Math.cos(l) * g / Blockly.Bubble.ARROW_BEND;
        a.push("M" + n + "," + p);
        a.push("C" + (n + g) + "," + (p + h) + " " + d + "," + e + " " + d + "," + e);
        a.push("C" + d + "," + e + " " + (b + g) + "," + (c + h) + " " + b + "," + c)
    }
    a.push("z");
...
Blockly.Field.prototype.getParentInput = function() {
    for (var a = null, b = this.sourceBlock_, c = b.inputList, d = 0; d < b.inputList.length; d++)
        for (var e = c[d], g = e.fieldRow, h = 0; h < g.length; h++)
            if (g[h] === this) {
                a = e;
                break
            } return a
...
Blockly.utils.colour.hsvToHex = function(a, b, c) {
    ...
    return Blockly.utils.colour.rgbToHex(Math.floor(d), Math.floor(e), Math.floor(g))
};
...
Blockly.Block.prototype.renameVarById = function(a, b) {
    for (var c = 0, d; d = this.inputList[c]; c++)
        for (var e = 0, g; g = d.fieldRow[e]; e++) g.referencesVariables() && a == g.getValue() && g.setValue(b)
};
...
Blockly.Block.prototype.toString = function(a, b) {
    ...
    if (this.collapsed_) c.push(this.getInput("_TEMP_COLLAPSED_INPUT").fieldRow[0].getText());
        ...
        for (var e = 0, g; g = this.inputList[e]; e++) {
            for (var h = 0, k; k = g.fieldRow[h]; h++) c.push(k.getText());
            g.connection && ((g = g.connection.targetBlock()) ? c.push(g.toString(void 0, b)) : c.push(d))
        }
    c = c.join(" ").trim() || "???";
...
Blockly.Block.prototype.interpolate_ = function(a, b, c) {
    ...
    for (var h = 0; h < d.length; h++) {
        ...
        if ("number" == typeof k) {
            ...
            if (e[k]) throw Error('Block "' + this.type + '": Message index %' + k + " duplicated.");
            e[k] = !0;
            g++;
            a.push(b[k - 1])
    ...
    for (h = 0; h < a.length; h++)
        if (e = a[h], "string" == typeof e) b.push([e, void 0]);
        else {
            d = g = null;
            do
                if (k = !1, "string" == typeof e) g = new Blockly.FieldLabel(e);
                else switch (e.type) {
                    case "input_value":
                    ...
                    case "input_dummy":
                        ...
                        break;
                    default:
                        g = Blockly.fieldRegistry.fromJson(e), !g && e.alt && (e = e.alt, k = !0)
                }
            while (k);
            if (g) b.push([g, e.name]);
            else if (d) {
...
Blockly.Block.prototype.moveInputBefore = function(a, b) {
    if (a != b) {
        for (var c = -1, d = b ? -1 : this.inputList.length, e = 0, g; g = this.inputList[e]; e++)
            if (g.name == a) {
                if (c = e, -1 != d) break
            } else if (b && g.name == b && (d = e, -1 != c)) break;
...
Blockly.Menu.prototype.highlightHelper = function(a, b) {
    ...
    for (var e = 0; e <= d;) {
        ...
        if (g && this.canHighlightItem(g)) return this.setHighlightedIndex(c), !0;
        e++;
        c = a.call(this, c, d)
    }
    return !1
...
Blockly.ContextMenu.populate_ = function(a, b) {
    ...
    for (var d = 0, e; e = a[d]; d++) {
        var g = new Blockly.MenuItem(e.text);
        g.setRightToLeft(b);
        c.addChild(g, !0);
        g.setEnabled(e.enabled);
        if (e.enabled) g.onAction(function() {
...
Blockly.ContextMenu.workspaceCommentOption = function(a, b) {
    ...
    c.callback = function() {
        ...
        var g = a.getOriginOffsetInPixels();
        e = Blockly.utils.Coordinate.difference(e, g);
        e.scale(1 / a.scale);
        c.moveBy(e.x, e.y);
    ...
    if (!this.sourceBlock_.workspace.isDragging()) {
        ...
        if (!b.isInFlyout) {
            ...
            var e = a.x_ + Blockly.SNAP_RADIUS + Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS) - this.x_,
                g = a.y_ + Blockly.SNAP_RADIUS + Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS) - this.y_;
            c && (g = -g);
            b.RTL &&
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function() {
    ...
    if (this.RTL) {
        var g = a.x - (c.width - b);
        a = a.x + b
    } else g = a.x - b, a = a.x + c.width - b;
    return new Blockly.utils.Rect(d, e, g, a)
};
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
    ...
    if (this.workspace.isDragging()) {
        ...
        for (var g = null; d;) d.isCollapsed() && (g = d), d = d.getSurroundParent();
        g && g.setWarningText(Blockly.Msg.COLLAPSED_WARNINGS_WARNING, Blockly.BlockSvg.COLLAPSED_WARNING_ID);
        d = !1;
        "string" == typeof a ? (this.warning || (this.warning = new Blockly.Warning(this), d = !0), this.warning.setText(a, c)) : this.warning && !c ? (this.warning.dispose(), d = !0) : this.warning && (d = this.warning.getText(), this.warning.setText("", c), (g = this.warning.getText()) || this.warning.dispose(), d = d != g);
        d && this.rendered &&
    ...
    if (this.workspace && !this.workspace.isDragging()) {
        ...
        if (!a.isInFlyout)
            for (var b = this.getConnections_(!1), c = 0, d; d = b[c]; c++) {
                ...
                for (var e = d.neighbours_(Blockly.SNAP_RADIUS), g = 0, h; h = e[g]; g++) d.isConnected() && h.isConnected() || h.getSourceBlock().getRootBlock() != a && (d.isSuperior() ? h.bumpAwayFrom_(d) : d.bumpAwayFrom_(h))
            }
    }
};
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none;", "}", ".blocklyNonSelectable {", "user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;", "position: absolute;", "top: 0;",
    ...
    "outline: none;", "z-index: 20000;", "}", ".blocklyDropDownDiv .goog-menu {", "cursor: default;", 'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;', "outline: none;", "z-index: 20000;", "}", ".blocklyWidgetDiv .goog-menuitem,", ".blocklyDropDownDiv .goog-menuitem {", "color: #000;", "font: normal 13px Arial, sans-serif;", "list-style: none;", "margin: 0;", "min-width: 7em;", "border: none;", "padding: 6px 15px;", "white-space: nowrap;", "cursor: pointer;", "}", ".blocklyWidgetDiv .goog-menu-nocheckbox .goog-menuitem,",
    ".blocklyWidgetDiv .goog-menu-noicon .goog-menuitem,", ".blocklyDropDownDiv .goog-menu-nocheckbox .goog-menuitem,", ".blocklyDropDownDiv .goog-menu-noicon .goog-menuitem {", "padding-left: 12px;", "}", ".blocklyWidgetDiv .goog-menuitem-content,", ".blocklyDropDownDiv .goog-menuitem-content {", "font: normal 13px Arial, sans-serif;", "}", ".blocklyWidgetDiv .goog-menuitem-content, ", ".blocklyDropDownDiv .goog-menuitem-content {", "color: #000;", "}", ".blocklyDropDownDiv .goog-menuitem-content {", "color: #000;",
    "}", ".blocklyWidgetDiv .goog-menuitem-disabled,", ".blocklyDropDownDiv .goog-menuitem-disabled {", "cursor: inherit;", "}", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-content,", ".blocklyDropDownDiv .goog-menuitem-disabled .goog-menuitem-content {", "color: #ccc !important;", "}", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-icon,", ".blocklyDropDownDiv .goog-menuitem-disabled .goog-menuitem-icon {", "opacity: .3;", "filter: alpha(opacity=30);", "}", ".blocklyWidgetDiv .goog-menuitem-highlight ,",
    ...
    ".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-icon,", ".blocklyDropDownDiv .goog-menuitem-rtl .goog-menuitem-checkbox,", ".blocklyDropDownDiv .goog-menuitem-rtl .goog-menuitem-icon {", "float: right;", "margin-right: -24px;", "}"
];
...
Blockly.DropDownDiv.showPositionedByBlock = function(a, b, c, d) {
    ...
    return Blockly.DropDownDiv.show(a, b.RTL, g, h, g, e, c)
};
Blockly.DropDownDiv.showPositionedByField = function(a, b, c) {
    ...
    return Blockly.DropDownDiv.show(a, c.RTL, e, g, e, d, b)
};
Blockly.DropDownDiv.show = function(a, b, c, d, e, g, h) {
    Blockly.DropDownDiv.owner_ = a;
    Blockly.DropDownDiv.onHide_ = h || null;
    a = Blockly.DropDownDiv.getPositionMetrics(c, d, e, g);
...
Blockly.DropDownDiv.getPositionMetrics = function(a, b, c, d) {
    var e = Blockly.DropDownDiv.getBoundsInfo_(),
        g = Blockly.utils.style.getSize(Blockly.DropDownDiv.DIV_);
    return b + g.height < e.bottom ? Blockly.DropDownDiv.getPositionBelowMetrics(a, b, e, g) : d - g.height > e.top ? Blockly.DropDownDiv.getPositionAboveMetrics(c, d, e, g) : b + g.height < document.documentElement.clientHeight ? Blockly.DropDownDiv.getPositionBelowMetrics(a, b, e, g) : d - g.height > document.documentElement.clientTop ? Blockly.DropDownDiv.getPositionAboveMetrics(c, d,
        e, g) : Blockly.DropDownDiv.getPositionTopOfPageMetrics(a, e, g)
};
...
Blockly.Grid.prototype.setLineAttributes_ = function(a, b, c, d, e, g) {
    a && (a.setAttribute("stroke-width", b), a.setAttribute("x1", c), a.setAttribute("y1", e), a.setAttribute("x2", d), a.setAttribute("y2", g))
};
...
Blockly.Options = function(a) {
    ...
    q = "end" === q ? !1 :
        !0;
    q = p ? q ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : q == n ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT;
    var r = a.css;
    void 0 === r && (r = !0);
    var t = "https://blockly-demo.appspot.com/static/media/";
    a.media ? t = a.media : a.path && (t = a.path + "media/");
    var u = void 0 === a.oneBasedIndex ? !0 : !!a.oneBasedIndex,
        v = a.theme,
        w = a.keyMap || Blockly.user.keyMap.createDefaultKeyMap(),
        x = a.renderer || "geras";
    this.RTL = n;
    this.oneBasedIndex = u;
    this.collapse = g;
    this.comments = h;
    this.disable = k;
    this.readOnly = b;
...
Blockly.WorkspaceDragSurfaceSvg.prototype.setContentsAndShow = function(a, b, c, d, e, g) {
...
Blockly.ConnectionDB.prototype.getNeighbours = function(a, b) {
    function c(a) {
        var c = e - d[a].x_,
            h = g - d[a].y_;
        Math.sqrt(c * c + h * h) <= b && m.push(d[a]);
        return h < b
    }
    for (var d = this.connections_, e = a.x_, g = a.y_, h = 0, k = d.length - 2, l = k; h < l;) d[l].y_ < g ? h = l : k = l, l = Math.floor((h + k) / 2);
    var m = [];
    k = h = l;
    if (d.length) {
        for (; 0 <= h && c(h);) h--;
        do k++; while (k < d.length && c(k))
    }
    return m
};
...
Blockly.ConnectionDB.prototype.searchForClosest = function(a, b, c) {
    ...
    c = null;
    for (var h = b, k, l = g - 1; 0 <= l && this.isInYRange_(l, a.y_, b);) k = this.connections_[l], a.isConnectionAllowed(k, h) && (c = k, h = k.distanceFrom(a)), l--;
    for (; g < this.connections_.length && this.isInYRange_(g, a.y_, b);) k = this.connections_[g], a.isConnectionAllowed(k, h) && (c = k, h = k.distanceFrom(a)), g++;
    a.x_ = e;
    a.y_ =
        d;
    return {
...
Blockly.WorkspaceAudio.prototype.load = function(a, b) {
    if (a.length) {
        ...
        for (var d, e = 0; e < a.length; e++) {
            var g = a[e],
                h = g.match(/\.(\w+)$/);
            if (h && c.canPlayType("audio/" + h[1])) {
                d = new Blockly.utils.global.Audio(g);
                break
            }
        }
        ...
        if (!isNaN(d) && !isNaN(e)) {
            ...
            do {
                ...
                for (var h; h = g[c]; c++) {
                    ...
                    if (1 >= Math.abs(d - k.x) && 1 >= Math.abs(e - k.y)) {
                        a = !0;
                        break
                    }
                }
                if (!a) {
                    ...
                    c = 0;
                    for (var m; m = l[c]; c++)
                        if (m.closest(Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(d, e)).connection) {
                            a = !0;
                            break
                        }
                }
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(a) {
    function b(a) {
        if (a.isDeletable()) q = q.concat(a.getDescendants(!1));
        else {
            a = a.getChildren(!1);
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        var d = [],
            ...
            g = Blockly.utils.genUid(),
            h = this,
            k = {};
        k.text = Blockly.Msg.UNDO;
        k.enabled = 0 < this.undoStack_.length;
        k.callback =
            this.undo.bind(this, !1);
        d.push(k);
        k = {};
        k.text = Blockly.Msg.REDO;
        k.enabled = 0 < this.redoStack_.length;
        k.callback = this.undo.bind(this, !0);
        d.push(k);
        this.isMovable() && (k = {}, k.text = Blockly.Msg.CLEAN_UP, k.enabled = 1 < e.length, k.callback = this.cleanUp.bind(this), d.push(k));
        if (this.options.collapse) {
            for (var l = k = !1, m = 0; m < e.length; m++)
                for (var n = e[m]; n;) n.isCollapsed() ? k = !0 : l = !0, n = n.getNextBlock();
            var p = function(a) {
            ...
            l.text = Blockly.Msg.COLLAPSE_ALL;
            l.callback = function() {
                p(!0)
            };
            d.push(l);
        ...
        var q = [];
        for (m = 0; m < e.length; m++) b(e[m]);
        k = {
            text: 1 == q.length ? Blockly.Msg.DELETE_BLOCK : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(q.length)),
            enabled: 0 < q.length,
            callback: function() {
                h.currentGesture_ && h.currentGesture_.cancel();
                2 > q.length ? c() : Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", q.length), function(a) {
                    a &&
                        c()
                })
            }
...
Blockly.WorkspaceSvg.prototype.focusSearch = function(a) {
    a ? this.toolbox_ && this.toolbox_.focusSearchField() : this.search_ && this.search_.focusSearchField()
};
...
Blockly.WorkspaceSvg.getContentDimensionsBounded_ = function(a, b) {
    var c = Blockly.WorkspaceSvg.getContentDimensionsExact_(a),
        ...
        g = d / 2,
        h = e / 2,
        k = Math.min(c.left - g, c.right - d),
        l = Math.min(c.top - h, c.bottom - e);
    return {
        left: k,
        top: l,
        height: Math.max(c.bottom + h, c.top + e) - l,
        width: Math.max(c.right + g, c.left + d) - k
    }
};
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function() {
    ...
    var e = Blockly.WorkspaceSvg.getContentDimensions_(this, d),
        g = 0;
    this.toolbox_ && this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT ? g = a.width : this.flyout_ && this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT && (g = b.width);
    var h = 0;
    this.toolbox_ && this.toolboxPosition == Blockly.TOOLBOX_AT_TOP ? h = a.height : this.flyout_ &&
        this.toolboxPosition == Blockly.TOOLBOX_AT_TOP && (h = b.height);
    return {
...
Blockly.inject = function(a, b) {
    ...
    var e = Blockly.createDom_(d, c),
        g = new Blockly.BlockDragSurfaceSvg(d);
...
Blockly.createDom_ = function(a, b) {
    ...
    var c = Blockly.utils.dom.createSvgElement("svg", {
        ...
        g = Blockly.utils.dom.createSvgElement("filter", {
    ...
    var h = Blockly.utils.dom.createSvgElement("feSpecularLighting", {
        "in": "blur",
        surfaceScale: 1,
        specularConstant: .5,
        specularExponent: 10,
    ...
    b.embossFilterId = g.id;
    g = Blockly.utils.dom.createSvgElement("pattern", {
                ...
                if (b.contentTop < b.viewTop || b.contentBottom > b.viewBottom || b.contentLeft < b.viewLeft || b.contentRight > b.viewRight) {
                    ...
                    switch (a.type) {
                        ...
                        case Blockly.Events.BLOCK_MOVE:
                            var g = e.getBlockById(a.blockId);
                            g = g.getRootBlock();
                            break;
                        case Blockly.Events.COMMENT_CREATE:
                        case Blockly.Events.COMMENT_MOVE:
                            g = e.getCommentById(a.commentId)
                    }
                    if (g) {
                        d =
                            g.getBoundingRectangle();
                        d.height = d.bottom - d.top;
                        d.width = d.right - d.left;
                        var n = b.viewTop,
                            p = b.viewBottom - d.height;
                        p = Math.max(n, p);
                        n = Blockly.utils.math.clamp(n, d.top, p) - d.top;
                        p = b.viewLeft;
                        var q = b.viewRight - d.width;
                        b.RTL ? p = Math.min(q, p) : q = Math.max(p, q);
                        b = Blockly.utils.math.clamp(p, d.left, q) - d.left;
                        g.moveBy(b, n)
                    }
...
Blockly.ASTNode.prototype.findNextForInput_ = function() {
    ...
    for (var c; c = b.inputList[a]; a++) {
        for (var d = c.fieldRow, e = 0, g; g = d[e]; e++)
            if (g.EDITABLE) return Blockly.ASTNode.createFieldNode(g);
...
Blockly.ASTNode.prototype.findPrevForInput_ = function() {
    for (var a = this.location_.getParentInput(), b = a.getSourceBlock(), c = b.inputList.indexOf(a), d; d = b.inputList[c]; c--) {
        ...
        d = d.fieldRow;
        for (var e = d.length - 1, g; g = d[e]; e--)
            if (g.EDITABLE) return Blockly.ASTNode.createFieldNode(g)
    }
    return null
};
...
Blockly.user.keyMap.createSerializedKey = function(a, b) {
    for (var c = "", d = Blockly.utils.object.values(Blockly.user.keyMap.modifierKeys), e = 0, g; g = b[e]; e++)
        if (-1 < d.indexOf(g)) c += g;
...
Blockly.navigation.modify_ = function() {
    ...
    var c = a.getType(),
        ...
        e = b.getLocation(),
        g = a.getLocation();
    if (a.isConnection() && b.isConnection()) return Blockly.navigation.connect_(e, g);
    if (a.isConnection() && (d == Blockly.ASTNode.types.BLOCK || d == Blockly.ASTNode.types.STACK)) return Blockly.navigation.insertBlock(e, g);
...
Blockly.navigation.connect_ = function(a, b) {
    ...
    var c = Blockly.navigation.getInferiorConnection_(a),
        ...
        g = Blockly.navigation.getInferiorConnection_(b);
    if (c && d && Blockly.navigation.moveAndConnect_(c, d) || e && g && Blockly.navigation.moveAndConnect_(e, g) || Blockly.navigation.moveAndConnect_(a, b)) return !0;
    try {
        b.checkConnection_(a)
    } catch (h) {
        Blockly.navigation.warn_("Connection failed with error: " + h)
    }
    return !1
};
...
Blockly.Procedures.flyoutCategory = function(a) {
    function b(a, b) {
        for (var d = 0; d < a.length; d++) {
            var e = a[d][0],
                g = a[d][1],
                h = Blockly.utils.xml.createElement("block");
            h.setAttribute("type", b);
            h.setAttribute("gap", 16);
            var p = Blockly.utils.xml.createElement("mutation");
            p.setAttribute("name", e);
            h.appendChild(p);
            for (e = 0; e < g.length; e++) {
                var q = Blockly.utils.xml.createElement("arg");
                q.setAttribute("name", g[e]);
                p.appendChild(q)
            }
            c.push(h)
        }
    ...
    var c = [];
    var d = Blockly.Xml.textToDom('<xml><label text="Function definition" web-class="subcategoryClass"></label></xml>');
    d = d.firstChild;
    c.push(d);
    ...
    Blockly.Blocks.procedures_defreturn && (d = Blockly.utils.xml.createElement("block"), d.setAttribute("type", "procedures_defreturn"),
        d.setAttribute("gap", 16), e = Blockly.utils.xml.createElement("field"), e.setAttribute("name", "NAME"), e.appendChild(Blockly.utils.xml.createTextNode(Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE)), d.appendChild(e), c.push(d));
    ...
    if (0 < a[0].length || 0 < a[1].length) d = Blockly.Xml.textToDom('<xml><sep gap="32"></sep><label text="Function execution" web-class="subcategoryClass"></label></xml>'),
        e = d.firstChild, d = d.lastChild, c.push(e), c.push(d);
    b(a[0], "procedures_callnoreturn");
    b(a[1], "procedures_callreturn");
    (function() {
        try {
            var a = JSON.parse(localStorage.getItem("storedFunctions"));
            null === a && (a = {})
        } catch (m) {
            console.log("Error parsing/reading storedFunctions information."), a = {}
        }
        if (a && 0 < Object.keys(a).length) {
            var b = Blockly.Xml.textToDom('<xml><sep gap="32"></sep><label text="Stored functions" web-class="subcategoryClass"></label></xml>');
            var d = b.lastChild;
            c.push(b.firstChild);
            c.push(d)
        }
        for (var e in a) b =
            a[e], b = (new DOMParser).parseFromString(b, "text/xml"), c.push(b.getElementsByTagName("block")[0])
    })();
    return c
};
Blockly.Procedures.getCallers = function(a, b) {
    for (var c = [], d = b.getAllBlocks(!1), e = 0; e < d.length; e++)
        if (d[e].getProcedureCall) {
            var g = d[e].getProcedureCall();
            g && Blockly.Names.equals(g, a) && c.push(d[e])
        } return c
};
Blockly.Procedures.mutateCallers = function(a) {
    ...
    for (var e; e = a[c]; c++) {
        ...
        e.domToMutation(d);
        var h = e.mutationToDom();
        h = h && Blockly.Xml.domToText(h);
        g != h && (Blockly.Events.recordUndo = !1, Blockly.Events.fire(new Blockly.Events.BlockChange(e, "mutation", null, g, h)), Blockly.Events.recordUndo = b)
    }
};
    ...
    if (a.length)
        for (var c = 1, d = 0, e = "ijkmnopqrstuvwxyzabcdefgh".charAt(d); !b;) {
            for (var g = !1, h = 0; h < a.length; h++)
                if (a[h].name.toLowerCase() == e) {
                    g = !0;
                    break
                } g ? (d++, 25 == d && (d = 0, c++), e = "ijkmnopqrstuvwxyzabcdefgh".charAt(d), 1 < c && (e += c)) : b = e
        } else b = "i";
    return b
};
    ...
    var d = c || "",
        e = function(c) {
            Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, c, function(c) {
                if (c) {
                    var g = Blockly.Variables.nameUsedWithAnyType_(c, a);
                    if (g) {
                        var h = c.toLowerCase();
                        if (g.type == d) var m = Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", h);
                        else m = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE, m = m.replace("%1", h).replace("%2", g.type);
                        Blockly.alert(m, function() {
                            e(c)
                        })
...
Blockly.Variables.renameVariable = function(a, b, c) {
    var d = function(e) {
        var g = Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", b.name);
        Blockly.Variables.promptName(g, e, function(e) {
            if (e) {
                var g = Blockly.Variables.nameUsedWithOtherType_(e, b.type, a);
                g ? (g = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace("%1", e.toLowerCase()).replace("%2", g.type), Blockly.alert(g, function() {
                    d(e)
...
Blockly.Variables.getAddedVariables = function(a, b) {
    ...
    if (b.length != c.length)
        for (var e = 0; e < c.length; e++) {
            var g = c[e]; - 1 == b.indexOf(g) && d.push(g)
        }
    return d
};
Blockly.WidgetDiv = {};
        ...
        if (b.options.readOnly) Blockly.navigation.onKeyPress(a);
            ...
            if (a.keyCode == Blockly.utils.KeyCodes.ESC) Blockly.hideChaff(), Blockly.navigation.onBlocklyAction(Blockly.navigation.ACTION_EXIT);
                ...
                if (a.keyCode == Blockly.utils.KeyCodes.BACKSPACE || a.keyCode == Blockly.utils.KeyCodes.DELETE) {
                    ...
                    if (a.keyCode == Blockly.utils.KeyCodes.V) {
                        if (Blockly.clipboardXml_) {
                            var d = Blockly.clipboardSource_;
                            d.isFlyout && (d = d.targetWorkspace);
                            Blockly.clipboardTypeCounts_ && d.isCapacityAvailable(Blockly.clipboardTypeCounts_) && (Blockly.Events.setGroup(!0), d.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1))
                        }
                    } else a.keyCode == Blockly.utils.KeyCodes.Z ? (Blockly.hideChaff(), b.undo(a.shiftKey)) : 70 == a.keyCode && d.focusSearch(a.shiftKey)
                }
            }
...
Blockly.alert = function(a, b) {
    console.log("Alert: " + a);
    Fable.View.Workspace.CustomDialog.show("Alert", a, {
        onCancel: b
    })
};
Blockly.confirm = function(a, b) {
    console.log("Confirm: " + a);
    Fable.View.Workspace.CustomDialog.show("Confirm", a, {
        showOkay: !0,
        onOkay: function() {
            b(!0)
        },
...
Blockly.prompt = function(a, b, c) {
    Fable.View.Workspace.CustomDialog.show("Prompt", a, {
        showInput: !0,
        showOkay: !0,
        onOkay: function() {
            c(Fable.View.Workspace.CustomDialog.inputField.value)
        },
        showCancel: !0,
        onCancel: function() {
            c(null)
    ...
    Fable.View.Workspace.CustomDialog.inputField.value = b
};
...
Blockly.evaluateSearchJson_ = function(a, b) {
    return function() {
        Blockly.Search.preprocessSearchKeywords(a, b)
    }
};
    ...
    for (var b = 0; b < a.length; b++) {
        ...
        if (c) {
            ...
            null == d || "" === d ? console.warn("Block definition #" + b + " in JSON array is missing a type attribute. Skipping.") : (Blockly.Blocks[d] && console.warn("Block definition #" + b + ' in JSON array overwrites prior definition of "' + d + '".'), Blockly.Blocks[d] = {
                ...
                ensureSearchKeywords: Blockly.evaluateSearchJson_(c.type, c.search_keywords)
            })
        } else console.warn("Block definition #" + b + " in JSON array is " +
            c + ". Skipping.")
    }
};
Blockly.bindEventWithChecks_ = function(a, b, c, d, e, g) {
    var h = !1,
        k = function(a) {
            var b = !e;
            a = Blockly.Touch.splitEventByTouches(a);
            for (var g = 0, k; k = a[g]; g++)
                if (!b || Blockly.Touch.shouldHandleEvent(k)) Blockly.Touch.setClientFromTouch(k), c ? d.call(c, k) : d(k), h = !0
        },
        l = [];
    if (Blockly.utils.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP)
        for (var m = 0, n; n = Blockly.Touch.TOUCH_MAP[b][m]; m++) a.addEventListener(n, k, !1), l.push([a, n, k]);
    else if (a.addEventListener(b, k, !1), l.push([a, b, k]), b in Blockly.Touch.TOUCH_MAP) {
        var p = function(a) {
            k(a);
            var b = !g;
            h && b && a.preventDefault()
        };
        for (m = 0; n = Blockly.Touch.TOUCH_MAP[b][m]; m++) a.addEventListener(n, p, !1), l.push([a, n, p])
    }
    return l
};
Blockly.bindEvent_ = function(a, b, c, d) {
    var e = function(a) {
        ...
        g = [];
    if (Blockly.utils.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP)
        for (var h = 0, k; k = Blockly.Touch.TOUCH_MAP[b][h]; h++) a.addEventListener(k, e, !1), g.push([a, k, e]);
    else if (a.addEventListener(b, e, !1), g.push([a, b, e]), b in Blockly.Touch.TOUCH_MAP) {
        var l = function(a) {
        ...
        for (h = 0; k = Blockly.Touch.TOUCH_MAP[b][h]; h++) a.addEventListener(k,
            l, !1), g.push([a, k, l])
    }
    return g
};
...
Blockly.checkBlockColourConstant_ = function(a, b, c) {
    for (var d = "Blockly", e = Blockly, g = 0; g < b.length; ++g) d += "." + b[g], e && (e = e[b[g]]);
...
Blockly.tree.BaseNode.prototype.getRowDom = function() {
    ...
    this.content_ instanceof HTMLElement ? a.appendChild(this.content_) : a.appendChild(this.getLabelDom());
    return a
};
    ...
    if (this.gauge_) {
        ...
        if (!isNaN(b)) {
            var e = Number(this.clockwise_),
                g = Blockly.utils.math.toRadians(this.offset_),
                h = Math.cos(g) * Blockly.FieldAngle.RADIUS,
                k = Math.sin(g) * -Blockly.FieldAngle.RADIUS;
            e && (b = 2 * g - b);
            ...
            e && (b = 1 - b);
            a.push(" l ", h, ",", k, " A ", Blockly.FieldAngle.RADIUS, ",", Blockly.FieldAngle.RADIUS, " 0 ", b, " ", e, " ", c, ",", d, " z")
        }
...
Blockly.AsciiInput = function(a, b) {
    Blockly.AsciiInput.superClass_.constructor.call(this, a, b)
};
Blockly.utils.object.inherits(Blockly.AsciiInput, Blockly.Field);
Blockly.AsciiInput.FONTSIZE = 11;
Blockly.AsciiInput.MIN_WIDTH = 50;
Blockly.AsciiInput.WIDGET_MIN_WIDTH = 0;
Blockly.AsciiInput.prototype.CURSOR = "button";
Blockly.AsciiInput.prototype.isSpecial = !0;
...
Blockly.AsciiInput.fromJson = function(a) {
    var b = Blockly.utils.replaceMessageReferences(a.text);
    return new Blockly.AsciiInput(b, a["class"])
};
Blockly.AsciiInput.prototype.setValue = function(a) {
    if (null !== a) {
...
Blockly.AsciiInput.prototype.setText = function(a) {
...
Blockly.AsciiInput.prototype.resizeInput_ = function() {
    if (void 0 == this.sourceBlock_ || void 0 == this.sourceBlock_.workspace.isFlyout || !this.sourceBlock_.workspace.isFlyout) {
        ...
        if (void 0 != this.size_) {
            ...
            b = a + 20;
            b < Blockly.AsciiInput.MIN_WIDTH && (b = Blockly.AsciiInput.MIN_WIDTH);
            b < Blockly.AsciiInput.WIDGET_MIN_WIDTH && (b = Blockly.AsciiInput.WIDGET_MIN_WIDTH);
            this.size_ = new Blockly.utils.Size(b, this.size_.height)
        }
        void 0 !=
...
Blockly.AsciiInput.prototype.showEditor_ = function(a) {
    this.workspace_ = this.sourceBlock_.workspace;
    a = a || !1;
    Blockly.WidgetDiv.show(this, this.sourceBlock_.RTL, this.widgetDispose_());
    var b = Blockly.WidgetDiv.DIV,
        c = document.createElement("input");
    c.setAttribute("id", "blocklyHtmlButtonInput");
    var d = Blockly.AsciiInput.FONTSIZE * this.workspace_.scale + "pt";
    b.style.fontSize = d;
    c.style.fontSize = d;
    d = this.fieldGroup_.getBBox();
    c.placeholder = Blockly.Msg.PRESS_ANY_KEY;
    Blockly.AsciiInput.WIDGET_MIN_WIDTH = 8 * c.placeholder.length;
    c.style.width = Blockly.AsciiInput.WIDGET_MIN_WIDTH * this.workspace_.scale + "px";
    c.style.height = d.height * this.workspace_.scale - 6 + "px";
    Blockly.AsciiInput.htmlInput_ = c;
    b.appendChild(c);
    this.validate_();
    this.resizeEditor_();
    a || (c.focus(), c.select());
...
Blockly.AsciiInput.prototype.onHtmlInputKeyDown_ = function(a) {
    var b = !0;
...
Blockly.AsciiInput.prototype.onInvalidButtonPressed_ = function() {
    var a = Blockly.WidgetDiv.DIV,
        b = a.children;
    a.blur();
    for (a = 0; a < b.length; a++) "blocklyHtmlButtonInput" == b[a].className && (b[a].placeholder = Blockly.Msg.INVALID_KEY_PRESSED, b[a].value = "", Blockly.AsciiInput.WIDGET_MIN_WIDTH = 8 * b[a].placeholder.length, b[a].style.width = Blockly.AsciiInput.WIDGET_MIN_WIDTH * this.sourceBlock_.workspace.scale + "px", this.resizeInput_(), b[a].className = "blocklyHtmlButtonInput button-input-error-1", b[a].focus(), b[a].select(),
        setTimeout(this.changePlaceholderAnimation_(b[a], 0), 300))
};
Blockly.AsciiInput.prototype.changePlaceholderAnimation_ = function(a, b) {
...
Blockly.AsciiInput.prototype.onResetPlaceholder_ = function(a) {
    a.className = "blocklyHtmlButtonInput";
    a.placeholder = Blockly.Msg.PRESS_ANY_KEY;
    0 < Blockly.AsciiInput.WIDGET_MIN_WIDTH && (Blockly.AsciiInput.WIDGET_MIN_WIDTH = 8 * a.placeholder.length, a.style.width = Blockly.AsciiInput.WIDGET_MIN_WIDTH * this.sourceBlock_.workspace.scale + "px", this.resizeInput_());
    a.focus();
    a.select()
};
Blockly.AsciiInput.prototype.keyDisplayParser_ = function(a) {
    console.log(a);
    var b = a.keyCode;
    switch (b) {
        case 32:
...
Blockly.AsciiInput.prototype.validate_ = function() {
    var a = !0;
    if ("object" == typeof Blockly.AsciiInput.htmlInput_ && null != Blockly.AsciiInput.htmlInput_) {
        var b = Blockly.AsciiInput.htmlInput_;
        this.sourceBlock_ && (a = this.callValidator(b.value));
        null === a ? Blockly.utils.dom.addClass(b, "blocklyInvalidInput") : Blockly.utils.dom.removeClass(b, "blocklyInvalidInput")
    }
};
...
Blockly.FieldBoolean.prototype.init = function() {
    this.fieldGroup_ || (this.fieldGroup_ = Blockly.utils.dom.createSvgElement("g", {}, null), this.borderPath_ = Blockly.utils.dom.createSvgElement("path", {
            d: "m 0,0",
            x: -Blockly.BlockSvg.SEP_SPACE_X / 2,
            y: 0
        }, this.fieldGroup_, this.sourceBlock_.workspace), this.textElement_ = Blockly.utils.dom.createSvgElement("text", {
            "class": "blocklyText",
        ...
        this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mousedown", this, this.onMouseDown_), this.fieldGroup_.style.cursor = this.CURSOR, Blockly.utils.dom.addClass(this.fieldGroup_, "blocklyEditableText"), Blockly.utils.dom.removeClass(this.fieldGroup_, "blocklyNonEditableText"))
};
...
Blockly.FieldBoolean.prototype.updateWidth = function() {
    var a = Blockly.Field.getCachedWidth(this.textElement_),
        b = a + this.ADDED_PADDING;
    b < this.MIN_WIDTH && (b = this.MIN_WIDTH);
    this.textElement_.setAttribute("x", (b - a) / 2);
    if (this.borderPath_) {
        b /= 2;
        var c = (this.size_.height - 5) / 2;
        this.borderPath_.setAttribute("d", "m 0,0 H " + a / 2 + " l " + c + "," + c + " v 5  l " + -c + "," + c + " H " + -a / 2 + " l " + -c + "," + -c + " v -5  l " + c + "," + -c + " z");
        this.borderPath_.setAttribute("transform", "translate(" + b + ",0)")
    }
    this.size_.width = a + this.ADDED_PADDING
};
Blockly.FieldBoolean.prototype.setValue = function(a) {
    a = "string" == typeof a ? "TRUE" == a.toUpperCase() : !!a;
    this.state_ !== a && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_, "field", this.name, this.state_, a)), this.state_ = a, Blockly.Field.prototype.setText.call(this, this.state_ ? Blockly.Msg.LOGIC_BOOLEAN_TRUE : Blockly.Msg.LOGIC_BOOLEAN_FALSE))
};
...
Blockly.ButtonInput.prototype.showEditor_ = function(a) {
    ...
    var b = Blockly.WidgetDiv.DIV,
        c = document.createElement("input");
    c.setAttribute("class", "blocklyHtmlButtonInput");
    var d = Blockly.ButtonInput.FONTSIZE * this.workspace_.scale + "pt";
    b.style.fontSize = d;
    c.style.fontSize = d;
    d = this.fieldGroup_.getBBox();
    c.placeholder = Blockly.Msg.PRESS_ANY_KEY;
    Blockly.ButtonInput.WIDGET_MIN_WIDTH = 8 * c.placeholder.length;
    c.style.width = Blockly.ButtonInput.WIDGET_MIN_WIDTH * this.workspace_.scale + "px";
    c.style.height = d.height * this.workspace_.scale - 6 + "px";
...
Blockly.ButtonInput.prototype.validate_ = function() {
    var a = !0;
    if ("object" == typeof Blockly.ButtonInput.htmlInput_ && null != Blockly.ButtonInput.htmlInput_) {
...
Blockly.FieldColour.prototype.moveHighlightBy_ = function(a, b) {
    ...
    e += a;
    g += b;
    0 > a ? 0 > e && 0 < g ? (e = d - 1, g--) : 0 > e && (e = 0) : 0 < a ? e > d - 1 && g < Math.floor(c.length / d) - 1 ? (e = 0, g++) : e > d - 1 && e-- : 0 > b ? 0 > g && (g = 0) : 0 < b && g > Math.floor(c.length / d) - 1 && (g = Math.floor(c.length / d) - 1);
    this.setHighlightedCell_(this.picker_.childNodes[g].childNodes[e], g * d + e)
};
...
Blockly.FieldColour.prototype.dropdownCreate_ = function() {
    ...
    for (var g, h = 0; h < b.length; h++) {
        0 == h % a && (g = document.createElement("tr"), Blockly.utils.aria.setRole(g, Blockly.utils.aria.Role.ROW), e.appendChild(g));
        var k = document.createElement("td");
        g.appendChild(k);
        k.label = b[h];
        k.title = c[h] || b[h];
        k.id = Blockly.utils.IdGenerator.getNextUniqueId();
        k.setAttribute("data-index", h);
        Blockly.utils.aria.setRole(k, Blockly.utils.aria.Role.GRIDCELL);
        Blockly.utils.aria.setState(k, Blockly.utils.aria.State.LABEL, b[h]);
        Blockly.utils.aria.setState(k, Blockly.utils.aria.State.SELECTED,
            b[h] == d);
        k.style.backgroundColor = b[h];
        b[h] == d && (k.className = "blocklyColourSelected", this.highlightedIndex_ = h)
    }
...
Blockly.FieldDropdown.prototype.dropdownCreate_ = function() {
    if (!this.shouldAllowSearch_) var a = new Blockly.Menu;
    ...
    a.filterInput_ && (a.filterInput_.setAttribute("placeholder", "Search"), a.filterInput_.setAttribute("id", "dropdownSearchInput"), b = this.sourceBlock_.colour_, b = "#dropdownSearchInput { border-bottom: 2px solid " + b + "; }#dropdownSearchInput:focus { background-color: " + b + "; }", this.styleTag_ || (this.styleTag_ = document.createElement("style")), this.styleTag_.styleSheet ? this.styleTag_.styleSheet.cssText =
        b : this.styleTag_.appendChild(document.createTextNode(b)), document.getElementsByTagName("head")[0].appendChild(this.styleTag_));
...
Blockly.FieldDropdown.applyTrim_ = function(a, b, c) {
    for (var d = [], e = [], g = 0; g < a.length; g++) {
        var h = a[g][0],
            k = a[g][1];
        h = h.substring(b, h.length - c);
        d[g] = [h, k];
        e.push(h)
    }
    this.longestOption = Blockly.utils.string.longestString(e);
    return d
};
...
Blockly.FieldDropdown.changeRecentModuleColors = function(a, b) {
    var c = document.getElementsByClassName("blocklyWidgetDiv");
    if (0 < c.length && (c = c[0], "none" !== c.style.display && (c = c.children, 0 < c.length))) {
        c = c[0];
        var d = [],
            e = [],
            g = ["Hub", "Dongle", "Joint", "Spin", "Face"],
            h;
        for (h in g) {
            var k = g[h];
            if (a && k in a)
                for (var l in a[k]) d.push(a[k][l][0]);
            if (b && k in b)
                for (var m in b[k]) e.push(b[k][m][0])
        }
        for (h = 0; h < c.children.length; h++) l = c.children[h], m = l.innerText, void 0 != m && (m = m.trim(), "Hub" != m && (m = m.toUpperCase()), !d.includes(m) &&
            e.includes(m) ? l.children[0].className = "goog-menuitem-content recent-module" : "goog-menuitem-content recent-module" === l.children[0].className && (l.children[0].className = "goog-menuitem-content"))
    }
};
Blockly.FieldDropdown.validateOptions_ = function(a) {
    ...
    for (var b = !1, c = 0; c < a.length; ++c) {
        var d = a[c];
        "string" == typeof d && (d = [d, d], a[c] = d);
        Array.isArray(d) ? 1 == d.length ? (d.push(d[0]), a[c] = d) : "string" != typeof d[1] ? (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option id must be a string. Found " + d[1] + " in: ", d)) : d[0] && "string" != typeof d[0] &&
            "string" != typeof d[0].src && (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option must have a string label or image description. Found" + d[0] + " in: ", d)) : (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option must be an array. Found: ", d));
        "string" != typeof d[1] && (b = !0, console.error("Invalid option[" + c + "]: Each FieldDropdown option id must be a string. Found " + d[1] + " in: ", d))
    }
...
Blockly.FieldImage = function(a, b, c, d, e, g, h) {
    ...
    Blockly.FieldImage.superClass_.constructor.call(this,
        a || "", null, h);
    h || (this.flipRtl_ = !!g, this.altText_ = Blockly.utils.replaceMessageReferences(d) || "");
...
/*
 ...
 limitations under the License.
*/
Blockly.FieldJointAngle = function(a, b) {
    this.symbol_ = Blockly.utils.dom.createSvgElement("tspan", {}, null);
    this.symbol_.appendChild(document.createTextNode("\u00b0"));
    a = a && !isNaN(a) ? String(a) : "0";
    Blockly.FieldJointAngle.superClass_.constructor.call(this, a, b)
};
Blockly.utils.object.inherits(Blockly.FieldJointAngle, Blockly.FieldTextInput);
Blockly.FieldJointAngle.fromJson = function(a) {
    return new Blockly.FieldJointAngle(a.angle)
};
Blockly.FieldJointAngle.ROUND = 15;
Blockly.FieldJointAngle.HALF = 50;
Blockly.FieldJointAngle.CLOCKWISE = !0;
...
Blockly.FieldJointAngle.prototype.dispose_ = function() {
    var a = this;
    return function() {
        Blockly.FieldJointAngle.superClass_.dispose_.call(a)();
        a.gauge_ = null;
...
Blockly.FieldJointAngle.prototype.showEditor_ = function() {
    Blockly.FieldJointAngle.superClass_.showEditor_.call(this, Blockly.utils.userAgent.MOBILE || Blockly.utils.userAgent.ANDROID || Blockly.utils.userAgent.IPAD);
    var a = Blockly.WidgetDiv.DIV;
    if (a.firstChild) {
        a = Blockly.utils.dom.createSvgElement("svg", {
            ...
            width: 2 * Blockly.FieldJointAngle.HALF +
                "px"
        }, a);
        var b = Blockly.utils.dom.createSvgElement("path", {
            d: "M " + Blockly.FieldJointAngle.HALF + "," + Blockly.FieldJointAngle.HALF + " l " + Blockly.FieldJointAngle.HALF + ",0 A " + Blockly.FieldJointAngle.HALF + "," + Blockly.FieldJointAngle.HALF + " 0 0 0 0," + Blockly.FieldJointAngle.HALF + " z",
            "class": "blocklyAngleCircle"
        }, a);
        ...
        for (var c = 195; 360 > c; c += 15) Blockly.utils.dom.createSvgElement("line", {
            x1: Blockly.FieldJointAngle.HALF + Blockly.FieldJointAngle.RADIUS,
            y1: Blockly.FieldJointAngle.HALF,
            x2: Blockly.FieldJointAngle.HALF + Blockly.FieldJointAngle.RADIUS - (0 == c % 45 ? 10 : 5),
            y2: Blockly.FieldJointAngle.HALF,
            "class": "blocklyAngleMarks",
            transform: "rotate(" + c + "," + Blockly.FieldJointAngle.HALF + "," + Blockly.FieldJointAngle.HALF + ")"
        }, a);
        Blockly.utils.dom.createSvgElement("line", {
            x1: 0,
            y1: Blockly.FieldJointAngle.HALF,
            x2: 2 * Blockly.FieldJointAngle.RADIUS,
            y2: Blockly.FieldJointAngle.HALF,
            "class": "blocklyAngleMarks",
            transform: "rotate(0," + Blockly.FieldJointAngle.HALF + "," + Blockly.FieldJointAngle.HALF + ")"
        }, a);
        a.style.marginLeft = 15 - Blockly.FieldJointAngle.RADIUS + "px";
...
Blockly.FieldJointAngle.prototype.onMouseMove = function(a) {
    var b = this.gauge_.ownerSVGElement.getBoundingClientRect(),
        c = a.clientX - b.left - Blockly.FieldJointAngle.HALF;
    a = a.clientY - b.top - Blockly.FieldJointAngle.HALF;
    b = Math.atan(-a / c);
    isNaN(b) || (b = Blockly.utils.math.toDegrees(b), 0 > c ? b += 180 : 0 < a && (b += 360), b = Blockly.FieldJointAngle.CLOCKWISE ? Blockly.FieldJointAngle.OFFSET + 360 - b : b - Blockly.FieldJointAngle.OFFSET, Blockly.FieldJointAngle.ROUND && (b = Math.round(b / Blockly.FieldJointAngle.ROUND) * Blockly.FieldJointAngle.ROUND),
        b = this.callValidator(b), Blockly.FieldTextInput.htmlInput_.value = b, this.setValue(b), this.validate_(), this.resizeEditor_())
};
Blockly.FieldJointAngle.prototype.setText = function(a) {
    Blockly.FieldJointAngle.superClass_.setText.call(this, a);
    this.textElement_ && (this.updateGraph_(), this.size_.width = 0)
};
Blockly.FieldJointAngle.prototype.updateGraph_ = function() {
    if (this.gauge_) {
        var a = Number(this.getText()) + 2 * Blockly.FieldJointAngle.OFFSET,
            b = Blockly.utils.math.toRadians(a);
        a = ["M ", Blockly.FieldJointAngle.HALF, ",", Blockly.FieldJointAngle.HALF];
        var c = Blockly.FieldJointAngle.HALF,
            d = Blockly.FieldJointAngle.HALF;
        if (!isNaN(b)) {
            var e = Blockly.utils.math.toRadians(Blockly.FieldJointAngle.OFFSET),
                g = Math.cos(e) * Blockly.FieldJointAngle.RADIUS,
                h = Math.sin(e) * -Blockly.FieldJointAngle.RADIUS;
            Blockly.FieldJointAngle.CLOCKWISE &&
                (b = 2 * e - b);
            c += Math.cos(b) * Blockly.FieldJointAngle.RADIUS;
            d -= Math.sin(b) * Blockly.FieldJointAngle.RADIUS;
            b = Math.abs(Math.floor((b - e) / Math.PI) % 2);
            Blockly.FieldJointAngle.CLOCKWISE && (b = 1 - b);
            a.push(" l ", g, ",", h, " A ", Blockly.FieldJointAngle.RADIUS, ",", Blockly.FieldJointAngle.RADIUS, " 0 ", b, " ", Number(Blockly.FieldJointAngle.CLOCKWISE), " ", c, ",", d, " z")
        }
        this.gauge_.setAttribute("d", a.join(""));
        this.line_.setAttribute("x2", c);
        this.line_.setAttribute("y2", d)
...
Blockly.FieldJointAngle.prototype.classValidator = function(a) {
    if (null === a) return null;
    a = parseFloat(a || 0);
    if (isNaN(a)) return null;
    a %= 360;
    0 > a && (a += 360);
    a > Blockly.FieldJointAngle.WRAP && (a -= 360);
    return String(a)
};
...
Blockly.FieldNumber = function(a, b, c, d, e, g) {
    this.min_ = -Infinity;
    this.max_ = Infinity;
    this.precision_ = 0;
    this.decimalPlaces_ = null;
    Blockly.FieldNumber.superClass_.constructor.call(this, a || 0, e, g);
...
Blockly.FieldVariable.prototype.setTypes_ = function(a, b) {
    ...
    if (null == a || void 0 == a) var d = null;
        ...
        d = a;
        for (var e = !1, g = 0; g < d.length; g++) d[g] == c && (e = !0);
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    this.permanentlyDisabled_.length =
        0;
    for (var d = this.horizontalLayout_ ? this.GAP_X : this.GAP_Y, e = 0, g; g = a[e]; e++)
        if (g.tagName) switch (g.tagName.toUpperCase()) {
            case "BLOCK":
                var h = Blockly.Xml.domToBlock(g, this.workspace_);
                h.isEnabled() || this.permanentlyDisabled_.push(h);
                b.push({
                    type: "block",
                    block: h
                });
            ...
            case "SEP":
                g = parseInt(g.getAttribute("gap"), 10);
                !isNaN(g) && 0 < c.length ? c[c.length - 1] = g : c.push(d);
                break;
            case "LABEL":
            case "BUTTON":
                h = "LABEL" == g.tagName.toUpperCase();
                if (!Blockly.FlyoutButton) throw Error("Missing require for Blockly.FlyoutButton");
                g = new Blockly.FlyoutButton(this.workspace_, this.targetWorkspace_, g, h);
                b.push({
                    type: "button",
                    button: g
                });
...
Blockly.Flyout.prototype.placeNewBlock_ = function(a) {
    ...
    var d = b.getOriginOffsetInPixels(),
        ...
        g = a.getRelativeToSurfaceXY();
    g.scale(this.workspace_.scale);
    e = Blockly.utils.Coordinate.sum(e, g);
    d = Blockly.utils.Coordinate.difference(e, d);
    d.scale(1 / b.scale);
    c.moveBy(d.x, d.y);
    try {
        incrementCounter(a)
...
Blockly.HorizontalFlyout.prototype.layout_ = function(a, b) {
    ...
    for (var e = 0, g; g = a[e]; e++)
        if ("block" == g.type) {
            g = g.block;
            for (var h = g.getDescendants(!1), k = 0, l; l = h[k]; k++) l.isInFlyout = !0;
            g.render();
            h = g.getSvgRoot();
            k = g.getHeightWidth();
            l = g.outputConnection ? this.tabWidth_ : 0;
            l = this.RTL ? d + k.width : d - l;
            g.moveBy(l, c);
            l = this.createRect_(g, l, c, k, e);
            d += k.width + b[e];
            this.addBlockListeners_(h, g, l)
        } else "button" ==
            g.type && (this.initFlyoutButton_(g.button, d, c), d += g.button.width + b[e])
};
...
Blockly.VerticalFlyout.prototype.layout_ = function(a, b) {
    this.workspace_.scale = this.targetWorkspace_.scale;
    for (var c = this.MARGIN, d = this.RTL ? c : c + this.tabWidth_, e = 0, g; g = a[e]; e++)
        if ("block" == g.type) {
            g = g.block;
            for (var h = g.getDescendants(!1), k = 0, l; l = h[k]; k++) l.isInFlyout = !0;
            g.render();
            h = g.getSvgRoot();
            k = g.getHeightWidth();
            l = g.outputConnection ? d - this.tabWidth_ : d;
            g.moveBy(l, c);
            l = this.createRect_(g, this.RTL ? l - k.width : l, c, k, e);
            this.addBlockListeners_(h, g, l);
            c += k.height + b[e]
        } else "button" == g.type && (this.initFlyoutButton_(g.button,
            d, c), c += g.button.height + b[e])
};
...
Blockly.blockRendering.ConstantProvider.prototype.makePuzzleTab = function() {
    function a(a) {
        ...
        var d = -a,
            ...
            g = e + 2.5,
            m = e + .5,
            n = Blockly.utils.svgPaths.point(-b, a * e);
        e = Blockly.utils.svgPaths.point(b, a * e);
        return Blockly.utils.svgPaths.curve("c", [Blockly.utils.svgPaths.point(0, a * g), Blockly.utils.svgPaths.point(-b, d * m), n]) + Blockly.utils.svgPaths.curve("s", [Blockly.utils.svgPaths.point(b, 2.5 * d), e])
    }
...
Blockly.blockRendering.RenderInfo.prototype.computeBounds_ = function() {
    for (var a = 0, b = 0, c = 0, d = 0, e; e = this.rows[d]; d++) {
        ...
        if (e.hasStatement) {
            var g = e.getLastInput();
            a = Math.max(a, e.width - g.width)
        }
...
Blockly.geras.Highlighter.prototype.drawInlineInput = function(a) {
    var b = this.highlightOffset_,
        ...
        g = d + b;
    this.RTL_ ? (d = a.connectionOffsetY - b, a = a.height - (a.connectionOffsetY + a.connectionHeight) + b, this.inlineSteps_ += Blockly.utils.svgPaths.moveTo(c - b, g) + Blockly.utils.svgPaths.lineOnAxis("v", d) + this.puzzleTabPaths_.pathDown(this.RTL_) + Blockly.utils.svgPaths.lineOnAxis("v", a) + Blockly.utils.svgPaths.lineOnAxis("h", e)) : this.inlineSteps_ +=
        Blockly.utils.svgPaths.moveTo(a.xPos + a.width + b, g) + Blockly.utils.svgPaths.lineOnAxis("v", a.height) + Blockly.utils.svgPaths.lineOnAxis("h", -e) + Blockly.utils.svgPaths.moveTo(c, d + a.connectionOffsetY) + this.puzzleTabPaths_.pathDown(this.RTL_)
};
...
Blockly.geras.RenderInfo.prototype.addElemSpacing_ = function() {
    ...
    for (b = 0; c = this.rows[b]; b++) {
        ...
        for (var e = 0; e < d.length - 1; e++) {
            c.elements.push(d[e]);
            var g = this.getInRowSpacing_(d[e], d[e + 1]);
            c.elements.push(new Blockly.blockRendering.InRowSpacer(this.constants_, g))
        }
        c.elements.push(d[d.length -
            1]);
        c.endsWithElemSpacer() && (g = this.getInRowSpacing_(d[d.length - 1], null), a && c.hasDummyInput && (g += this.constants_.TAB_WIDTH), c.elements.push(new Blockly.blockRendering.InRowSpacer(this.constants_, g)))
    }
};
...
Blockly.geras.HighlightConstantProvider.prototype.makeInsideCorner = function() {
    var a = this.constantProvider.CORNER_RADIUS,
        ...
        g = Blockly.utils.svgPaths.moveBy(c, -c) + Blockly.utils.svgPaths.arc("a", "0 0,0", a + b, Blockly.utils.svgPaths.point(a - c, c + b));
    return {
        width: a + b,
        height: a,
        pathTop: function(a) {
...
Blockly.geras.HighlightConstantProvider.prototype.makeOutsideCorner = function() {
    var a = this.constantProvider.CORNER_RADIUS,
        ...
        g = -c,
        h = Blockly.utils.svgPaths.moveBy(c, g) + Blockly.utils.svgPaths.arc("a", "0 0,1", a - b, Blockly.utils.svgPaths.point(-c +
            b, -g - a));
    return {
        height: a,
        topLeft: function(a) {
...
Blockly.geras.HighlightConstantProvider.prototype.makePuzzleTab = function() {
    var a = this.constantProvider.TAB_WIDTH,
        ...
        g = Blockly.utils.svgPaths.moveBy(-5, b - .7) + Blockly.utils.svgPaths.lineTo(.46 * a, -2.1);
    return {
        width: a,
        height: b,
        pathUp: function(a) {
...
Blockly.Toolbox.prototype.syncTrees_ = function(a, b, c, d) {
    for (var e = null, g = null, h = 0, k; k = a.childNodes[h]; h++)
        if (k.tagName) switch (k.tagName.toUpperCase()) {
            case "CATEGORY":
                g = Blockly.utils.replaceMessageReferences(k.getAttribute("name"));
                var l = this.tree_.createNode(g);
                l.onSizeChanged(this.handleNodeSizeChanged_);
                l.blocks = [];
                b.add(l);
                var m = k.getAttribute("custom");
                m ? l.blocks = m : (m = d && k.getAttribute("name") != Blockly.Msg.MOST_USED, (m = this.syncTrees_(k, l, c, m)) && (e = m));
                m = k.getAttribute("categorystyle");
                var n =
                    k.getAttribute("colour");
                n && m ? (l.hexColour = "", console.warn('Toolbox category "' + g + '" can not have both a style and a colour')) : m ? this.setColourFromStyle_(m, l, g) : this.setColour_(n, l, g);
                "true" == k.getAttribute("expanded") ? (l.blocks.length && (e = l), l.setExpanded(!0)) : l.setExpanded(!1);
                g = k;
                break;
            case "SEP":
                if (g && "CATEGORY" == g.tagName.toUpperCase()) {
                ...
                case "BLOCK":
                    d &&
                        (g = k.getAttribute("type"), this.search_.onBlockAdded(g, k));
                    b.blocks.push(k);
                    g = k;
                    break;
                case "SEARCH":
                    g = new Blockly.Toolbox.TreeSearch(this, this.search_), g.hexColour = "#144bb2", b.add(g), g = k
        }
    return e
};
...
Blockly.Toolbox.prototype.addColour_ = function(a) {
    ...
    for (var b = 0, c; c = a[b]; b++) {
        ...
        if (d) {
            var e = this.hasColours_ ? "16px solid " + (c.hexColour || "#ddd") : "none";
...
Blockly.Toolbox.prototype.focusSearchField = function() {
    this.tree_.setSelectedItem(null);
    for (var a = this.tree_.getChildren(), b = 0; b < a.length; b++) {
        var c = a[b];
        if (c.focusSearchField) {
            c.focusSearchField();
            break
        } else c.blur()
    }
};
Blockly.Toolbox.TreeSearch = function(a, b) {
    this.toolbox_ = a;
    this.search_ = b;
    var c = document.createElement("input");
    c.setAttribute("id", "blockSearchInput");
    c.setAttribute("type", "search");
    c.setAttribute("placeholder", "Search");
    Blockly.tree.TreeNode.call(this, a, c, Blockly.Toolbox.TreeSearch.CONFIG_)
};
...
Blockly.Toolbox.TreeSearch.prototype.enterDocument = function() {
    ...
    var a = this.toolbox_,
        b = this.search_,
        c = this.getElement().getElementsByTagName("input")[0];
    this.searchField_ = c;
    ...
    c.addEventListener("keyup", function(c) {
        if (27 == c.keyCode) a.flyout_.hide(), this.blur();
        else {
            var d = [];
            c = c.target.value.trim().toLowerCase().split(/\s+/);
            0 < c.length && (c = Blockly.Toolbox.TreeSearch.filter(c, function(a) {
                return 0 < a.length
            }), 0 < c.length && (d = b.blocksMatchingSearchTerms(c)));
            c = Blockly.utils.xml.createElement("label");
            c.setAttribute("web-class", "subcategoryClass");
            0 < d.length ? c.setAttribute("text", "Search results:") : c.setAttribute("text", "No results found");
            d.splice(0, 0, c);
            a.flyout_.show(d);
...
Blockly.Toolbox.TreeSearch.filter = function(a, b, c) {
