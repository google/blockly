...
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TIP = "Checks if the received message was a broadcast message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TITLE = "Check for broadcast message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_MESSAGE_TIP = "Compares the broadcast message with the given message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_MESSAGE_TITLE = "Compare broadcast message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_NUMBER_TIP = "Compares the broadcast number with the given number";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_NUMBER_TITLE = "Compare broadcast number";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_DISABLE_TIP = "Disables the short messages";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_DISABLE_TITLE = "Disable short message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_ENABLE_TIP = "Enables the short messages";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_ENABLE_TITLE = "Enable short message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_TIP = "Reads the number from the broadcast message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_TITLE = "Get broadcast number";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_AND_NUMBER_TIP = "Broadcast a message and a number to all OXOcards";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TIP = "Broadcast a message to all OXOcards";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TITLE = "Send broadcast message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_FIELD = "and number";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TIP = "Broadcast a number to all OXOcards";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TITLE = "Send broadcast number";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_FIELD = "with timeout";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_TIP = "Waits for a given time for a message";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIP = "Waits until a new message arives";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TITLE = "Wait for messages";  // untranslated
