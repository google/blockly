 ...
 * fable: spirit of old age.
 * @author ivan@shaperobotics.com (Ivan Mladenov)
 */
'use strict';

goog.provide('Blockly.fable');
goog.provide('Blockly.fable.RenderInfo');
...
goog.require('Blockly.fable.InlineInput');
goog.require('Blockly.fable.StatementInput');
 ...
 *
 * @param {!Blockly.fable.Renderer} renderer The renderer in use.
 * @param {!Blockly.BlockSvg} block The block to measure.
 * @constructor
 * @package
 * @extends {Blockly.blockRendering.RenderInfo}
 */
Blockly.fable.RenderInfo = function (renderer, block) {
  Blockly.fable.RenderInfo.superClass_.constructor.call(this, renderer, block);
};
Blockly.utils.object.inherits(Blockly.fable.RenderInfo,
  Blockly.blockRendering.RenderInfo);

/**
 * Get the block renderer in use.
 * @return {!Blockly.fable.Renderer} The block renderer in use.
 * @package
 */
Blockly.fable.RenderInfo.prototype.getRenderer = function () {
  return /** @type {!Blockly.fable.Renderer} */ (this.renderer_);
};

/**
 * @override
 */
Blockly.fable.RenderInfo.prototype.addInput_ = function (input, activeRow) {
  // Non-dummy inputs have visual representations onscreen.
  if (this.isInline && input.type == Blockly.INPUT_VALUE) {
    activeRow.elements.push(
      new Blockly.fable.InlineInput(this.constants_, input));
    activeRow.hasInlineInput = true;
  } else if (input.type == Blockly.NEXT_STATEMENT) {
    activeRow.elements.push(
      new Blockly.fable.StatementInput(this.constants_, input));
    ...
    if (hasLargeImage) {
      this.topRow.minHeight = this.constants_.Y_MARGIN_TOP_WITH_IMAGE;
      this.bottomRow.minHeight = this.constants_.Y_MARGIN_TOP_WITH_IMAGE;
    }
 ...
 * @override
 */
Blockly.fable.RenderInfo.prototype.addElemSpacing_ = function () {
 ...
 * @override
 */
Blockly.fable.RenderInfo.prototype.getInRowSpacing_ = function (prev, next) {
  if (!prev) {
 ...
 * @override
 */
Blockly.fable.RenderInfo.prototype.addAlignmentPadding_ = function (row, missingSpace) {
 ...
 * @override
 */
Blockly.fable.RenderInfo.prototype.getSpacerRowHeight_ = function (prev, next) {
 ...
 * @override
 */
Blockly.fable.RenderInfo.prototype.getElemCenterline_ = function (row, elem) {
 ...
 * @override
 */
Blockly.fable.RenderInfo.prototype.finalize_ = function () {
