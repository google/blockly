...
messages["ADD_COMMENT"] = "Lasseet komment";
messages["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "Ij lah máhđulâš sikkođ muttojeijee '%1' tanen ko tot lii uási funktio miäruštâllâm '%2'";
messages["CHANGE_VALUE_TITLE"] = "Mute áárvu:";
...
messages["COLOUR_BLEND_COLOUR1"] = "ivne 1";
messages["COLOUR_BLEND_COLOUR2"] = "ivne 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "koskâvuotâ";
messages["COLOUR_BLEND_TITLE"] = "siävuttâs";
messages["COLOUR_BLEND_TOOLTIP"] = "Siävvut kyevti ivne koskânis adelum koskâvuođâst (0.0 - 1.0).";
messages["COLOUR_PICKER_HELPURL"] = "https://smn.wikipedia.org/wiki/Ivne";
messages["COLOUR_PICKER_TOOLTIP"] = "Valjii ivne paletist.";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "säti-ivne";
messages["COLOUR_RANDOM_TOOLTIP"] = "Valjii ivne sätioornigist.";
messages["COLOUR_RGB_BLUE"] = "čuovjâd";
messages["COLOUR_RGB_GREEN"] = "ruánáá";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "ruopsâd";
messages["COLOUR_RGB_TITLE"] = "ivne, mast lii";
messages["COLOUR_RGB_TOOLTIP"] = "Räähti ivne, mast lii tiätu meeri ruopsâd, ruánáá já čuovjâd. Puoh áárvuh kalgeh leđe 0 já 100 kooskâst.";
...
messages["CONTROLS_IF_MSG_ELSE"] = "mudoi";
messages["CONTROLS_IF_MSG_ELSEIF"] = "mudoi jis";
messages["CONTROLS_IF_MSG_IF"] = "jis";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "poorgâ";
messages["CONTROLS_REPEAT_TITLE"] = "kiärdut %1 tove";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "kiärdut tassaaš ko";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "kiärdut ton puudâ ko";
...
messages["DELETE_VARIABLE"] = "Siho muttojeijee '%1'";
messages["DELETE_VARIABLE_CONFIRMATION"] = "Sikkop-uv %1 kevttim muttojeijeest '%2'?";
messages["DELETE_X_BLOCKS"] = "Delete %1 Blocks";  // untranslated
messages["DIALOG_CANCEL"] = "Jooskâ";
messages["DIALOG_OK"] = "OK";
messages["DISABLE_BLOCK"] = "Disable Block";  // untranslated
messages["DUPLICATE_BLOCK"] = "Jyemeehpittá";
messages["DUPLICATE_COMMENT"] = "Dublikist komment";
...
messages["EXTERNAL_INPUTS"] = "Olgoldâs fáluseh";
messages["HELP"] = "Iše";
messages["INLINE_INPUTS"] = "Pyevti fálusijd";
...
messages["LISTS_GET_INDEX_FIRST"] = "vuosmuš";
...
messages["LISTS_GET_INDEX_LAST"] = "majemuš";
messages["LISTS_GET_INDEX_RANDOM"] = "sätinálásâš";
messages["LISTS_GET_INDEX_REMOVE"] = "siho";
...
messages["LISTS_INLIST"] = "listoost";
...
messages["LOGIC_BOOLEAN_FALSE"] = "epituotâ";
...
messages["LOGIC_BOOLEAN_TRUE"] = "tuotâ";
...
messages["LOGIC_TERNARY_CONDITION"] = "testâ";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "jis epituotâ";
messages["LOGIC_TERNARY_IF_TRUE"] = "jis tuotâ";
...
messages["MATH_CHANGE_TITLE"] = "mute %1 árvoin %2";
messages["MATH_CHANGE_TOOLTIP"] = "Lasseet áárvu muttojeijen '%1'.";
...
messages["MATH_IS_DIVISIBLE_BY"] = "puáhtá jyehiđ lovvoin";
messages["MATH_IS_EVEN"] = "lii parâlâš";
messages["MATH_IS_NEGATIVE"] = "lii negatiivlâš";
messages["MATH_IS_ODD"] = "lii parâttem";
messages["MATH_IS_POSITIVE"] = "lii positiivlâš";
messages["MATH_IS_PRIME"] = "lii algâloho";
messages["MATH_IS_TOOLTIP"] = "Täärhist lii-uv nummeer parâlâs, parâttem, algâloho, olesloho, positiivlâš, negatiivlâš, teikkâ jis tom puáhtá jyehiđ nube lovvoin. Maaccât tuotâ teikkâ epituotâ.";
messages["MATH_IS_WHOLE"] = "lii olesloho";
...
messages["MATH_NUMBER_TOOLTIP"] = "Loho.";
messages["MATH_ONLIST_HELPURL"] = "";  // untranslated
messages["MATH_ONLIST_OPERATOR_AVERAGE"] = "koskâárvu lovoin";
messages["MATH_ONLIST_OPERATOR_MAX"] = "stuárráámus lovoin";
messages["MATH_ONLIST_OPERATOR_MEDIAN"] = "mediaan lovoin";
messages["MATH_ONLIST_OPERATOR_MIN"] = "ucemus lovoin";
...
messages["MATH_ONLIST_OPERATOR_SUM"] = "summe lovoin";
messages["MATH_ONLIST_TOOLTIP_AVERAGE"] = "Maaccât aritmaattisâš koskâáárvu adelum lovoin.";
messages["MATH_ONLIST_TOOLTIP_MAX"] = "Maaccât stuárráámuu adelum lovoin.";
messages["MATH_ONLIST_TOOLTIP_MEDIAN"] = "Maaccât adelum lovoi mediaan.";
messages["MATH_ONLIST_TOOLTIP_MIN"] = "Maaccât ucemuu adelum lovoin.";
...
messages["MATH_ONLIST_TOOLTIP_SUM"] = "Maaccât puoh adelum lovoi sume.";
...
messages["MATH_ROUND_OPERATOR_ROUND"] = "jurbii";
messages["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "jurbii vuáluskulij";
messages["MATH_ROUND_OPERATOR_ROUNDUP"] = "jurbii pajaskulij";
messages["MATH_ROUND_TOOLTIP"] = "Jorbee lovo pajas- teikkâ vuáluskulij.";
messages["MATH_SINGLE_HELPURL"] = "https://en.wikipedia.org/wiki/Square_root";  // untranslated
messages["MATH_SINGLE_OP_ABSOLUTE"] = "jiešárvu";
messages["MATH_SINGLE_OP_ROOT"] = "neljihâšruotâs";
...
messages["NEW_COLOUR_VARIABLE"] = "Räähti ivnemuttojeijee...";
messages["NEW_NUMBER_VARIABLE"] = "Räähti nummeermuttojeijee...";
messages["NEW_STRING_VARIABLE"] = "Räähti merkkâráiđumuttojeijee...";
messages["NEW_VARIABLE"] = "Räähti muttojeijee...";
messages["NEW_VARIABLE_TITLE"] = "Uđđâ muttojeijee nommâ:";
messages["NEW_VARIABLE_TYPE_TITLE"] = "Uđđâ muttojeijee tijppâ:";
messages["ORDINAL_NUMBER_SUFFIX"] = "";  // untranslated
messages["PROCEDURES_ALLOW_STATEMENTS"] = "allow statements";  // untranslated
messages["PROCEDURES_BEFORE_PARAMS"] = "parameettereh:";
...
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "parameettereh:";
messages["PROCEDURES_CREATE_DO"] = "Create '%1'";  // untranslated
messages["PROCEDURES_DEFNORETURN_COMMENT"] = "Valdâl taam funktio...";
...
messages["PROCEDURES_DEFNORETURN_PROCEDURE"] = "poorgâ maidnii";
messages["PROCEDURES_DEFNORETURN_TITLE"] = "to";  // untranslated
messages["PROCEDURES_DEFNORETURN_TOOLTIP"] = "Räähti puáđushánnáá leijee funktio.";
messages["PROCEDURES_DEFRETURN_HELPURL"] = "https://en.wikipedia.org/wiki/Subroutine";  // untranslated
messages["PROCEDURES_DEFRETURN_RETURN"] = "maaccât";
...
messages["PROCEDURES_MUTATORARG_TITLE"] = "fáálus nommâ:";
messages["PROCEDURES_MUTATORARG_TOOLTIP"] = "Add an input to the function.";  // untranslated
messages["PROCEDURES_MUTATORCONTAINER_TITLE"] = "fáluseh";
messages["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] = "Add, remove, or reorder inputs to this function.";  // untranslated
messages["REDO"] = "Räähti uđđâsist";
messages["REMOVE_COMMENT"] = "Siho komment";
messages["RENAME_VARIABLE"] = "Noomât uđđâsist muttojeijee...";
messages["RENAME_VARIABLE_TITLE"] = "Noomât uđđâsist puoh '%1' muttojeijee:";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "labde";
...
messages["TODAY"] = "Onne";
messages["UNDO"] = "Koomeet";
messages["UNNAMED_KEY"] = "nomâttem";
messages["VARIABLES_DEFAULT_NAME"] = "tiŋgâ";
...
messages["VARIABLE_ALREADY_EXISTS"] = "Muttojeijee mon nommâ lii '%1' lii jo lemin.";
messages["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "Muttojeijee, mon nommâ lii '%1', lii jo lemin nube tiijpân: '%2'.";
messages["WORKSPACE_ARIA_LABEL"] = "Blockly Workspace";  // untranslated
messages["WORKSPACE_COMMENT_DEFAULT_TEXT"] = "Eeđâ maidnii...";
