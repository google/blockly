...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">avança</span><span id="Maze_turnLeft">vira a esquèrra</span><span id="Maze_turnRight">vira a drecha</span><span id="Maze_doCode">far</span><span id="Maze_elseCode">siquenon</span><span id="Maze_helpIfElse">Un blòt \'Se-Siquenon\' executa una causa o una autra.</span><span id="Maze_pathAhead">se camin davant</span><span id="Maze_pathLeft">se camin cap a esquèrra</span><span id="Maze_pathRight">se camin cap a drecha</span><span id="Maze_repeatUntil">repetís fins a</span><span id="Maze_moveForwardTooltip">Fa avançar sénher Pegman en avant d\'un espaci.</span><span id="Maze_turnTooltip">Fa virar sénher Pegman a esquèrra o a drecha de 90 grases.</span><span id="Maze_ifTooltip">Se i a un camin dins la direccion especificada, alara efectua aquelas accions.</span><span id="Maze_ifelseTooltip">Se i a un camin dins la direccion especificada, alara fasètz lo premièr blòt d\'accions. Siquenon fasètz lo segond blòt d\'accions.</span><span id="Maze_whileTooltip">Repetíse los blòts que son a l\'interior fins a aténher la tòca.</span><span id="Maze_capacity0">Te demòra %0 blòt.</span><span id="Maze_capacity1">Te demòra %1 blòt.</span><span id="Maze_capacity2">Te demòran %2 blòts.</span><span id="Maze_nextLevel">Òsca ! Sètz prèst pel nivèl %1?</span><span id="Maze_finalLevel">Òsca ! As acabat lo darrièr nivèl.</span></div>';
};
