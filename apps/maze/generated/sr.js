...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">иди напред</span><span id="Maze_turnLeft">окрени се лево</span><span id="Maze_turnRight">окрени се десно</span><span id="Maze_doCode">изведи</span><span id="Maze_elseCode">иначе</span><span id="Maze_helpIfElse">Ако-у-супротмом блок урадиће једно или друго.</span><span id="Maze_pathAhead">ако постоји пут напред</span><span id="Maze_pathLeft">ако постоји пут лово</span><span id="Maze_pathRight">ако постоји пут десно</span><span id="Maze_repeatUntil">понављај док не</span><span id="Maze_moveForwardTooltip">Помера Штипаљка једну позицију напред.</span><span id="Maze_turnTooltip">Окреће играча улево или удесно за 90 степени.</span><span id="Maze_ifTooltip">Ако постоји пут у датом правцу, \\nонда изврши неке радње. </span><span id="Maze_ifelseTooltip">Ако постоји пут у датом правцу, \\nонда изврши први блок радњи. У \\nсупротном, изврши други. </span><span id="Maze_whileTooltip">Понављајте задате радње док се не дође до краја.</span><span id="Maze_capacity0">Преостало вам је %0 блокова.</span><span id="Maze_capacity1">Преостао вам је %1 блок.</span><span id="Maze_capacity2">Преостало вам је %2 блокова.</span><span id="Maze_nextLevel">Честитамо! Јесте ли спремни да пређете на ниво %1?</span><span id="Maze_finalLevel">Честитамо! Решили сте последњи ниво.</span></div>';
};
