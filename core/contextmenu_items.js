...
Blockly.ContextMenuItems.registerCollapse = function() {
  ...
  var collapseOption = {
    ...
    callback: function(
        /** @type {!Blockly.ContextMenuRegistry.Scope} */ scope) {
      Blockly.ContextMenuItems.toggleOption_(
          true, scope.workspace.getTopBlocks(true));
    },
    scopeType: Blockly.ContextMenuRegistry.ScopeType.WORKSPACE,
...
Blockly.ContextMenuItems.registerExpand = function() {
  ...
  var expandOption = {
    ...
    callback: function(
        /** @type {!Blockly.ContextMenuRegistry.Scope} */ scope) {
      Blockly.ContextMenuItems.toggleOption_(
          false, scope.workspace.getTopBlocks(true));
    },
    scopeType: Blockly.ContextMenuRegistry.ScopeType.WORKSPACE,
    id: 'toggleWorkspace',
    weight: 0,
 ...
 * @param {!Array.<!Blockly.BlockSvg>} deleteList list of blocks that can be
 *     deleted. This will be
...
Blockly.ContextMenuItems.deleteNext_ = function(deleteList, eventGroup) {
  ...
  if (block) {
    if (block.workspace) {
      ...
      setTimeout(
          Blockly.ContextMenuItems.deleteNext_, DELAY, deleteList, eventGroup);
    } else {
...
Blockly.ContextMenuItems.registerDeleteAll = function() {
  ...
  var deleteOption = {
    ...
    callback: function(
      ...
      var deletableBlocks =
          Blockly.ContextMenuItems.getDeletableBlocks_(scope.workspace);
      ...
      if (deletableBlocks.length < 2) {
        ...
        Blockly.confirm(
            Blockly.Msg['DELETE_ALL_BLOCKS'].replace(
                '%1', deletableBlocks.length),
            function(ok) {
              if (ok) {
                Blockly.ContextMenuItems.deleteNext_(
                    deletableBlocks, eventGroup);
              }
            });
      }
    },
...
Blockly.ContextMenuItems.registerInline = function() {
  ...
  var inlineOption = {
    displayText: function(
        /** @type {!Blockly.ContextMenuRegistry.Scope} */ scope) {
      return (scope.block.getInputsInline()) ? Blockly.Msg['EXTERNAL_INPUTS'] :
...
Blockly.ContextMenuItems.registerDisable = function() {
  ...
  var disableOption = {
    displayText: function(
        /** @type {!Blockly.ContextMenuRegistry.Scope} */ scope) {
      return (scope.block.isEnabled()) ? Blockly.Msg['DISABLE_BLOCK'] :
...
Blockly.ContextMenuItems.registerHelp = function() {
  ...
  var helpOption = {
    ...
    preconditionFn: function(
        /** @type {!Blockly.ContextMenuRegistry.Scope} */ scope) {
      var block = scope.block;
      var url = (typeof block.helpUrl == 'function') ? block.helpUrl() :
                                                       block.helpUrl;
      if (url) {
        return 'enabled';
      }
