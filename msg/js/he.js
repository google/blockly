...
Blockly.Msg["CONTROLS_FOR_TOOLTIP"] = "לעשות שהערך ‚%1’ יקבל את הערכים מהמספר ההתחלתי עד המספר הסופי, בהתאם למרווח שהוגדר, ולבצע את המקטעים הנבחרים.";
...
Blockly.Msg["TEXT_CREATE_JOIN_TOOLTIP"] = "הוספה, הסרה או סידור סעיפים מחדש כדי להגדיר את מקטע הטקסט הזה מחדש.";
