...
Blockly.FieldImage = function(
  ...
  Blockly.FieldImage.superClass_.constructor.call(this, src, null, opt_config);
  ...
  this.size_ = new Blockly.utils.Size(
      imageWidth, imageHeight + Blockly.FieldImage.Y_PADDING);
...
Blockly.FieldImage.prototype.doValueUpdate_ = function(newValue) {
  ...
  if (this.imageElement_) {
    this.imageElement_.setAttributeNS(
        Blockly.utils.dom.XLINK_NS, 'xlink:href', String(this.value_));
  }
};
