...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Renkennadoù : %1</span><span id="Plane_getRows">renkennadoù (%1)</span><span id="Plane_rows1">Renkennadoù kentañ klas : %1</span><span id="Plane_getRows1">Renkennadoù kentañ klas (%1)</span><span id="Plane_rows2">Renkennadoù eil klas : %1</span><span id="Plane_getRows2">Renkennadoù eil klas (%1)</span><span id="Plane_seats">Azezennoù : %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">azezennoù =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Jederez azezenn nijerez</span> &nbsp; ';
