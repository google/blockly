 ...
 * @param {!Array.<string>} variableTypes A list of the types of variables to
 *     include in the dropdown.
 * @extends {Blockly.FieldDropdown}
 * @constructor
 */
Blockly.FieldVariable = function(varname, opt_validator, variableTypes) {
...
Blockly.FieldVariable.dropdownCreate = function() {
  ...
  if (workspace) {
    ...
    for (var i = 0, variableType; i < variableTypes.length; i++) {
...
Blockly.FieldVariable.prototype.onItemSelected = function(menu, menuItem) {
  ...
  if (this.sourceBlock_ && this.sourceBlock_.workspace) {
    ...
    if (variable) {
      ...
      Blockly.Variables.renameVariable(workspace, null, variable.type,
        currentName);
      return;
