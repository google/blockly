...
appsIndex.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="indexTitle">אפליקציות בלוקלי</ span><span id="indexFooter">בלוקלי הוא חינם ומבוסס קוד פתוח. בכדי לתרום קוד או תרגומים לבלוקלי, או כדי להשתמש בבלוקלי באפליקציה שלך, בקר ב־ %1<span></div>';
};


appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">אפליקציות בלוקלי</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>בלוקלי היא סביבת פיתוח גרפית. בהמשך ישנן מספר דוגמאות לאפליקציות אשר משתמשות בבלוקלי.</td></tr></table><table><tr><td><a href="maze/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/maze.png" height=80 width=100></a></td><td><div><a href="maze/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">מבוך</a></div><div>השתמש בבלוקלי בכדי לפתור מבוך</div></td></tr><tr><td><a href="turtle/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/turtle.png" height=80 width=100></a></td><td><div><a href="turtle/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">גרפיקת צב</a></div><div>השתמש בבלוקלי כדי לצייר</div></td></tr><tr><td><a href="graph/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/graph.png" height=80 width=100></a></td><td><div><a href="graph/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">מחשבון גרפים</a></div><div>הצג פונקציות עם בלוקלי</div></td></tr><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">קוד</a></div><div>ייצא תוכנית בלוקלי לג\'אווה סקריפט, פייתון או XML.</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">מחשבון מושב במטוס</a></div><div>פתור בעייה חשבונית עם משתנה אחד או שניים</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
