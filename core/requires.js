...
// Flyout close buttons add a small "close" button next to each flyout, so users can close the flyouts easily.
goog.require('Blockly.FlyoutCloseButton');
...
goog.require('Blockly.fable.Renderer');
