...
appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">برنامه\u200Cهای بلوکلی</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>بلوکلی یک محیط برنامه\u200Cنویسی گرافیک است.  در زیر نمونه برنامه\u200Cهایی وجود دارد که از بلوکلی استفاده می\u200Cکند.</td></tr></table><table><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">کد</a></div><div>خارج\u200Cسازی یک برنامه بلوکلی به جاوااسکریپت، پایتون، دارت و اکس\u200Cام\u200Cال.</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">محاسبه\u200Cگر صندلی\u200Cهای هواپیما</a></div><div>حل یک مسألهٔ ریاضی با یک یا دو متغییر.</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
