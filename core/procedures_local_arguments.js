 ...
 */
  ...
  * @namespace Blockly.ProceduresLocalArgument
  */
 goog.module('Blockly.ProceduresLocalArgument');
 ...
 const allProcedures = function(root) {
   const proceduresLocalNoReturn =
       root.getBlocksByType('procedures_with_argument_defnoreturn', false).map(function(block) {
  ...
  * @this {Field}
  * @alias Blockly.ProceduresLocalArgument.rename
  */
  ...
  * @alias Blockly.ProceduresLocalArgument.mutatorOpenListener
  * @package
  */
  ...
  * @alias Blockly.ProceduresLocalArgument.getCallers
  */
  ...
  * @alias Blockly.ProceduresLocalArgument.mutateCallers
  */
  ...
  * @alias Blockly.ProceduresLocalArgument.getDefinition
  */
