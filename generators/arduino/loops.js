...
Arduino['controls_repeat'] = function(block) {
  ...
  var loopVar = Arduino.variableDB_.getDistinctName(
...
Arduino['controls_repeat_ext'] = function(block) {
  ...
  if (!repeats.match(/^\w+$/) && !Blockly.isNumber(repeats)) {
    var endVar = Arduino.variableDB_.getDistinctName(
...
Arduino['controls_for'] = function(block) {
  ...
  if (Blockly.isNumber(argument0) && Blockly.isNumber(argument1) &&
    ...
    if (!argument0.match(/^\w+$/) && !Blockly.isNumber(argument0)) {
      var startVar = Arduino.variableDB_.getDistinctName(
    ...
    var incVar = Arduino.variableDB_.getDistinctName(
