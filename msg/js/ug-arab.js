...
messages["ADD_COMMENT"] = "ئىزاھات قوشۇش";
...
messages["CHANGE_VALUE_TITLE"] = "قىممەت ئۆزگەرتىش:";
messages["CLEAN_UP"] = "بۆلەكنى رەتلەش";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "قاتلىنىش بۆلىكى";
messages["COLLAPSE_BLOCK"] = "قاتلىنىش بۆلىكى";
messages["COLOUR_BLEND_COLOUR1"] = "رەڭ 1";
messages["COLOUR_BLEND_COLOUR2"] = "رەڭ 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "نىسبەت";
messages["COLOUR_BLEND_TITLE"] = "ئارىلاش";
messages["COLOUR_BLEND_TOOLTIP"] = "Blends two colours together with a given ratio (0.0 - 1.0).";  // untranslated
messages["COLOUR_PICKER_HELPURL"] = "https://zh.wikipedia.org/wiki/رەڭگى";
messages["COLOUR_PICKER_TOOLTIP"] = " تاختىدىن رەڭنى تاللاڭ";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "خالىغان رەڭ";
messages["COLOUR_RANDOM_TOOLTIP"] = "ئىختىيارىي بىر رەڭنى تاللاڭ";
messages["COLOUR_RGB_BLUE"] = "كۆك";
messages["COLOUR_RGB_GREEN"] = "يېشىل";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "قىزىل";
messages["COLOUR_RGB_TITLE"] = "رەڭگى";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "ئۈزۈلۈپ ئايلىنىش";
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = " كىيىنكى قېتىم داۋاملىق ئايلىنىشن";
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "ئۇنىڭ دەۋرىي ئۈزۈلۈش ئۆز ئىچىگە ئالىدۇ .";
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] = "بۇ ئايلىنىشنىڭ قالغان قىسمى ئاتلاپ ئۆتۈپ كېتىدۇ ، ھەمدە داۋاملىق كېلەر قېتىملىق ئىتېراتسىيە .";
messages["CONTROLS_FLOW_STATEMENTS_WARNING"] = "ئاگاھلاندۇرۇش : بۇ پەقەت بىر ئايلىنىش دەۋرى ئىچىدە ئىشلىتىشكە بولىدۇ .";
...
messages["CONTROLS_IF_ELSEIF_TOOLTIP"] = "بۇ بىلمەيمىز جۈملە بۆلىكى قوشۇلۇپ بىر if شەرتى .";
messages["CONTROLS_IF_ELSE_TOOLTIP"] = "ئەڭ ئاخىرقى قوشۇش ، ھەممە ئەھۋالنى ئۆز ئىچىگە ئالىدۇ بايرىمىدا بىلمەيمىز ifپارچىلىرى .";
messages["CONTROLS_IF_HELPURL"] = "https://github.com/google/blockly/wiki/IfElse";  // untranslated
messages["CONTROLS_IF_IF_TOOLTIP"] = "كۆپۈيۈپ كىتىدۇ، ئۆچۈرۈش ياكى قايتا تىزىلغان بايرام « if （ سۆزىنىڭ پارچە قايتىدىن تەقسىملەش .";
messages["CONTROLS_IF_MSG_ELSE"] = "ئۇنداق بولمىسا";
messages["CONTROLS_IF_MSG_ELSEIF"] = "ئۇنداق بولمىسا ئەگەر";
messages["CONTROLS_IF_MSG_IF"] = "ئەگەر";
messages["CONTROLS_IF_TOOLTIP_1"] = "ئەگەر قىممىتى ھەقىقەتەن ، بەزى جۈملە .";
messages["CONTROLS_IF_TOOLTIP_2"] = "ئەگەر قىممىتى ھەقىقەتەن ، ئۇنداقتا نىڭ بىر جۈملە . ئۇنداق بولمايدىكەن، ئىككىنچى جۈملىسى ئىجرا قىلىندى .";
messages["CONTROLS_IF_TOOLTIP_3"] = "ئەگەر تۇنجى قىممىتى ھەقىقەتەن ، ئۇنداقتا نىڭ بىر جۈملە . ئۇنداق بولمايدىكەن، ئەگەر ئىككىنچى قىممىتى ، ئۇنداقتا ئىككىنچى پارچىنىڭ جۈملە .";
messages["CONTROLS_IF_TOOLTIP_4"] = "ئەگەر تۇنجى قىممىتى ھەقىقەتەن ، ئۇنداقتا نىڭ بىر جۈملە . ئۇنداق بولمايدىكەن، ئەگەر ئىككىنچى قىممىتى ، بولسا ئىجرا قىلىش جۈملىسى ئىشككى پارچە . ئەگەر قىممىتى يوق ، ئۇنداقتا ئەڭ ئاخىرقى بىر جۈملىسى .";
messages["CONTROLS_REPEAT_HELPURL"] = "https://zh.wikipedia.org/wiki/Forئايلىنىش";
messages["CONTROLS_REPEAT_INPUT_DO"] = "ئىجرا";
messages["CONTROLS_REPEAT_TITLE"] = "تەكرار %1قېتىم";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "تەكرارلىقى";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "تەكرار بولۇش";
...
messages["DELETE_ALL_BLOCKS"] = "ھەممىنى ئۆچۈرۈش %1 پارچىمۇ؟";
messages["DELETE_BLOCK"] = "بۆلەك ئۆچۈرۈش";
messages["DELETE_VARIABLE"] = "“%1” ئۆزگەرگۈچى مىقدارنى ئۆچۈرۈش";
messages["DELETE_VARIABLE_CONFIRMATION"] = "ئۆچۈرۈش “%2” ئۆزگەرگۈچى مىقدار%1 ئىشلىتىلىش ئورنى بارمۇ؟";
messages["DELETE_X_BLOCKS"] = "بۆلەك %1 نى ئۆچۈرۈش";
messages["DIALOG_CANCEL"] = "ۋاز كەچ";
messages["DIALOG_OK"] = "ماقۇل";
messages["DISABLE_BLOCK"] = "چەكلەنگەن بۆلەك";
messages["DUPLICATE_BLOCK"] = "كۆچۈرۈش";
messages["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
messages["ENABLE_BLOCK"] = "قوزغىتىلغان بۆلەك";
messages["EXPAND_ALL"] = "ئېچىلىش بۆلىكى";
messages["EXPAND_BLOCK"] = "ئېچىلىش بۆلىكى";
messages["EXTERNAL_INPUTS"] = "سىرتقى كىرگۈزۈش";
messages["HELP"] = "ياردەم";
messages["INLINE_INPUTS"] = "تاق قۇرلۇق كىرگۈزۈش";
...
messages["LISTS_GET_INDEX_FIRST"] = "تۇنجى";
messages["LISTS_GET_INDEX_FROM_END"] = "# from end";  // untranslated
messages["LISTS_GET_INDEX_FROM_START"] = "#";  // untranslated
messages["LISTS_GET_INDEX_GET"] = "قولغا كەلتۈرۈش";
messages["LISTS_GET_INDEX_GET_REMOVE"] = "get and remove";  // untranslated
messages["LISTS_GET_INDEX_LAST"] = "ئاخىرقى";
messages["LISTS_GET_INDEX_RANDOM"] = "خالىغانچە";
messages["LISTS_GET_INDEX_REMOVE"] = "چىقىرىۋىتىش";
...
messages["LISTS_SET_INDEX_INSERT"] = "قىستۇرۇڭ";
messages["LISTS_SET_INDEX_SET"] = "تەڭشەك";
...
messages["LISTS_SORT_ORDER_ASCENDING"] = "يۇقىرىغا";
messages["LISTS_SORT_ORDER_DESCENDING"] = "تۆۋەنگە";
messages["LISTS_SORT_TITLE"] = "sort %1 %2 %3";  // untranslated
messages["LISTS_SORT_TOOLTIP"] = "Sort a copy of a list.";  // untranslated
messages["LISTS_SORT_TYPE_IGNORECASE"] = "ھەرب بويىچە تىزىل، چوڭ كىچىك يېزىلىش ھېساپ قىلىنمايدۇ";
messages["LISTS_SORT_TYPE_NUMERIC"] = "سان بويىچە تىزىل";
messages["LISTS_SORT_TYPE_TEXT"] = " ھەرپ بويىچە تىزىل";
...
messages["LOGIC_BOOLEAN_FALSE"] = "يالغان";
messages["LOGIC_BOOLEAN_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
messages["LOGIC_BOOLEAN_TOOLTIP"] = "راست ياكى يالغان قايتىش";
messages["LOGIC_BOOLEAN_TRUE"] = "ھەقىقىي";
messages["LOGIC_COMPARE_HELPURL"] = "https://zh.wikipedia.org/wiki/ تەڭ ئەمەس";
messages["LOGIC_COMPARE_TOOLTIP_EQ"] = "ئەگەر ئىككى دانە كىرگۈزۈش نەتىجىسى تەڭ بولسا ، راستىنلا كەينىگە قايتسا.";
messages["LOGIC_COMPARE_TOOLTIP_GT"] = "ئەگەر تۇنجى كىرگۈزۈش نەتىجىسى ئىشككىنچى چوڭ بولسا راستىنلا كەينىگە قايتسا .";
messages["LOGIC_COMPARE_TOOLTIP_GTE"] = "ئەگەر تۇنجى كىرگۈزۈش نەتىجىدە ئىشككىنچى كىچىك بولسا راستىنلا كەينىگە قايتسا .";
messages["LOGIC_COMPARE_TOOLTIP_LT"] = "ئەگەر تۇنجى كىرگۈزۈش نەتىجىدە ئىشككىنچى كىچىك بولسا راستىنلا كەينىگە قايتسا .";
messages["LOGIC_COMPARE_TOOLTIP_LTE"] = "ئەگەر تۇنجى كىرگۈزۈش نەتىجىسى ئىككىنچى كىرگۈزۈش نەتىجىسى تىن تۆۋەن ياكى شۇنىڭغا تەڭ بولسا راستىنلا كەينىگە قايتسا .";
messages["LOGIC_COMPARE_TOOLTIP_NEQ"] = "ئەگەر ئىككى دانە كىرگۈزۈش نەتىجىسى تەڭ بولمايدۇ ، بەك كەلدى .";
messages["LOGIC_NEGATE_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#not";  // untranslated
messages["LOGIC_NEGATE_TITLE"] = "ئەمەس%1";
messages["LOGIC_NEGATE_TOOLTIP"] = "Returns true if the input is false. Returns false if the input is true.";  // untranslated
messages["LOGIC_NULL"] = "قۇرۇق";
messages["LOGIC_NULL_HELPURL"] = "https://en.wikipedia.org/wiki/Nullable_type";  // untranslated
messages["LOGIC_NULL_TOOLTIP"] = " نۆلگە قايتىش";
messages["LOGIC_OPERATION_AND"] = "ۋە";
messages["LOGIC_OPERATION_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#logical-operations";  // untranslated
messages["LOGIC_OPERATION_OR"] = "ياكى";
...
messages["LOGIC_TERNARY_CONDITION"] = "سىناق";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "ئەگەر يالغان بولسا";
messages["LOGIC_TERNARY_IF_TRUE"] = "ئەگەر راست بولسا";
...
messages["MATH_ARITHMETIC_HELPURL"] = "https://zh.wikipedia.org/wiki/ئارىفمېتىكىلىق";
...
messages["MATH_CHANGE_HELPURL"] = "https://zh.wikipedia.org/wiقوشۇش";
messages["MATH_CHANGE_TITLE"] = " ئۆزگەرتىش %1 دىن %2";
messages["MATH_CHANGE_TOOLTIP"] = "Add a number to variable '%1'.";  // untranslated
messages["MATH_CONSTANT_HELPURL"] = "https://zh.wikipedia.org/wiki/ماتېماتىكا تۇراقلىق سانى";
...
messages["MATH_IS_DIVISIBLE_BY"] = "پۈتۈن بۆلۈنۈش";
messages["MATH_IS_EVEN"] = "جۈپ سان";
messages["MATH_IS_NEGATIVE"] = " مەنپى";
messages["MATH_IS_ODD"] = " تاق سان";
messages["MATH_IS_POSITIVE"] = "مۇسبەت";
messages["MATH_IS_PRIME"] = "تۈپ سان";
...
messages["MATH_IS_WHOLE"] = "پۈتۈن سان";
messages["MATH_MODULO_HELPURL"] = "https://zh.wikipedia.org/wiki/مودېل ھېسابى";
...
messages["MATH_NUMBER_HELPURL"] = "https://zh.wikipedia.org/wiki/سان";
messages["MATH_NUMBER_TOOLTIP"] = "بىر سان.";
messages["MATH_ONLIST_HELPURL"] = "";  // untranslated
messages["MATH_ONLIST_OPERATOR_AVERAGE"] = "جەدۋەل ئىچىدىكى ئوتتۇرىچە سان";
messages["MATH_ONLIST_OPERATOR_MAX"] = " جەدۋەلدىكى ئەڭ چوڭ قىممەت";
messages["MATH_ONLIST_OPERATOR_MEDIAN"] = "جەدۋەلدىكى ئوتتۇرا سان";
messages["MATH_ONLIST_OPERATOR_MIN"] = "جەدۋەل ئىچىدىكى ئەڭ كىچىك قىممەت";
messages["MATH_ONLIST_OPERATOR_MODE"] = " جەدۋەل ھالىتى";
...
messages["MATH_ONLIST_TOOLTIP_MEDIAN"] = " جەدۋەلدىكى ئوتتۇرا سانغا قايتىش";
messages["MATH_ONLIST_TOOLTIP_MIN"] = " جەدۋەلدىكى ئەڭ كىچىك سانغا قايتىش";
...
messages["MATH_ROUND_HELPURL"] = "https://zh.wikipedia.org/wiki/سانلىق قىممەت تۈزىتىش";
messages["MATH_ROUND_OPERATOR_ROUND"] = "تۆۋەنگە تارتىڭ";
messages["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "تۆۋەنگە تارتىڭ";
messages["MATH_ROUND_OPERATOR_ROUNDUP"] = " تۆۋەنگە تارتىڭ";
messages["MATH_ROUND_TOOLTIP"] = "Round a number up or down.";  // untranslated
messages["MATH_SINGLE_HELPURL"] = "https://zh.wikipedia.org/wiki/كۋادرات يىلتىز";
messages["MATH_SINGLE_OP_ABSOLUTE"] = "مۇتلەق";
messages["MATH_SINGLE_OP_ROOT"] = " كۋادرات يىلتىز";
...
messages["MATH_TRIG_HELPURL"] = "https://zh.wikipedia.org/wiki/ترىگونومېتىرىيىلىك فۇنكسىيە";
...
messages["NEW_VARIABLE"] = "ئۆزگەرگۈچى مىقدار ... قۇرۇش";
messages["NEW_VARIABLE_TITLE"] = "يېڭى ئۆزگەرگۈچى مىقدار نامى:";
...
messages["REDO"] = "قايتىلاش";
messages["REMOVE_COMMENT"] = "ئىزاھاتنى ئۆچۈرۈش";
messages["RENAME_VARIABLE"] = "ئۆزگەرگۈچى مىقدارغا قايتا نام قويۇش";
messages["RENAME_VARIABLE_TITLE"] = "بارلىق بۆلەك “%1\" ئۆزگەرگۈچى مىقدار قايتا ناملىنىپ :";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "   قوشۇش";
...
messages["TODAY"] = "بۈگۈن";
messages["UNDO"] = "يېنىۋال";
messages["UNNAMED_KEY"] = "unnamed";  // untranslated
messages["VARIABLES_DEFAULT_NAME"] = "تۈر";
...
messages["VARIABLE_ALREADY_EXISTS"] = "ئىسم مەۋجۇت “%1” ئۆزگەرگۈچى";
messages["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "ئىسىملىك“%1” ئۆزگەرگۈچى مىقدار مەۋجۇت بولۇپ تۇرىدۇ ، لېكىن يەنە بىر ئۆزگەرگۈچى مىقدار تىپى بولۇش سۈپىتى بىلەن “%2” مەۋجۇت .";
