...
appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">블록리 앱</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>Blockly는 그래픽 프로그래밍 환경을 제공합니다. 아래는 Blockly를 사용하는 몇가지 예시 프로그램들입니다.</td></tr></table><table><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">코드</a></div><div>블록리 프로그램을 자바스크립트, 파이썬, 다트 또는 XML로 내보냅니다.</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">비행기 좌석 계산기</a></div><div>하나 또는 두개의 변수를 가진 수학 문제를 풉니다.</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
