...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">mara ke hadapan</span><span id="Maze_turnLeft">belok kiri</span><span id="Maze_turnRight">belok kanan</span><span id="Maze_doCode">lakukan</span><span id="Maze_elseCode">jika tidak</span><span id="Maze_helpIfElse">Blok \'jika-jika tidak\' akan memilih salah satu tindakan yang diberikan.</span><span id="Maze_pathAhead">jika ada laluan ke hadapan</span><span id="Maze_pathLeft">jika ada laluan ke kiri</span><span id="Maze_pathRight">jika ada laluan ke kanan</span><span id="Maze_repeatUntil">ulangi sehingga</span><span id="Maze_moveForwardTooltip">Mengalihkan Pegman satu petak ke hadapan.</span><span id="Maze_turnTooltip">Membelokkan Pegman 90 darjah ke kiri atau ke kanan.</span><span id="Maze_ifTooltip">Jika terdapat laluan ke arah yang tertentu, lakukan beberapa tindakan.</span><span id="Maze_ifelseTooltip">Jika terdapat laluan ke arah yang tertentu, ambil blok tindakan yang pertama. Jika tidak, ambil blok tindakan yang kedua.</span><span id="Maze_whileTooltip">Ulangi tindakan-tindakan yang dilampirkan sehingga titik penamat dicapai.</span><span id="Maze_capacity0">Tinggal %0 blok.</span><span id="Maze_capacity1">Tinggal %1 blok.</span><span id="Maze_capacity2">Tinggal %2 blok.</span><span id="Maze_nextLevel">Tahniah! Adakah anda sedia untuk meningkat ke peringkat %1?</span><span id="Maze_finalLevel">Tahniah! Anda telah menyelesaikan peringkat terakhir.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Pagar Sesat</span> &nbsp; ';
