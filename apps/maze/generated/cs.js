...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">pohyb vpřed</span><span id="Maze_turnLeft">otočit levá</span><span id="Maze_turnRight">otočit pravá</span><span id="Maze_doCode">udělej</span><span id="Maze_elseCode">jinak</span><span id="Maze_helpIfElse">Příkaz \'pokud-jinak\' provede buď něco, nebo něco jiného.</span><span id="Maze_pathAhead">pokud cesta vpřed</span><span id="Maze_pathLeft">pokud cesta doleva</span><span id="Maze_pathRight">pokud cesta doprava</span><span id="Maze_repeatUntil">opakuj až do</span><span id="Maze_moveForwardTooltip">Pohne Pegmanem vpřed o jedno pole.</span><span id="Maze_turnTooltip">Otočí Pegmana vlevo nebo vpravo o 90 stupňů.</span><span id="Maze_ifTooltip">Pokud je v daném směru cesta, pak proveď nějakou akci.</span><span id="Maze_ifelseTooltip">Pokud je v danném směru cesta, pak proveď posloupnost akcí. V opačném případě proveď druhou posloupnost akcí.</span><span id="Maze_whileTooltip">Opakuj obsažené akce do té doby, dokud není dosažen cílový bod.</span><span id="Maze_capacity0">Počet zbývajících bloků %0.</span><span id="Maze_capacity1">Počet zbývajících bloků %1.</span><span id="Maze_capacity2">Počet zbývajících bloků %2.</span><span id="Maze_nextLevel">Blahopřejeme! Jsi připraven vstoupit do levelu %1?</span><span id="Maze_finalLevel">Blahopřejeme! Vyřešil jsi poslední level.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Bludiště</span> &nbsp; ';
