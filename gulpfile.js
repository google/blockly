...
function prependHeader() {
  return gulp.insert.prepend(`// Do not edit this file; automatically generated by build.py.\n`);
}
...
/**
 * This task compiles Blockly's core files.
...
/**
 * This task compiles the Blockly's built in blocks.
 ...
 */
function compileGenerator(language, namespace) {
...
/**
 * This task compiles the javascript generator.
 *     javascript_compressed.js
 */
gulp.task('compile-javascript', function() {
  return compileGenerator('javascript', 'JavaScript');
});

/**
 * This task compiles the python generator.
 *     python_compressed.js
 */
gulp.task('compile-python', function() {
  return compileGenerator('python', 'Python');
});

/**
 * This task compiles the php generator.
 *     php_compressed.js
 */
gulp.task('compile-php', function() {
  return compileGenerator('php', 'PHP');
});

/**
 * This task compiles the lua generator.
 *     lua_compressed.js
 */
gulp.task('compile-lua', function() {
  return compileGenerator('lua', 'Lua');
});

/**
 * This task compiles the dart generator:
 *     dart_compressed.js
 */
gulp.task('compile-dart', function() {
  return compileGenerator('dart', 'Dart');
});

/**
 * This task compiles Blockly's uncompressed file.
 *     blockly_uncompressed.js
 */
gulp.task('compile-uncompressed', function() {
...
/**
 * This task compiles all of Blockly:
 *     blockly_compressed.js
 *     blocks_compressed.js
 *     javascript_compressed.js
 *     python_compressed.js
 ...
 * compile script. Invoke with "gulp watch".
 *
