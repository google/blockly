...
goog.module('Blockly.Constants.Loops');
...
Blockly.Extensions.register('controls_whileUntil_tooltip',
    Blockly.Extensions.buildTooltipForDropdown('MODE', WHILE_UNTIL_TOOLTIPS));
...
const CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
   ...
   * CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES.push('custom_loop');
   */
  LOOP_TYPES: [
    'controls_repeat',
    'controls_repeat_ext',
  ...
  getSurroundLoop: function(block) {
    ...
    do {
      if (CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES
  ...
  onchange: function(e) {
    ...
    var enabled = CONTROL_FLOW_IN_LOOP_CHECK_MIXIN
