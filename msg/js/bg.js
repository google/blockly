...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Ако стойността е истина, изпълни операциите.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Ако стойността е истина, изпълни първия блок. Иначе, изпълни втория блок.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Ако първата стойност е истина, изпълни първия блок. Иначе, ако втората стойност е истина, изпълни втория блок.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Ако първата стойност е истина, изпълни първия блок. Иначе, ако втората стойност е истина, изпълни втория блок. Ако нито една от стойностите е истина, испълни последния блок.";
...
Blockly.Msg.LOGIC_BOOLEAN_TRUE = "истината";
Blockly.Msg.LOGIC_COMPARE_HELPURL = "https://en.wikipedia.org/wiki/Inequality_(mathematics)";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Върни истина, ако двата параметъра са еднакви.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Върни истина, ако първия параметър е по-малък от втория.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Върни истина, ако първия параметър е по-малък или равен на втория.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Върни истина, ако двата параметъра са различни.";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "https://github.com/google/blockly/wiki/Logic#not";  // untranslated
Blockly.Msg.LOGIC_NEGATE_TITLE = "не %1";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Върни истина, ако параметърът е лъжа. Върни лъжа, ако параметърът е истина.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Върни истина, ако и двата параметъра са истина.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Върни \"истина\", ако поне един от входовете е истина.";
...
Blockly.Msg.ME = "Аз";
Blockly.Msg.NEW_VARIABLE = "Нова стойност...";
