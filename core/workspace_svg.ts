...
export class WorkspaceSvg extends Workspace implements IASTNodeLocationSvg {
  ...
  constructor(
    ...
    // '(name: string) => void'.
    const Variables =
      (goog.module as AnyDuringMigration).get('Blockly.Variables');
    ...
    const VariablesDynamic =
      (goog.module as AnyDuringMigration).get('Blockly.VariablesDynamic');
    ...
    // '(name: string) => void'.
    const Procedures =
      (goog.module as AnyDuringMigration).get('Blockly.Procedures');
  ...
  addTrashcan() {
    ...
    // '(name: string) => void'.
    const { Trashcan } =
      (goog.module as AnyDuringMigration).get('Blockly.Trashcan');
    if (!Trashcan) {
  ...
  addZoomControls() {
    ...
    // '(name: string) => void'.
    const { ZoomControls } =
      (goog.module as AnyDuringMigration).get('Blockly.ZoomControls');
    if (!ZoomControls) {
  ...
  private pasteWorkspaceComment_(xmlComment: Element): WorkspaceCommentSvg {
    ...
    try {
      // AnyDuringMigration because:  Property 'get' does not exist on type
      // '(name: string) => void'.
      comment = (goog.module as AnyDuringMigration)
