...
Blockly.Events.Abstract.prototype.toJson = function() {
  ...
  if (this.variableId) {
    json['variableId'] = this.variableId;
  }
  if (this.group) {
...
Blockly.Events.VarCreate.prototype.run = function(forward) {
  var workspace = Blockly.Workspace.getById(this.workspaceId);
  if (forward) {
    workspace.createVariable(this.name, this.varType, this.variableId);
  } else {
    workspace.deleteVariableById(this.variableId);
  }
};
...
Blockly.Events.VarRename.prototype.run = function(forward) {
  var workspace = Blockly.Workspace.getById(this.workspaceId);
  if (forward) {
    workspace.renameVariableById(this.variableId, this.newName);
  } else {
    workspace.renameVariableById(this.variableId, this.oldName);
  }
};
