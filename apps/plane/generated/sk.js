...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Rady: %1</span><span id="Plane_getRows">rady (%1)</span><span id="Plane_rows1">rady 1. trieda: %1</span><span id="Plane_getRows1">rady 1. trieda (%1)</span><span id="Plane_rows2">rady 2. trieda: %1</span><span id="Plane_getRows2">rady 2. trieda (%1)</span><span id="Plane_seats">Sedadiel: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">sedadlá =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html">Blockly</a> : Lietadlo</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Lietadlo má niekoľko radov sedadiel.  Každý rad obsahuje štyri sedadlá.';
      break;
    case 2:
      output += 'Lietadlo má dve sedadlá v kabíne pilota (pre kapitána a kopilota), a veľa radov sedadiel pre cestujúcich. Každý rad obsahuje štyri sedadlá.';
      break;
    case 3:
