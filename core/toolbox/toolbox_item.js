 ...
 * @param {!Blockly.utils.toolbox.ToolboxItems} toolboxItemDef The JSON defining the
 *     toolbox item.
...
Blockly.ToolboxItem = function(toolboxItemDef, toolbox) {
   ...
   * @type {!Blockly.utils.toolbox.ToolboxItems}
   * @protected
   */
 ...
 * @param {!Blockly.utils.toolbox.ToolboxItems} toolboxItemDef The JSON
 ...
 * @return {!Array<!Blockly.utils.toolbox.FlyoutItems>| string} The definition
