...
messages["ADD_COMMENT"] = "کمنٹ کریں";
messages["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "متغیر '٪ 1' کو حذف نہیں کر سکتا کیونکہ یہ فنکشن کی تعریف کا حصہ ہے '٪ 2'";
messages["CHANGE_VALUE_TITLE"] = "ویلیو تبدیل کریں:";
messages["CLEAN_UP"] = "بلاکس صاف کریں";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "بند کرو بلاکس";
messages["COLLAPSE_BLOCK"] = "بند کرو بلاک";
...
messages["COLOUR_BLEND_RATIO"] = "ریشیو";
messages["COLOUR_BLEND_TITLE"] = "مرکب";
messages["COLOUR_BLEND_TOOLTIP"] = "دیئے گئے ریشیو میں دو رنگوں کو مرکب کریں (0.0-1.0)";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["COLOUR_PICKER_TOOLTIP"] = "پیلیٹ سے رنگ منتخب کریں";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "ناسیدھا رنگ";
messages["COLOUR_RANDOM_TOOLTIP"] = "کسی بھی رنگ کو منتجب کریں";
messages["COLOUR_RGB_BLUE"] = "نیلا";
...
messages["COLOUR_RGB_RED"] = "سرخ";
messages["COLOUR_RGB_TITLE"] = "کے ساتھ رنگ";
messages["COLOUR_RGB_TOOLTIP"] = "مخصوص، سرخ، سبز اور نیلے رنگ کے ساتھ ایک رنگ بنائیں. تمام اقدار 0 اور 100 کے درمیان ہونا ضروری ہے.";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "لوپ سے باہر نکلنا";
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "continue with next iteration of loop";  // untranslated
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "مشتمل لوپ کے باہر توڑ.";
...
messages["CONTROLS_FLOW_STATEMENTS_WARNING"] = "انتباہ: اس بلاک کو صرف لوپ میں استعمال کیا جاسکتا ہے۔";
messages["CONTROLS_FOREACH_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#for-each";  // untranslated
messages["CONTROLS_FOREACH_TITLE"] = "प्रत्येक چیز کیلئے %1 فہرست ميں %2";
messages["CONTROLS_FOREACH_TOOLTIP"] = "فہرست میں ہر آئٹم کے لئے، '%1' متغیر کو آئٹم پہ لگائے،اور پھر کچھ جملے کہے";
messages["CONTROLS_FOR_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#count-with";  // untranslated
messages["CONTROLS_FOR_TITLE"] = "%1 سے %2 سے %3 تک %4 کے ساتھ گنتی کریں";
messages["CONTROLS_FOR_TOOLTIP"] = "کیا چر '%1' ابتدا عدد سے اختتام عدد تک मानों کو لیتا ہے، निर्दिष्ट अंतराल کے تحت گنتی کرتا ہے، اور निर्दिष्ट रुकावटों کو کرتا ہے۔";
...
messages["CONTROLS_IF_MSG_ELSE"] = "دوسراں";
messages["CONTROLS_IF_MSG_ELSEIF"] = "دوسراں اگر";
messages["CONTROLS_IF_MSG_IF"] = "اگر";
messages["CONTROLS_IF_TOOLTIP_1"] = "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "کریں";
messages["CONTROLS_REPEAT_TITLE"] = "%1 مرتبہ دہرائے";
messages["CONTROLS_REPEAT_TOOLTIP"] = "کچھ جملوں کو کہیں مرتبہ کریں۔";
messages["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "تک دہرائے";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "کے دوران دہرائے";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
messages["DELETE_ALL_BLOCKS"] = "تمام%1 بلاکس کو حذف کریں؟";
messages["DELETE_BLOCK"] = "حذف بلاک";
messages["DELETE_VARIABLE"] = "'٪ 1' متغیر کو حذف کریں";
messages["DELETE_VARIABLE_CONFIRMATION"] = "%2 متغیر کے %1 استعمال کو حذف کریں؟";
messages["DELETE_X_BLOCKS"] = " بلاکوں کو حذف کریں %1";
messages["DIALOG_CANCEL"] = "منسوخ";
messages["DIALOG_OK"] = "ٹھیک ہے";
messages["DISABLE_BLOCK"] = "بلاک کو غیرفعال کریں";
messages["DUPLICATE_BLOCK"] = "نقل";
messages["DUPLICATE_COMMENT"] = " نقل  تبصرہ";
messages["ENABLE_BLOCK"] = "بلاک کو فعال کریں";
messages["EXPAND_ALL"] = "بلاکوں میں توسیع کریں";
messages["EXPAND_BLOCK"] = "بلاک میں توسیع کریں";
messages["EXTERNAL_INPUTS"] = "خارجی دخل اندازی";
messages["HELP"] = "مدد";
messages["INLINE_INPUTS"] = "بین السطور داخل کریں";
...
messages["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "فہرست";
...
messages["LISTS_CREATE_WITH_INPUT_WITH"] = "کے ساتھ فہرست بنائیں";
...
messages["LISTS_GET_INDEX_FIRST"] = "پہلا";
messages["LISTS_GET_INDEX_FROM_END"] = "آخر سے";
messages["LISTS_GET_INDEX_FROM_START"] = "#";  // untranslated
messages["LISTS_GET_INDEX_GET"] = "حاصل کریں";
messages["LISTS_GET_INDEX_GET_REMOVE"] = "get and remove";  // untranslated
messages["LISTS_GET_INDEX_LAST"] = "آخری";
messages["LISTS_GET_INDEX_RANDOM"] = "غیرمتعین";
messages["LISTS_GET_INDEX_REMOVE"] = "حذف کریں";
messages["LISTS_GET_INDEX_TAIL"] = "";  // untranslated
messages["LISTS_GET_INDEX_TOOLTIP_GET_FIRST"] = "پہلے آئٹم کو فہرست میں لوٹائے";
...
messages["LISTS_INLIST"] = "فہرست میں";
...
messages["LISTS_LENGTH_TITLE"] = "%1 کی لمبائی";
...
messages["LISTS_SET_INDEX_INPUT_TO"] = "بطور";
messages["LISTS_SET_INDEX_INSERT"] = "میں درج کریں";
messages["LISTS_SET_INDEX_SET"] = "تعین کریں";
...
messages["LISTS_SET_INDEX_TOOLTIP_SET_FIRST"] = "فہرست میں پہلا آئٹم  کا تعین کریں";
...
messages["LOGIC_BOOLEAN_FALSE"] = "غلط";
...
messages["LOGIC_NEGATE_TITLE"] = "%1 نہیں";
...
messages["LOGIC_OPERATION_AND"] = "اور";
...
messages["LOGIC_TERNARY_CONDITION"] = "ٹیسٹ";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "اگر غلط ہے";
messages["LOGIC_TERNARY_IF_TRUE"] = "اگ سچ ہے";
...
messages["MATH_NUMBER_TOOLTIP"] = "ایک نمبر.";
...
messages["MATH_SINGLE_OP_ABSOLUTE"] = "بالکل";
messages["MATH_SINGLE_OP_ROOT"] = "اسکویر روٹ";
...
messages["NEW_COLOUR_VARIABLE"] = "رنگ متغیر بنائیں";
messages["NEW_NUMBER_VARIABLE"] = "عدد متغیر بناییں";
messages["NEW_STRING_VARIABLE"] = "متغیر بنائیں String";
messages["NEW_VARIABLE"] = "متغیر بنائیں";
messages["NEW_VARIABLE_TITLE"] = "نیا ویریابل نام:";
messages["NEW_VARIABLE_TYPE_TITLE"] = " نئی متغیر قسم";
messages["ORDINAL_NUMBER_SUFFIX"] = "";  // untranslated
messages["PROCEDURES_ALLOW_STATEMENTS"] = "allow statements";  // untranslated
messages["PROCEDURES_BEFORE_PARAMS"] = "سمیت:";
...
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "سمیت:";
...
messages["PROCEDURES_DEFNORETURN_PROCEDURE"] = "کچھ کرو";
messages["PROCEDURES_DEFNORETURN_TITLE"] = "کو";
messages["PROCEDURES_DEFNORETURN_TOOLTIP"] = "بغیر آوٹ پٹ کا فنکشن بنائیں";
messages["PROCEDURES_DEFRETURN_HELPURL"] = "https://en.wikipedia.org/wiki/Subroutine";  // untranslated
messages["PROCEDURES_DEFRETURN_RETURN"] = "واپس آ جائیں";
messages["PROCEDURES_DEFRETURN_TOOLTIP"] = "بغیر آوٹ پٹ کا فنکشن بنائیں";
...
messages["REDO"] = "دہرائیں";
messages["REMOVE_COMMENT"] = "تبصرہ کو ہٹا دیں";
messages["RENAME_VARIABLE"] = "دوبار نام دیں ویریابل کو...";
messages["RENAME_VARIABLE_TITLE"] = "تمام %1 متغیروں کو دوبارہ نام دے:";
...
messages["TEXT_CHARAT_FROM_START"] = "# حرف حاصل کریں";
...
messages["TODAY"] = "آج";
messages["UNDO"] = "کیا ہوا کام کینسل کرے";
messages["UNNAMED_KEY"] = "نامعلوم";
messages["VARIABLES_DEFAULT_NAME"] = "آئٹم";
...
messages["VARIABLE_ALREADY_EXISTS"] = "ایک متغیر نام %1 پہلے سے ہی موجود ہے.";
messages["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "ایک متغیر نام %1 کسی دوسرے قسم کے لئے پہلے ہی موجود ہے: %2.";
