...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">පේළි:%1</span><span id="Plane_getRows">පේළි(%1)</span><span id="Plane_rows1">පළමු පන්තියේ පේළි :%1</span><span id="Plane_getRows1">පළමු පන්තියේ පේළි(%1)</span><span id="Plane_rows2">දෙවන පන්තියේ පේලි :%1</span><span id="Plane_getRows2">දෙවන පන්තියේ පේළි(%1)</span><span id="Plane_seats">ආසන:%1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">ආසන=</span></div>';
};
...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'ගුවන් යානයක පේළි වලට සමාන ආසන සංඛයාවක් ඇත.සෑම පේලියකම ආසන 4ක් ඇත.';
      break;
    case 2:
      output += 'ගුවන් යානයක තට්ටුවේ අසන දෙකක් (ගුවන් නියමුවා සහ උප ගුවන් නියමුවා ට),සහ පේළි සංඛ්\u200Dයාවට සමාන ආසන සංඛ්\u200Dයාවක් ඇත.සෑම පේලියකම ආසන හතරක් ඇත.';
      break;
    case 3:
      output += 'ගුවන් යානයක තට්ටුවේ අසන දෙකක් (ගුවන් නියමුවා සහ උප ගුවන් නියමුවා ට),සහ පේළි සංඛ්\u200Dයාවට සමාන පළමු හා දෙවන පන්තියේ ආසන සංඛ්\u200Dයාවක් ඇත.සෑම පළමු පන්තියේ පේලියක්ම ආසන හතරක් ඇති අතර සෑම දෙවන පන්තියේ පේලියක්ම ආසන පහක් ඇත.';
      break;
  }
  output += '</p><p>(ඉහත)පේළි වෙනස් වූ විට සියලු ආසන සංඛ්\u200Dයාව ගණනය කිරීමට ශ්\u200Dරිතයක් තනන්න (පහත).</p><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../blocks_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + planepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>';
  return output;
};
