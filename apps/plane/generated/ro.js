...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Rânduri: %1</span><span id="Plane_getRows">rânduri (%1)</span><span id="Plane_rows1">rânduri de clasa I: %1</span><span id="Plane_getRows1">rânduri de clasa I (%1)</span><span id="Plane_rows2">rânduri de clasa a II-a: %1</span><span id="Plane_getRows2">rânduri de clasa a II-a (%1)</span><span id="Plane_seats">Scaune: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">scaune =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Calculator pentru locurile dintr-un avion</span> &nbsp; ';
