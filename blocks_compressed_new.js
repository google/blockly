...
Blockly.defineBlocksWithJsonArray([{
    ...
    search_keywords: ["%{BKY_LISTS_CREATE_EMPTY_TITLE}"]
}, {
    type: "lists_repeat",
    ...
    search_keywords: ["%{BKY_LISTS_REPEAT_TITLE}"]
}, {
    type: "lists_reverse",
    ...
    search_keywords: ["%{BKY_LISTS_REVERSE_MESSAGE0}"]
}, {
    type: "lists_isEmpty",
    ...
    search_keywords: ["%{BKY_LISTS_ISEMPTY_TITLE}"]
}, {
    type: "lists_length",
    ...
    search_keywords: ["%{BKY_LISTS_LENGTH_TITLE}"]
}]);
Blockly.Blocks.lists_create_with = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_create_with", [Blockly.Msg.LISTS_CREATE_EMPTY_TITLE, Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH])
    },
    ...
    compose: function(a) {
        ...
        for (b = 0; b < this.itemCount_; b++) {
            ...
            c && -1 == a.indexOf(c) && (this.child_disconnected_.push(this.getInput("ADD" + b).connection.targetBlock()), c.disconnect())
        }
        this.add_shadow = a.length > this.itemCount_;
    ...
    updateShape_: function() {
        ...
        for (var a = 0; a < this.itemCount_; a++)
            ...
            } for (b = 0; this.getInput("ADD" + a);) this.child_disconnected_[b] && this.child_disconnected_[b].isShadow() && this.child_disconnected_[b].dispose(!0, !0), this.removeInput("ADD" + a), a++, b++;
        this.child_disconnected_ = []
    },
    connectShadowBlock_: function() {
        if (this.add_shadow) {
            var a = workspace.newBlock("math_number");
            a.setFieldValue(0, "NUM");
            a.setShadow(!0);
            a.initSvg();
            a.render();
            a = a.outputConnection;
            this.getInput("ADD" + (this.itemCount_ - 1)).connection.connect(a)
        }
    }
};
Blockly.Blocks.lists_create_with_container = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_create_with_container", [Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD])
    }
};
Blockly.Blocks.lists_create_with_item = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_create_with_item", [Blockly.Msg.LISTS_CREATE_WITH_ITEM_TITLE])
    }
};
Blockly.Blocks.lists_indexOf = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_indexOf", [Blockly.Msg.LISTS_INDEX_OF_FIRST, Blockly.Msg.LISTS_INDEX_OF_LAST, Blockly.Msg.LISTS_INDEX_OF_INPUT_IN_LIST])
    }
};
Blockly.Blocks.lists_getIndex = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_getIndex", [Blockly.Msg.LISTS_GET_INDEX_GET, Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE, Blockly.Msg.LISTS_GET_INDEX_REMOVE, Blockly.Msg.LISTS_GET_INDEX_FROM_START,
            Blockly.Msg.LISTS_GET_INDEX_FROM_END, Blockly.Msg.LISTS_GET_INDEX_FIRST, Blockly.Msg.LISTS_GET_INDEX_LAST, Blockly.Msg.LISTS_GET_INDEX_RANDOM, Blockly.Msg.LISTS_GET_INDEX_INPUT_IN_LIST, Blockly.Msg.LISTS_GET_INDEX_TAIL
        ])
    },
    mutationToDom: function() {
        var a = document.createElement("mutation");
...
Blockly.Blocks.lists_setIndex = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_setIndex", [Blockly.Msg.LISTS_SET_INDEX_SET, Blockly.Msg.LISTS_SET_INDEX_INSERT, Blockly.Msg.LISTS_GET_INDEX_FROM_START, Blockly.Msg.LISTS_GET_INDEX_FROM_END, Blockly.Msg.LISTS_GET_INDEX_FIRST,
            Blockly.Msg.LISTS_GET_INDEX_LAST, Blockly.Msg.LISTS_GET_INDEX_RANDOM, Blockly.Msg.LISTS_SET_INDEX_INPUT_IN_LIST, Blockly.Msg.LISTS_SET_INDEX_INPUT_TO
        ])
    },
    mutationToDom: function() {
        var a = document.createElement("mutation"),
...
Blockly.Blocks.lists_getSublist = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_getSublist",
            [Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START, Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END, Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST, Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_START, Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_END, Blockly.Msg.LISTS_GET_SUBLIST_END_LAST, Blockly.Msg.LISTS_GET_SUBLIST_INPUT_IN_LIST, Blockly.Msg.LISTS_GET_SUBLIST_TAIL])
    },
    mutationToDom: function() {
        var a = document.createElement("mutation"),
            b = this.getInput("AT1").type == Blockly.INPUT_VALUE;
        a.setAttribute("at1", b);
        b = this.getInput("AT2").type ==
            Blockly.INPUT_VALUE;
    ...
    updateAt_: function(a, b) {
        ...
        var c = new Blockly.FieldDropdown(this["WHERE_OPTIONS_" +
            a], function(c) {
...
Blockly.Blocks.lists_sort = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_sort", [Blockly.Msg.LISTS_SORT_TITLE, Blockly.Msg.LISTS_SORT_TYPE_NUMERIC, Blockly.Msg.LISTS_SORT_TYPE_TEXT, Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE, Blockly.Msg.LISTS_SORT_ORDER_ASCENDING, Blockly.Msg.LISTS_SORT_ORDER_DESCENDING])
    }
};
Blockly.Blocks.lists_split = {
    ...
    ensureSearchKeywords: function() {
        Blockly.Search.preprocessSearchKeywords("lists_split", [Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT, Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST, Blockly.Msg.LISTS_SPLIT_WITH_DELIMITER])
    },
...
Blockly.defineBlocksWithJsonArray([{
    ...
    search_keywords: ["%{BKY_LOGIC_BOOLEAN_TRUE}", "%{BKY_LOGIC_BOOLEAN_FALSE}"]
}, {
    type: "controls_if",
    ...
    search_keywords: ["%{BKY_CONTROLS_IF_MSG_IF}", "%{BKY_CONTROLS_IF_MSG_THEN}", "%{BKY_CONTROLS_IF_MSG_ELSEIF}", "%{BKY_CONTROLS_IF_MSG_ELSE}"]
}, {
    ...
    helpUrl: "%{BKY_CONTROLS_IF_HELPURL}",
    extensions: ["controls_if_tooltip"],
    search_keywords: ["%{BKY_CONTROLS_IF_MSG_IF}", "%{BKY_CONTROLS_IF_MSG_THEN}", "%{BKY_CONTROLS_IF_MSG_ELSE}"]
}, {
    type: "logic_compare",
    message0: "%1 %2 %3",
    args0: [{
    ...
    search_keywords: ["%{BKY_LOGIC_OPERATION_AND}", "%{BKY_LOGIC_OPERATION_OR}"]
}, {
    type: "logic_negate",
    ...
    search_keywords: ["%{BKY_LOGIC_NEGATE_TITLE}"]
}, {
    type: "logic_null",
    ...
    search_keywords: ["%{BKY_LOGIC_NULL}"]
}, {
    type: "logic_ternary",
    ...
    search_keywords: ["%{BKY_LOGIC_TERNARY_CONDITION}", "%{BKY_LOGIC_TERNARY_IF_TRUE}", "%{BKY_LOGIC_TERNARY_IF_FALSE}"]
}]);
Blockly.defineBlocksWithJsonArray([{
    type: "controls_if_if",
...
Blockly.defineBlocksWithJsonArray([{
    ...
    search_keywords: ["%{BKY_CONTROLS_REPEAT_TITLE}", "%{BKY_CONTROLS_REPEAT_INPUT_DO}"]
}, {
    ...
    search_keywords: ["%{BKY_CONTROLS_WHILEUNTIL_OPERATOR_WHILE}", "%{BKY_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL}",
    ...
    search_keywords: ["%{BKY_CONTROLS_FOR_TITLE}", "%{BKY_CONTROLS_REPEAT_INPUT_DO}"]
}, {
    ...
    search_keywords: ["%{BKY_CONTROLS_FOREACH_TITLE}", "%{BKY_CONTROLS_REPEAT_INPUT_DO}"]
}, {
    ...
    search_keywords: ["%{BKY_CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK}", "%{BKY_CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE}"]
}]);
...
Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
    LOOP_TYPES: "controls_repeat controls_repeat_ext controls_forEach controls_for controls_whileUntil controls_whileForever".split(" "),
    onchange: function() {
        if (this.workspace.isDragging && !this.workspace.isDragging()) {
            ...
            a ? (this.setWarningText(null), this.isInFlyout || this.setDisabled(!1)) : (this.setWarningText(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING),
...
Blockly.defineBlocksWithJsonArray([{
    ...
    search_keywords: ["%{BKY_MATH_ADDITION_SYMBOL}", "%{BKY_MATH_SUBTRACTION_SYMBOL}", "%{BKY_MATH_MULTIPLICATION_SYMBOL}", "%{BKY_MATH_DIVISION_SYMBOL}", "%{BKY_MATH_POWER_SYMBOL}"]
}, {
    type: "math_single",
    message0: "%1 %2",
    args0: [{
    ...
    extensions: ["math_op_tooltip"],
    search_keywords: "%{BKY_MATH_SINGLE_OP_ROOT} %{BKY_MATH_SINGLE_OP_ABSOLUTE} - ln log10 e^ 10^".split(" ")
}, {
    type: "math_trig",
    message0: "%1 %2",
    args0: [{
    ...
    extensions: ["math_op_tooltip"],
    search_keywords: "%{BKY_MATH_TRIG_SIN} %{BKY_MATH_TRIG_COS} %{BKY_MATH_TRIG_TAN} %{BKY_MATH_TRIG_ASIN} %{BKY_MATH_TRIG_ACOS} %{BKY_MATH_TRIG_ATAN}".split(" ")
}, {
    type: "math_constant",
    message0: "%1",
    args0: [{
    ...
    search_keywords: "\u03c0 e \u03c6 sqrt(2) sqrt(\u00bd) \u221e".split(" ")
}, {
    ...
    search_keywords: "%{BKY_MATH_IS_EVEN} %{BKY_MATH_IS_ODD} %{BKY_MATH_IS_PRIME} %{BKY_MATH_IS_WHOLE} %{BKY_MATH_IS_POSITIVE} %{BKY_MATH_IS_NEGATIVE} %{BKY_MATH_IS_DIVISIBLE_BY}".split(" ")
}, {
    type: "math_change",
    ...
    search_keywords: ["%{BKY_MATH_CHANGE_TITLE}"]
}, {
    type: "math_round",
    message0: "%1 %2",
    args0: [{
    ...
    search_keywords: ["%{BKY_MATH_ROUND_OPERATOR_ROUND}", "%{BKY_MATH_ROUND_OPERATOR_ROUNDUP}", "%{BKY_MATH_ROUND_OPERATOR_ROUNDDOWN}"]
}, {
    type: "math_on_list",
    message0: "%1 %2",
    args0: [{
    ...
    extensions: ["math_op_tooltip"],
    search_keywords: "%{BKY_MATH_ONLIST_OPERATOR_SUM} %{BKY_MATH_ONLIST_OPERATOR_MIN} %{BKY_MATH_ONLIST_OPERATOR_MAX} %{BKY_MATH_ONLIST_OPERATOR_AVERAGE} %{BKY_MATH_ONLIST_OPERATOR_MEDIAN} %{BKY_MATH_ONLIST_OPERATOR_MODE} %{BKY_MATH_ONLIST_OPERATOR_STD_DEV} %{BKY_MATH_ONLIST_OPERATOR_RANDOM}".split(" ")
}, {
    type: "math_modulo",
    ...
    search_keywords: ["%{BKY_MATH_MODULO_TITLE}"]
}, {
    type: "math_constrain",
    ...
    search_keywords: ["%{BKY_MATH_CONSTRAIN_TITLE}"]
}, {
    ...
    search_keywords: ["%{BKY_MATH_RANDOM_INT_TITLE}"]
}, {
    ...
    search_keywords: ["%{BKY_MATH_RANDOM_FLOAT_TITLE_RANDOM}"]
}, {
    type: "math_atan2",
    ...
    search_keywords: ["%{BKY_MATH_ATAN2_TITLE}"]
}]);
    ...
    customContextMenu: function(a) {
        if (!this.isInFlyout) {
            var b =
                ...
                d = {
                    text: "Export '%1' to a file".replace("%1", c),
                    enabled: !0,
                    callback: function() {
                        var a = Blockly.Xml.blockToDom(b, !0);
                        console.log(a);
                        Fable.Domain.Platform.Electron.saveProject("Function", a)
                    }
                };
            a.push(d);
            try {
                var e = JSON.parse(localStorage.getItem("storedFunctions"));
                null === e && (e = {})
            } catch (l) {
                console.log("Error parsing/reading storedFunctions information."), e = {}
            }
            var f = !1;
            c in e && (f = !0);
            d = {
                text: f ? "Overwrite/Update stored '%1' function".replace("%1", c) : "Store '%1' for use in future projects".replace("%1",
                    c),
                enabled: !0,
                callback: function() {
                    if (f) Blockly.confirm("Are you sure? You will lose your old '%1' function in the process.".replace("%1", c), function(a) {
                        a && (a = Blockly.Xml.blockToDom(b, !0), a = (new XMLSerializer).serializeToString(a), a = a.replace(/xmlns="(.*?)" /g, ""), e[c] = a, localStorage.setItem("storedFunctions", JSON.stringify(e)))
                    });
                    else {
                        var a = Blockly.Xml.blockToDom(b, !0);
                        ...
                        a = a.replace(/xmlns="(.*?)" /g, "");
                        e[c] = a;
                        localStorage.setItem("storedFunctions", JSON.stringify(e))
                    }
                }
            };
            a.push(d);
            d = {
                text: "Delete stored function '%1'".replace("%1", c),
                enabled: f,
                callback: function() {
                    delete e[c];
                    localStorage.setItem("storedFunctions", JSON.stringify(e))
            ...
            d.text = Blockly.Msg.PROCEDURES_CREATE_DO.replace("%1", c);
            var h = document.createElement("mutation");
            h.setAttribute("name", c);
            for (var k = 0; k < this.arguments_.length; k++) {
                var g = document.createElement("arg");
                g.setAttribute("name", this.arguments_[k]);
                h.appendChild(g)
            }
            g = document.createElement("block");
            g.setAttribute("type",
                this.callType_);
            g.appendChild(h);
            d.callback = Blockly.ContextMenu.callbackFactory(this, g);
            a.push(d);
            if (!this.isCollapsed())
                for (k = 0; k < this.argumentVarModels_.length; k++) d = {
                    enabled: !0
                }, h = this.argumentVarModels_[k], c = h.name, d.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", c), h = Blockly.Variables.generateVariableFieldDom(h), g = document.createElement("block"), g.setAttribute("type", "variables_get"), g.appendChild(h), d.callback = Blockly.ContextMenu.callbackFactory(this, g), a.push(d)
        }
    },
