...
messages["CHANGE_VALUE_TITLE"] = "قدر بدلايو";
messages["CLEAN_UP"] = "بلاڪ صاف ڪيو";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "بلاڪَ ڍڪيو";
messages["COLLAPSE_BLOCK"] = "بلاڪ ڍڪيو";
messages["COLOUR_BLEND_COLOUR1"] = "رنگ 1";
messages["COLOUR_BLEND_COLOUR2"] = "رنگ 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "تناسب";
messages["COLOUR_BLEND_TITLE"] = "گڏيل";
messages["COLOUR_BLEND_TOOLTIP"] = "ڄاڻايل تناسب سان ٻہ رنگ پاڻ ۾ ملايو (0.0-1.0).";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["COLOUR_PICKER_TOOLTIP"] = "رنگ دٻيءَ مان رنگ چونڊيو.";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "بنا ترتيب رنگ";
messages["COLOUR_RANDOM_TOOLTIP"] = "ڪو بہ ‌رنگ چونڊيو.";
messages["COLOUR_RGB_BLUE"] = "نيرو";
messages["COLOUR_RGB_GREEN"] = "سائو";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "ڳاڙهو";
messages["COLOUR_RGB_TITLE"] = "سان رڱيو";
messages["COLOUR_RGB_TOOLTIP"] = "ڳاڙهي، سائي، ۽ نيري جو مقدار ڄاڻائي گھربل رنگ ٺاهيو. سمورا قدر 0 ۽ 100 جي وچ ۾ هجن.";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "چڪر مان ٻاهر نڪرو";
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "چڪر جاري رکندي نئين ڦيري پايو";
...
messages["CONTROLS_IF_MSG_ELSE"] = "نہ تہ";
messages["CONTROLS_IF_MSG_ELSEIF"] = "نہ تہ جي";
messages["CONTROLS_IF_MSG_IF"] = "جيڪڏهن";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "ڪريو";
messages["CONTROLS_REPEAT_TITLE"] = "1٪ ڀيرا ورجايو";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "ورجايو جيستائين";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "ورجايو جڏهن";
...
messages["DELETE_ALL_BLOCKS"] = "سڀ %1 بلاڪ ڊاھيون؟";
messages["DELETE_BLOCK"] = "بلاڪ ڊاهيو";
...
messages["DELETE_X_BLOCKS"] = "1٪ بلاڪ ڊاهيو";
messages["DIALOG_CANCEL"] = "رد";
messages["DIALOG_OK"] = "ٺيڪ";
messages["DISABLE_BLOCK"] = "بلاڪ کي غيرفعال بڻايو";
messages["DUPLICATE_BLOCK"] = "نقل";
messages["DUPLICATE_COMMENT"] = "نقل رايو";
messages["ENABLE_BLOCK"] = "بلاڪ کي فعال بڻايو";
messages["EXPAND_ALL"] = "بلاڪَ نمايو";
messages["EXPAND_BLOCK"] = "بلاڪ نمايو";
messages["EXTERNAL_INPUTS"] = "ٻاهريون داخلائون";
messages["HELP"] = "مدد";
messages["INLINE_INPUTS"] = "اِنلائين اِن پٽس";
messages["LISTS_CREATE_EMPTY_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#create-empty-list";  // untranslated
messages["LISTS_CREATE_EMPTY_TITLE"] = "خالي فهرست تخليق ڪريو";
messages["LISTS_CREATE_EMPTY_TOOLTIP"] = "Returns a list, of length 0, containing no data records";  // untranslated
messages["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "لسٽ";
...
messages["LISTS_CREATE_WITH_INPUT_WITH"] = "سان فهرست تخليق ڪيو";
messages["LISTS_CREATE_WITH_ITEM_TOOLTIP"] = "فهرست ۾ ڪا شي شامل ڪريو.";
messages["LISTS_CREATE_WITH_TOOLTIP"] = "Create a list with any number of items.";  // untranslated
messages["LISTS_GET_INDEX_FIRST"] = "پهريون";
messages["LISTS_GET_INDEX_FROM_END"] = "# آخر کان";
...
messages["LISTS_GET_INDEX_LAST"] = "آخري";
messages["LISTS_GET_INDEX_RANDOM"] = "بي ترتيب";
messages["LISTS_GET_INDEX_REMOVE"] = "هٽايو";
...
messages["LISTS_GET_SUBLIST_END_FROM_END"] = "ڏانهن # آخر کان";
messages["LISTS_GET_SUBLIST_END_FROM_START"] = "ڏانهن #";
messages["LISTS_GET_SUBLIST_END_LAST"] = "آخري ڏانهن";
...
messages["LISTS_SET_INDEX_INPUT_TO"] = "جيان";
messages["LISTS_SET_INDEX_INSERT"] = "تي داخل ڪريو";
messages["LISTS_SET_INDEX_SET"] = "ميڙ";
...
messages["LISTS_SORT_ORDER_ASCENDING"] = "اُڀو (اَسينڊنگ)";
messages["LISTS_SORT_ORDER_DESCENDING"] = "descending";  // untranslated
messages["LISTS_SORT_TITLE"] = "ترتيب ڏيو %1 %2 %3";
...
messages["LISTS_SORT_TYPE_TEXT"] = "الف ب وار (الفابيٽڪ)";
...
messages["LOGIC_BOOLEAN_FALSE"] = "ڪُوڙ";
messages["LOGIC_BOOLEAN_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
messages["LOGIC_BOOLEAN_TOOLTIP"] = "درست يا غير درست وراڻي ٿو.";
messages["LOGIC_BOOLEAN_TRUE"] = "سچ";
messages["LOGIC_COMPARE_HELPURL"] = "https://en.wikipedia.org/wiki/Inequality_(mathematics)";
messages["LOGIC_COMPARE_TOOLTIP_EQ"] = "جيڪڏهن ٻئي ان پُٽس برابر آهن تہ درست وراڻيو";
messages["LOGIC_COMPARE_TOOLTIP_GT"] = "جيڪڏهن پهريون ان پُٽ ٻين ان پُٽ کان وڏو آهي تہ درست وراڻيو.";
messages["LOGIC_COMPARE_TOOLTIP_GTE"] = "جيڪڏهن پهريون ان پُٽ ٻين ان پُٽ کان وڏو آهي يا ٻئي برابر آهن تہ درست وراڻيو.";
messages["LOGIC_COMPARE_TOOLTIP_LT"] = "جيڪڏهن پهريون ان پُٽ ٻين ان پُٽ کان ننڍو آهي تہ درست وراڻيو";
messages["LOGIC_COMPARE_TOOLTIP_LTE"] = "جيڪڏهن پهريون ان پُٽ ٻين ان پُٽ کان ننڍو آهي يا ٻئي برابر آهن تہ درست وراڻيو";
messages["LOGIC_COMPARE_TOOLTIP_NEQ"] = "جيڪڏهن ٻئي ان پُٽس اڻ برابر آهن تہ درست وراڻيو";
messages["LOGIC_NEGATE_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#not";  // untranslated
messages["LOGIC_NEGATE_TITLE"] = "نڪي %1";
messages["LOGIC_NEGATE_TOOLTIP"] = "ان پُٽ غير درست آهي تہ درست وراڻيو. ان پُٽ درست آهي تہ غير درست وراڻيو.";
...
messages["LOGIC_OPERATION_AND"] = "۽";
messages["LOGIC_OPERATION_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#logical-operations";  // untranslated
messages["LOGIC_OPERATION_OR"] = "يا";
messages["LOGIC_OPERATION_TOOLTIP_AND"] = "جيڪڏهن ٻئي ان پُٽ درست آهن تہ درست وراڻيو.";
messages["LOGIC_OPERATION_TOOLTIP_OR"] = "جيڪڏهن ٻنهي ان پُٽس مان ڪو هڪ بہ درست آهي تہ درست وراڻيو.";
messages["LOGIC_TERNARY_CONDITION"] = "پرک (ٽيسٽ)";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "جيڪڏهن ڪوڙو";
messages["LOGIC_TERNARY_IF_TRUE"] = "جيڪڏهن سچو";
...
messages["MATH_ARITHMETIC_TOOLTIP_ADD"] = "ٻن انگن جي جوڙ اپت ڏيو.";
messages["MATH_ARITHMETIC_TOOLTIP_DIVIDE"] = "ٻنهي انگن جي ونڊ ڏيو.";
messages["MATH_ARITHMETIC_TOOLTIP_MINUS"] = "ٻنهي انگن جو تفاوت ڏيو.";
messages["MATH_ARITHMETIC_TOOLTIP_MULTIPLY"] = "ٻنهي انگن جي ضرب اُپت ڏيو.";
...
messages["MATH_CHANGE_TITLE"] = "%1 کي %2 سان مَٽايو";
messages["MATH_CHANGE_TOOLTIP"] = "Add a number to variable '%1'.";  // untranslated
messages["MATH_CONSTANT_HELPURL"] = "https://en.wikipedia.org/wiki/رياضياتي استقلال";
...
messages["MATH_IS_DIVISIBLE_BY"] = "سان ونڊجندڙ آهي";
messages["MATH_IS_EVEN"] = "ٻڌي آهي";
messages["MATH_IS_NEGATIVE"] = "ڪاٽو آهي";
messages["MATH_IS_ODD"] = "اِڪي آهي";
messages["MATH_IS_POSITIVE"] = "واڌو آهي";
messages["MATH_IS_PRIME"] = "مفرد آهي";
...
messages["MATH_IS_WHOLE"] = "سڄو آهي";
...
messages["MATH_NUMBER_TOOLTIP"] = "ڪو انگ.";
messages["MATH_ONLIST_HELPURL"] = "";  // untranslated
messages["MATH_ONLIST_OPERATOR_AVERAGE"] = "لسٽ جي سراسري";
messages["MATH_ONLIST_OPERATOR_MAX"] = "لسٽ جو وڏي ۾ وڏو قدر";
messages["MATH_ONLIST_OPERATOR_MEDIAN"] = "لسٽ جو مڌيان";
messages["MATH_ONLIST_OPERATOR_MIN"] = "لسٽ جو ننڍي ۾ ننڍو قدر";
messages["MATH_ONLIST_OPERATOR_MODE"] = "فهرست جا طريقيڪا (موڊز آف لسٽ)";
messages["MATH_ONLIST_OPERATOR_RANDOM"] = "بي ترتيب جذن جي فهرست (رينڊم آئيٽم آف لسٽ)";
messages["MATH_ONLIST_OPERATOR_STD_DEV"] = "standard deviation of list";  // untranslated
messages["MATH_ONLIST_OPERATOR_SUM"] = "فهرست جو وچور";
messages["MATH_ONLIST_TOOLTIP_AVERAGE"] = "Return the average (arithmetic mean) of the numeric values in the list.";  // untranslated
messages["MATH_ONLIST_TOOLTIP_MAX"] = "لسٽ ۾ وڏي کان وڏو قدر ڄاڻايو.";
messages["MATH_ONLIST_TOOLTIP_MEDIAN"] = "لسٽ جو مڌيان انگ ڄاڻايو.";
messages["MATH_ONLIST_TOOLTIP_MIN"] = "لسٽ ۾ ننڍي کان ننڍو قدر ڄاڻايو.";
...
messages["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "هيٺ ڦيرايو (رائونڊ ڊائون)";
messages["MATH_ROUND_OPERATOR_ROUNDUP"] = "ويڙهيو (رائونڊ اَپ)";
messages["MATH_ROUND_TOOLTIP"] = "Round a number up or down.";  // untranslated
messages["MATH_SINGLE_HELPURL"] = "https://en.wikipedia.org/wiki/ٻيون مول";
messages["MATH_SINGLE_OP_ABSOLUTE"] = "ٺپ";
messages["MATH_SINGLE_OP_ROOT"] = "ٻيون مول";
...
messages["MATH_SINGLE_TOOLTIP_LN"] = "ڪنهن انگ جو قدرتي لاگ ڄاڻايو.";
messages["MATH_SINGLE_TOOLTIP_LOG10"] = "ڪنهن انگ جو 10 بنيادي لاگ ڄاڻايو.";
messages["MATH_SINGLE_TOOLTIP_NEG"] = "ڪنهن انگ جو ڪاٽو ڄاڻايو.";
messages["MATH_SINGLE_TOOLTIP_POW10"] = "Return 10 to the power of a number.";  // untranslated
messages["MATH_SINGLE_TOOLTIP_ROOT"] = "ڪنهن انگ جو ٻيون مول ڄاڻايو.";
...
messages["MATH_TRIG_HELPURL"] = "https://en.wikipedia.org/wiki/ٽڪنڊور ڪاڄ";
...
messages["NEW_VARIABLE"] = "نئون ڦرڻو...";
messages["NEW_VARIABLE_TITLE"] = "ڦرڻي جو نئون نالو:";
...
messages["PROCEDURES_BEFORE_PARAMS"] = "سان:";
...
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "سان:";
messages["PROCEDURES_CREATE_DO"] = "تخليق ڪريو '%1'";
...
messages["PROCEDURES_DEFNORETURN_PROCEDURE"] = "ڪجھ ڪريو";
messages["PROCEDURES_DEFNORETURN_TITLE"] = "ڏانهن";
...
messages["PROCEDURES_DEFRETURN_RETURN"] = "واپس ورو";
...
messages["PROCEDURES_MUTATORCONTAINER_TITLE"] = "ان پُٽس";
messages["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] = "Add, remove, or reorder inputs to this function.";  // untranslated
messages["REDO"] = "ٻيهر ڪريو";
messages["REMOVE_COMMENT"] = "رايو ڊاهيو";
messages["RENAME_VARIABLE"] = "ڦرڻي کي نئون نالو ڏيو...";
...
messages["TEXT_CHANGECASE_OPERATOR_LOWERCASE"] = "ننڍن اکر ڏانهن";
messages["TEXT_CHANGECASE_OPERATOR_TITLECASE"] = "to Title Case";  // untranslated
messages["TEXT_CHANGECASE_OPERATOR_UPPERCASE"] = "وڏن اکرن ڏانهن";
...
messages["TEXT_COUNT_MESSAGE0"] = "ڳڻيو %1 ۾ %2";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "شامل ٿيو";
...
messages["TEXT_GET_SUBSTRING_INPUT_IN_TEXT"] = "متن ۾";
...
messages["TEXT_INDEXOF_TITLE"] = "۾ متن %1 %2 %3";
...
messages["TEXT_JOIN_TITLE_CREATEWITH"] = "سان مواد تخليق ڪيو (ڪريئيٽ ٽيڪسٽ وِد)";
...
messages["TEXT_PRINT_TITLE"] = "ڇاپيو %1";
messages["TEXT_PRINT_TOOLTIP"] = "ڄاڻايل تحرير، انگ يا ڪو ٻيو قدر ڇاپيو.";
...
messages["TODAY"] = "اڄ";
messages["UNDO"] = "اڻڪريو";
messages["UNNAMED_KEY"] = "unnamed";  // untranslated
messages["VARIABLES_DEFAULT_NAME"] = "اسم";
