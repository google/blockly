...
/**
 * @fileoverview Block element construction function generator from an xml block element description list.
 * @author JC-Orozco (Juan Carlos Orozco)
 */

var NAMESPACE = 'BlockConstructors'
var HEADER = 
`/**
 ...
 */\n`
  ...
  code += NAMESPACE+'.'+blockType+' = function('+data+parameters.join(', ')+') {\n';
