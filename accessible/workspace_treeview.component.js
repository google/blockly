...
/**
 * @fileoverview Angular2 Component that details how Blockly.Block's are rendered in the workspace in AccessibleBlockly. Also handles any interactions with the blocks.
...
<li #parentList aria-selected=false role='treeitem' class='blocklyHasChildren' [attr.aria-level]='level' id='{{setId(parentList)}}'>
  ...
  .Class({
    constructor: [blocklyApp.ClipboardService, blocklyApp.TreeService, function(_service, _service2) {
      this.infoBlocks = {};
      this.nextBlock = {};
