...
Blockly.WorkspaceSvg.prototype.showContextMenu = function(e) {
  ...
  var menuOptions = Blockly.ContextMenuRegistry.getContextMenuOptions(
...
(function() {
  ...
  undoOption.weight = 0;
  Blockly.ContextMenuRegistry.register(undoOption);
  ...
  redoOption.weight = 0;
  Blockly.ContextMenuRegistry.register(redoOption);
  ...
  Blockly.ContextMenuRegistry.register(cleanOption);

  // Options to collapse and expand top blocks
  ...
  Blockly.ContextMenuRegistry.register(collapseOption);
  ...
  Blockly.ContextMenuRegistry.register(expandOption);
  ...
  function deleteNext(deleteList) {
    var DELAY = 10;
    ...
    if (block) {
      if (block.workspace) {
        ...
        setTimeout(deleteNext, DELAY, deleteList);
      } else {
        deleteNext(deleteList);
      }
    }
    Blockly.Events.setGroup(false);
  }
  ...
  Blockly.ContextMenuRegistry.register(deleteOption);
})();
