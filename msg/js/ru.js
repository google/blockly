...
Blockly.Msg.COLOUR_BLEND_RATIO = "отношение";
...
Blockly.Msg.COLOUR_RGB_GREEN = "зелёный";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Для каждого элемента в списке, присвоить переменной '%1' значение элемента  и выполнить некоторые команды.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Присваивает переменной %1 значения от начального до конечного с заданным шагом и выполняет указанные блоки.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Добавляет условие к блоку если";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Добавить окончательное, обобщающее условие для блока «если».";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Если значение равно истина, выполняет команды";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Если значение равно истина, исполняет первый блок команд. Иначе исполняется второй блок команд.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Если первое значение равно истина, то исполняет первый блок команд.Иначе, если второе значение равно истина, исполняет второй блок команд.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Если первое значение равно истина, то выполняет первый блок команд.  В противном случае, если второе значение равно истина, выполняет второй блок команд.  Если ни одно из значений не равно истина, выполняет последний блок операторов.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http://en.wikipedia.org/wiki/For_loop";
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "выполнять";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Выполнить некоторые команды несколько раз.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Пока значение равно ложь, выполняет команды";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Пока значение равно истина, выполняет команды";
...
Blockly.Msg.EXTERNAL_INPUTS = "Внешние параметры";
Blockly.Msg.HELP = "Справка";
Blockly.Msg.INLINE_INPUTS = "Показать внутренние параметры";
...
Blockly.Msg.LISTS_SET_INDEX_INPUT_TO = "равно";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Возвращает значение истина, если параметры равны.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Возвращает значение истина, если первый параметр больше второго.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Возвращает значение истина, если первый параметр больше или равен  второму.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Возвращает значение истина, если первый параметр меньше второго.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Возвращает значение истина, если первый параметр меньше или равен  второму.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Возвращает значение истинв, если параметры не равны.";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "http://code.google.com/p/blockly/wiki/Not";  // untranslated
Blockly.Msg.LOGIC_NEGATE_TITLE = "не %1";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Возвращает значение истина, если параметр имеет значение ложь.  Возвращает значение ложь, если параметр имеет значение истина.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Возвращает значение истина, если оба параметра равны истина.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Возвращает значение истина, если хотя бы один из параметров имеет значение истина.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Проверить условие в 'test'. Если условие имеет значение «истина», возвращает значение 'если истина'; в противном случае возвращает значение 'если ложь'.";
...
Blockly.Msg.MATH_IS_NEGATIVE = "отрицательно";
Blockly.Msg.MATH_IS_ODD = "нечётное";
Blockly.Msg.MATH_IS_POSITIVE = "положительно";
...
Blockly.Msg.MATH_IS_WHOLE = "является целым";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Возвращает случайную дробную часть между 0.0 (включительно) и 1.0 (не включая).";
...
Blockly.Msg.MATH_ROUND_TOOLTIP = "Округление числа до большего или меньшего.";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Исполняет определённую пользователем функцию '%1' и использует возвращаемое значение.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Если значение равно истина, возвращает второе значение.";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "к Капитализации Начальных Букв";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "в ВЕРХНИЙ РЕГИСТР";
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Возвращать копию текста в другом регистре.";
...
Blockly.Msg.VARIABLES_GET_CREATE_SET = "Создать 'присвоить значение %1'";
...
Blockly.Msg.VARIABLES_SET_CREATE_GET = "Создать 'взять %1'";
Blockly.Msg.VARIABLES_SET_HELPURL = "http://code.google.com/p/blockly/wiki/Variables#Set";  // untranslated
Blockly.Msg.VARIABLES_SET_TAIL = "равно";
Blockly.Msg.VARIABLES_SET_TITLE = "присвоить";
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Присваивает переменной значение параметра.";
