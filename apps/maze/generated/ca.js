...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">mou endavant</span><span id="Maze_turnLeft">gira esquerra</span><span id="Maze_turnRight">gira dreta</span><span id="Maze_doCode">fes</span><span id="Maze_elseCode">si no</span><span id="Maze_helpIfElse">Les declaracions \'si-si no\' faran fer una cosa o una altra.</span><span id="Maze_pathAhead">al davant</span><span id="Maze_pathLeft">si camí a l\'esquerra</span><span id="Maze_pathRight">si camí a la dreta</span><span id="Maze_repeatUntil">repeteix fins al</span><span id="Maze_moveForwardTooltip">Mou el Pegman endavant un espai.</span><span id="Maze_turnTooltip">Gira el Pegman a l\'esquerra o a la dreta 90 graus.</span><span id="Maze_ifTooltip">Si hi ha un camí en la direcció especificada, llavors fes algunes accions.</span><span id="Maze_ifelseTooltip">Si hi ha un camí en la direcció especificada, llavors fes el primer bloc d\'accions. Si no, fes el segon bloc d\'accions.</span><span id="Maze_whileTooltip">Repeteix les accions de dins del bloc fins arribar al punt final.</span><span id="Maze_capacity0">Et resten %0 blocs.</span><span id="Maze_capacity1">Et resten %1 blocs.</span><span id="Maze_capacity2">Et resten %2 blocs.</span><span id="Maze_nextLevel">Felicitats! Estàs preparat per a procedir amb el nivell %1?</span><span id="Maze_finalLevel">Felicitats! Has resolt el nivell final.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Laberint</span> &nbsp; ';
  ...
  output += '</h1></td><td class="farSide"><select id="languageMenu"></select> &nbsp; <button id="pegmanButton"><img src="../../media/1x1.gif"><span>&#x25BE;</span></button></td></tr></table><div id="visualization"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="svgMaze" width="400px" height="400px"><g id="look"><path d="M 0,-15 a 15 15 0 0 1 15 15" /><path d="M 0,-35 a 35 35 0 0 1 35 35" /><path d="M 0,-55 a 55 55 0 0 1 55 55" /></g></svg><div id="capacityBubble"><div id="capacity"></div></div></div><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="codeButton" class="notext" title="Vegeu el codi JavaScript generat."><img src="../../media/1x1.gif" class="code icon21"></button><button id="linkButton" class="notext" title="Desa i enllaça als blocs."><img src="../../media/1x1.gif" class="link icon21"></button></td><td><button id="runButton" class="primary" title="Fa que el jugador faci el que diuen els blocs."><img src="../../media/1x1.gif" class="run icon21"> Executa el programa</button><button id="resetButton" class="primary" style="display: none" title="Col·loca el jugador a l\'inici del laberint."><img src="../../media/1x1.gif" class="stop icon21"> Reinicialitza</button></td></tr></table><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + mazepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div><div id="pegmanMenu"></div>' + apps.dialog(null, null, opt_ijData) + apps.codeDialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData) + '<div id="dialogDone" class="dialogHiddenContent"><div id="dialogDoneText" style="font-size: large; margin: 1em;"></div><img src="../../media/1x1.gif" id="pegSpin"><div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0"></div></div><div id="dialogHelpStack" class="dialogHiddenContent"><table><tr><td><img src="help.png"></td><td>&nbsp;</td><td>Apila un parell de blocs \'mou endavant\' junts per ajudar-me a arribar a la meta.</td><td valign="top"><img src="help_stack.png" class="mirrorImg" height=63 width=136></td></tr></table></div><div id="dialogHelpOneTopBlock" class="dialogHiddenContent"><table><tr><td><img src="help.png"></td><td>&nbsp;</td><td>En aquest nivell, has d\'apilar junts tots els blocs a l\'espai de treball blanc.<iframe id="iframeOneTopBlock" style="height: 80px; width: 100%; border: none;" src=""></iframe></td></tr></table></div><div id="dialogHelpRun" class="dialogHiddenContent"><table><tr><td>Executeu el vostre programa per veure què passa.</td><td rowspan=2><img src="help.png"></td></tr><tr><td><div><img src="help_run.png" class="mirrorImg" height=27 width=141></div></td></tr></table></div><div id="dialogHelpReset" class="dialogHiddenContent"><table><tr><td>El vostre programa no ha resolt el laberint. Cliqueu \'Reinicialitza\' i torneu a intentar-ho.</td><td rowspan=2><img src="help.png"></td></tr><tr><td><div><img src="help_run.png" class="mirrorImg" height=27 width=141></div></td></tr></table></div><div id="dialogHelpRepeat" class="dialogHiddenContent"><table><tr><td><img src="help_up.png"></td><td>Els ordinadors tenen una memòria limitada. Arriba al final d\'aquest camí utilitzant només dos blocs. Utilitza \'repeteix\' per a executar un bloc més d\'una vegada.</td><td><img src="help.png"></td></tr></table></div><div id="dialogHelpCapacity" class="dialogHiddenContent"><table><tr><td><img src="help.png"></td><td>&nbsp;</td><td>Heu usat tots els blocs per aquest nivell. Per crear un nou bloc, primer heu d\'esborrar un bloc existent.</td></tr></table></div><div id="dialogHelpRepeatMany" class="dialogHiddenContent"><table><tr><td><img src="help_up.png"></td><td>Podeu encabit més d\'un bloc dins d\'un bloc \'repeteix\'.</td><td><img src="help.png"></td></tr></table></div><div id="dialogHelpSkins" class="dialogHiddenContent"><table><tr><td><img src="help.png"></td><td>Escolliu el vostre jugador favorit en aquest menú.</td><td><img src="help_up.png"></td></tr></table></div><div id="dialogHelpIf" class="dialogHiddenContent"><table><tr><td><img src="help_up.png"></td><td>Una condició \'si\' farà fer alguna cosa només si la condició és certa. Prova de girar a l\'esquerra si hi ha un camí a l\'esquerra.</td><td><img src="help.png"></td></tr></table></div><div id="dialogHelpMenu" class="dialogHiddenContent"><table><tr><td><img src="help_up.png"></td><td id="helpMenuText">Feu clic a %1 en el bloc \'si\' per canviar-ne la condició.</td><td><img src="help.png"></td></tr></table></div><div id="dialogHelpIfElse" class="dialogHiddenContent"><table><tr><td><img src="help_down.png"></td><td>Les declaracions \'si-si no\' faran fer una cosa o una altra.</td><td><img src="help.png"></td></tr></table></div><div id="dialogHelpWallFollow" class="dialogHiddenContent"><table><tr><td><img src="help.png"></td><td>&nbsp;</td><td>Pots resoldre aquest complicat laberint? Prova de seguir la paret de l\'esquerra. Només programadors avançats!' + apps.ok(null, null, opt_ijData) + '</td></tr></table></div>';
  return output;
};
