 ...
 *     variable.
 * @param {function(null|undefined|string)} opt_callback The callback that returns
 *     an acceptable new variable name, or null if change is to be aborted
 *     (cancel button), or undefined if an existing variable was chosen.
 */
 ...
 * @param {function(?string)} callback The callback that returns the new
