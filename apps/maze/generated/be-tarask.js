...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">рухацца наперад</span><span id="Maze_turnLeft">паварот налева</span><span id="Maze_turnRight">павярнуць направа</span><span id="Maze_doCode">выканаць</span><span id="Maze_elseCode">у іншым выпадку</span><span id="Maze_helpIfElse">Блёкі „калі-інакш“ будуць выконваць адно ці іншае дзеяньне.</span><span id="Maze_pathAhead">калі шлях наперадзе</span><span id="Maze_pathLeft">калі шлях налева</span><span id="Maze_pathRight">калі шлях направа</span><span id="Maze_repeatUntil">паўтараць, пакуль</span><span id="Maze_moveForwardTooltip">Перамяшчае гульца наперад на адно поле.</span><span id="Maze_turnTooltip">Павярнуць гульца налева або направа на 90 градусаў.</span><span id="Maze_ifTooltip">Калі шлях у паказаным кірунку існуе, то выканаць пэўныя дзеяньні.</span><span id="Maze_ifelseTooltip">Калі існуе шлях у паказаным кірунку, то выканаць першы блёк дзеяньняў. У адваротным выпадку, выканаць другі блёк дзеяньняў.</span><span id="Maze_whileTooltip">Паўтарыце закрытыя дзеяньні, пакуль не будзе дасягнутая канцавая кропка.</span><span id="Maze_capacity0">У Вас засталося %0 блёкаў.</span><span id="Maze_capacity1">У Вас застаўся %1 блёк.</span><span id="Maze_capacity2">У Вас засталося %2 блёкі(аў).</span><span id="Maze_nextLevel">Віншуем! Вы гатовыя перайсьці на ўзровень %1?</span><span id="Maze_finalLevel">Віншуем! Вы прайшлі канчатковы ўзровень.</span></div>';
};
