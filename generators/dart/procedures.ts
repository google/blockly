...
export function procedures_callreturn(block: Block, generator: DartGenerator): [string, Order] {
...
export function procedures_callnoreturn(block: Block, generator: DartGenerator) {
