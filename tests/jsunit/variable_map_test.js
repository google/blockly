 ...
 * @private
 */
function variableMapTest_createVariable(name, opt_type, opt_id) {
  variable_map.createVariable(name, opt_type, opt_id);
  return variable_map.getVariable(name);
}
...
function test_getVariable_Trivial() {
  ...
  var var_1 = this.variableMapTest_createVariable('name1', 'type1', 'id1');
  var var_2 = this.variableMapTest_createVariable('name2', 'type1', 'id2');
  var var_3 = this.variableMapTest_createVariable('name3', 'type2', 'id3');
...
function test_getVariablesOfType_Null() {
  variableMapTest_setUp();
  var var_1 = this.variableMapTest_createVariable('name1', '', 'id1');
  var var_2 = this.variableMapTest_createVariable('name2', '', 'id2');
  var var_3 = this.variableMapTest_createVariable('name3', '', 'id3');
...
function test_getVariablesOfType_EmptyString() {
  variableMapTest_setUp();
  var var_1 = this.variableMapTest_createVariable('name1', null, 'id1');
  var var_2 = this.variableMapTest_createVariable('name2', null, 'id2');
...
function test_getVariablesOfType_Deleted() {
  variableMapTest_setUp();
  var variable = this.variableMapTest_createVariable('name1', null, 'id1');
