...
/**
 * @fileoverview Loads uncompressed Blockly when running locally. Loads compressed otherwise.
 */
'use strict';


/**
 * Loads all the compressed or uncompressed dependencies necessary to run the playground.
 * This is necessary since the goog.module conversion. Please see issue #5557 for more information.
 */

(function() {
    if (location.hostname  === 'localhost' || location.hostname === "127.0.0.1" || location.hostname === '[::1]') {
        document.write(`<script src="../blockly_uncompressed.js" id="blockly-uncompressed-script"></script>`);
        document.write(`<script src="../msg/messages.js"></script>`);
        document.write(`<script src="../tests/themes/test_themes.js"></script>`);
        document.write(`<script src="../node_modules/@blockly/block-test/dist/index.js"></script>`);
        ...
        document.write(`<script src="../blockly_compressed.js" id="blockly-compressed-script"></script>`);
