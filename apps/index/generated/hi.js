...
appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">ब्लॉकली एप्स</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>ब्लॉकली एक ग्राफिकल प्रोग्रामिंग वातावरण है। नीचे कुछ सैम्पल ऐप्लकेशन हैं जो की ब्लॉकली का उपयोग करते हैं।</td></tr></table><table><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">कोड</a></div><div>ब्लॉकली प्रोग्राम को जावास्क्रिप्ट, पायथन या XML में निर्यात करें।</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">विमान सीट कैलक्यूलेटर</a></div><div>एक या दो चर के साथ गणित की समस्या को हल करें।</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
