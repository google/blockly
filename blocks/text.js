...
Blockly.Blocks['text_split'] = {
  /**
   * Block for splitting a string by space.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      'message0': Blockly.Msg.TEXT_SPLIT_MESSAGE0,
      'args0': [
        {
          'type': 'input_value',
          'name': 'TEXT',
      ...
      'tooltip': Blockly.Msg.TEXT_SPLIT_TOOLTIP,
      'helpUrl': Blockly.Msg.TEXT_SPLIT_HELPURL,
    });
  }
};
...
Blockly.Blocks['text_split_on'] = {
  /**
   * Block for splitting a string by another string.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      'message0': Blockly.Msg.TEXT_SPLIT_ON_MESSAGE0,
      'args0': [
        {
          'type': 'input_value',
          'name': 'TEXT',
      ...
      'inputsInline': true,
      'colour': Blockly.Blocks.lists.HUE,
      'tooltip': Blockly.Msg.TEXT_SPLIT_ON_TOOLTIP,
      'helpUrl': Blockly.Msg.TEXT_SPLIT_ON_HELPURL,
    });
  }
};
