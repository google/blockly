...
appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">ブロックリーのアプリ</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>ブロックリーはグラフィカルなプログラミング環境です。以下に列挙したサンプル アプリケーションはブロックリーを使用しています。</td></tr></table><table><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">コード</a></div><div>ブロックリーのプログラムを JavaScript、Python、Dart、XML にエクスポートしましょう。</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">飛行機座席計算機</a></div><div>1変数または2変数の数学の問題を解きましょう。</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
