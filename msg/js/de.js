...
/** @export */ Blockly.Msg.ARD_FUN_RUN_LOOP = "Wiederhole für immer :";
/** @export */ Blockly.Msg.ARD_FUN_RUN_SETUP = "Mache zuerst:";
/** @export */ Blockly.Msg.ARD_FUN_RUN_TIP = "Definiere die OXOcard setup() und loop() Funktionen";
...
/** @export */ Blockly.Msg.ARD_TIME_DELAY = "Warte";
...
/** @export */ Blockly.Msg.ARD_TIME_DELAY_TIP = "Warte angegebene anzahl an Millisekunden";
...
/** @export */ Blockly.Msg.ARD_TIME_MS = "Millisekunden";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_HZ_TIP = "Spielt einen Ton in Herz.";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_HZ_TITLE = "Spiele Ton (Herz)";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_TIP = "Spielt einen Ton. Die Oktave kann mittels dem entsprechenden Block gesetzt werden";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_TITLE = "Spiele Ton";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_BPM_TIP = "Setzt den globalen beats per minute (BPM) Wert";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_BPM_TITLE = "Setze BPM";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_OCTAVE_TIP = "Setzt die globale Oktave für alle Töne";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_OCTAVE_TITLE = "Setze Oktave";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_WAVEFORM_TIP = "Setzt die Art des Tones z.B. Sinus oder Dreieck";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_WAVEFORM_TITLE = "Setze Klangfarbe";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_STOP_TONE_TIP = "Schaltet den aktuellen Ton aus";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_STOP_TONE_TITLE = "Ton aus";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_NOT_FOR_TONE_TITLE = "Nach jedem Ton weitermachen";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_TIP = "Warte für eine angegebene Tondauer";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_TITLE = "Warte";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIMEOUT_FIELD = "mit Timeout";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIP = "Schaltet nach der angegebenen Zeit automatisch aus";
...
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TITLE = "Automatisch ausschalten";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_PRESSED_TIP = "Ja, wenn der angegebene Knopf gedrückt ist";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_PRESSED_TITLE = "Ist Knopf gedrückt?";
/** @export */ Blockly.Msg.OXOCARD_CLEAR_DISPLAY_TIP = "Schaltet das ganze Display aus";
/** @export */ Blockly.Msg.OXOCARD_CLEAR_DISPLAY_TITLE = "Lösche Display";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TIP = "Prüfe, ob eine Broadcast Nachricht eingetroffen ist";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TITLE = "Broadcast empfangen?";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_MESSAGE_TIP = "Vergleiche die empfangene Nachricht mit dem angegebenen Text";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_MESSAGE_TITLE = "Vergleiche Broadcast Nachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_NUMBER_TIP = "Vergleiche die empfangene Nummer mit dem angegebenen Wert";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_NUMBER_TITLE = "Vergleiche Broadcast Nummer";
/** @export */ Blockly.Msg.OXOCARD_COMM_DISABLE_TIP = "Schaltet den Kurzmeldungsdienst aus";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TIP = "Broadcastet eine Nachricht an alle OXOcards";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TITLE = "Sende Broadcast Nachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_FIELD = "und Nummer";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TIP = "Broadcastet eine Nummer an alle OXOcards";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TITLE = "Sende Broadcast Nummer";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_FIELD = "mit Timeout";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_TIP = "Wartet für die angegebene Zeit auf eine Kurzmeldung";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIP = "Wartet bis eine Kurzmeldung eintrifft";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TITLE = "Warte auf Kurzmeldung";
/** @export */ Blockly.Msg.OXOCARD_CONNECT_TO_INTERNET_SAWTOOTH = "Sägezahn";
/** @export */ Blockly.Msg.OXOCARD_CONNECT_TO_INTERNET_SINE = "Sinus";
/** @export */ Blockly.Msg.OXOCARD_CONNECT_TO_INTERNET_SQUARE = "Rechteck";
...
/** @export */ Blockly.Msg.OXOCARD_CONNECT_TO_INTERNET_TRIANGLE = "Dreieck";
/** @export */ Blockly.Msg.OXOCARD_DRAW_CHAR_TIP = "Zeichnet ein einzelner Buchstabe (A - Z)";
/** @export */ Blockly.Msg.OXOCARD_DRAW_CHAR_TITLE = "Zeichne Buchstabe";
/** @export */ Blockly.Msg.OXOCARD_DRAW_DIGIT_TIP = "Zeichnet eine einzelne Ziffer (0 - 9)";
/** @export */ Blockly.Msg.OXOCARD_DRAW_DIGIT_TITLE = "Zeichne Ziffer";
/** @export */ Blockly.Msg.OXOCARD_DRAW_NUMBER_TIP = "Zeichnet eine Nummer (0 - 99)";
/** @export */ Blockly.Msg.OXOCARD_DRAW_NUMBER_TITLE = "Zeichne Nummer";
/** @export */ Blockly.Msg.OXOCARD_FILL_DISPLAY_TIP = "Schaltet das ganze Display an (Helligkeit 0 - 255)";
/** @export */ Blockly.Msg.OXOCARD_FILL_DISPLAY_TITLE = "Fülle Display";
/** @export */ Blockly.Msg.OXOCARD_FIND_IBEACON_TIP = "Sucht nach iBeacons mit der angegebenen ID";
/** @export */ Blockly.Msg.OXOCARD_FIND_IBEACON_TITLE = "Finde iBeacon mit ID";
/** @export */ Blockly.Msg.OXOCARD_GET_ACCELERATION_TIP = "Gibt die Beschleunigung der angegebenen Achse zurück";
/** @export */ Blockly.Msg.OXOCARD_GET_ACCELERATION_TITLE = "Beschleunigung";
/** @export */ Blockly.Msg.OXOCARD_GET_ORIENTATION_TIP = "Gibt die Orientierung der OXOcard zurück";
/** @export */ Blockly.Msg.OXOCARD_GET_ORIENTATION_TITLE = "Orientierung ";
/** @export */ Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TIP = "Liefert die Sekunden des Timers zurück";
/** @export */ Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TITLE = "Hole Timer Sekunden";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_DOWN_FIELD = "Ab";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HORIZONTALLY_FIELD = "Horizontal";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_TIP = "Ja, wenn die OXOcard in der angegebenen Orientierung liegt";
...
/** @export */ Blockly.Msg.OXOCARD_MATH_DECREMENT_TIP = "Subtrahiere 1 von der angegebenen Variable";
/** @export */ Blockly.Msg.OXOCARD_MATH_DECREMENT_TITLE = "Subtrahiere 1 von";
/** @export */ Blockly.Msg.OXOCARD_MATH_INCREMENT_TIP = "Addiere 1 zu der angegebenen Variable";
/** @export */ Blockly.Msg.OXOCARD_MATH_INCREMENT_TITLE = "Addiere 1 zu";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_RANDOM_TIP = "Schreibt eine zufällige Zahl in die angegebene Variable.";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_RANDOM_TITLE = "Zufallszahl in";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_RANDOM_TITLE2 = "von";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_RANDOM_TITLE3 = "bis";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_ALL_TITLE = "Zeichne alle Pixel";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_CIRCLE_RADIUS = "Radius";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_CIRCLE_TIP = "Zeichnet einen Kreis an der angegebenen Position";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_CIRCLE_TITLE = "Zeichne Kreis";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_IMAGE_TIP = "Zeichnet ein einfarbiges Bild.";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_IMAGE_TITLE = "Einfarbiges Bild";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_FROM = "von";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_TIP = "Zeichnet eine Linie vom angegebenen Start- zum Endpunkt";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_TITLE = "Zeichne Linie";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_TO = "bis";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_NUMBER_TIP = "Zeichnet eine Nummer ufs Display";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_NUMBER_TITLE = "Zeichne Nummer";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_PIXEL_TIP = "Zeichnet ein Pixel an der angegebenen Koordinate";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_PIXEL_TITLE = "Zeichne Pixel";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RECTANGLE_HEIGHT = "Höhe";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RECTANGLE_TIP = "Zeichnet ein Quadrat an der angegebenen Position";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RECTANGLE_TITLE = "Zeichne Quadrat";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RECTANGLE_WIDTH = "Breite";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RGB_IMAGE_TIP = "Zeichnet ein Bild mit mehreren Farben.";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RGB_IMAGE_TITLE = "Mehrfarbiges Bild";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TEXT_BIG_FONT = "Grosse Schrift ";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TEXT_SMALL_FONT = "Kleine Schrift";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TEXT_TIP = "Zeichnet den angegebenen Text auf dem Display";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TEXT_TITLE = "Zeichne Text";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TRIANGLE_TIP = "Zeichnet ein Dreieck an der angegebenen Position";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_COLOR_VAR_TITLE = "Setze Pinselfarbe";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FILL_TIP = "Die Formen werden beim Zeichnen ausgefüllt";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FILL_TITLE = "Fülle Objekte";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_NOFILL_TIP = "Die Formen werden beim Zeichnen nicht ausgefüllt";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_NOFILL_TITLE = "Leere Objekte";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_UPDATE_TIP = "Zeichnet das aktuelle Bild";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_UPDATE_TITLE = "Matrix aktualisieren";
/** @export */ Blockly.Msg.OXOCARD_NO_AUTO_TURNOFF_TIP = "Deaktiviert die automatische ausschalt Funktion";
...
/** @export */ Blockly.Msg.OXOCARD_PRINTLN_TIP = "Schreibt die angegebene Nummer oder Text in die Konsole (mit einem Zeilenumbruch)";
/** @export */ Blockly.Msg.OXOCARD_PRINTLN_TITLE = "Schreibe Zeile";
/** @export */ Blockly.Msg.OXOCARD_PRINT_TIP = "Schreibt die angegebene Nummer oder Text in die Konsole";
...
/** @export */ Blockly.Msg.OXOCARD_RESET_TIMER_TITLE = "Timer zurücksetzen";
/** @export */ Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_ID_FIELD = "mit der ID";
/** @export */ Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_TIP = "Startet die OXOcard als iBeacon mit der angegebenen ID";
/** @export */ Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_TITLE = "Starte als iBeacon";
/** @export */ Blockly.Msg.OXOCARD_SET_CURSOR_TIP = "Setze die Position des Cursors";
/** @export */ Blockly.Msg.OXOCARD_SET_CURSOR_TITLE = "Setze Cursor";
/** @export */ Blockly.Msg.OXOCARD_SMILE_TIP = "Zeichnet ein einfaches Smile :)";
/** @export */ Blockly.Msg.OXOCARD_SMILE_TITLE = "Zeichne Smile :)";
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_1 = "Pacific - Samoa / Pago";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_10 = "Atlantic - Cape Verde / Praia";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_11 = "Europe - London / Lisbon";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_12 = "Europe - Zurich / Warsaw";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_13 = "Europe - Athens / Helsinki";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_14 = "Europe - Moscow / Baghdad";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_15 = "Asia - Baku / Dubai";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_16 = "Asia - Karachi / Yekaterinburg";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_17 = "Asia - Dhaka / Omsk";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_18 = "Asia - Jakarta / Bangkok";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_19 = "Asia - Beijing / Pago";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_2 = "Pacific - Honolulu / Papeete";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_20 = "Asia - Tokyo / Yakutsk";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_21 = "Australia - Port Moresby / Brisbane";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_22 = "Australia - Sydney / Nouméa";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_23 = "Pacific - Auckland / Suva";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_3 = "Pacific - Auckland / Anchorage";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_4 = "America - Los Angeles / Vancouver";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_5 = "America - Phoenix / Calgary";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_6 = "America - Chicago / Mexico City";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_7 = "America - New York / Toronto";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_8 = "America - Santiago / Halifax";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_ID_9 = "America - São Paulo / Buenos Aires";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_TIP = "Get the time from a given city";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_TITLE = "Get time for ";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_DAY = "day";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_HOUR = "hour";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_MINUTE = "minutes";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_MONTH = "month";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_SECOND = "seconds";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_TIP = "Get a specific value from the time e.g. seconds";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_TITLE = "Get time ";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_WEEKDAY = "weekday";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_YEAR = "year";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_UPDATE_TIP = "Updates the time on the OXOcard";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TIME_UPDATE_TITLE = "Synchronize time";  // untranslated
/** @export */ Blockly.Msg.OXOCARD_TONE_DURATION_FIELD = "für die Dauer";
/** @export */ Blockly.Msg.OXOCARD_TONE_FREQUENCY_FIELD = "mit Frequenz";
/** @export */ Blockly.Msg.OXOCARD_TONE_NO_DURATION_TIP = "Spielt einen ton ab";
/** @export */ Blockly.Msg.OXOCARD_TONE_NO_DURATION_TITLE = "Spiele Ton";
/** @export */ Blockly.Msg.OXOCARD_TONE_TIP = "Spelt ein Ton für die angegebene Zeit";
/** @export */ Blockly.Msg.OXOCARD_TONE_TITLE = "Spiele Ton";
/** @export */ Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TIP = "Schaltet das ganze Display an";
/** @export */ Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TITLE = "Schalte Display an";
/** @export */ Blockly.Msg.OXOCARD_TURN_OXOCARD_OFF_TIP = "Schaltet die OXOcard aus";
/** @export */ Blockly.Msg.OXOCARD_TURN_OXOCARD_OFF_TIP2 = "Schaltet die OXOcard aus";
...
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_FROM_TITLE = "Hole Wetter von";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_ICON_TIP = "Hole die Icon-Nummer vom Wetter";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_ICON_TITLE = "Wetter: Hole Icon";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_DEWPOINT = "Taupunkt";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_HUMIDITY = "Luftfeuchtigkeit";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_PRECIPITATION = "Niederschlag";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TEMP = "Temperatur";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TIP = "Hole einen wert vom Wetter";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TITLE = "Wetter: Hole";
