...
/**
 * @fileoverview Angular2 Component that details how the demo is displayed. Also handles any interactions with the demo.
...
`;
  ...
  <block type='text_print' x='137' y='213'>
    ...
    workspaceUpdated: function(xmlText, workspaceList,
     button1, button2, button3, num) {
      ...
      //TODO(madeeha): add non-visual feedback when this completes successfully or not successfully.
    },
  });
