...
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https://github.com/google/blockly/wiki/Loops#for-each для кожнага блёку";
...
Blockly.Msg.LISTS_IS_EMPTY_TITLE = "%1 пусты";
...
Blockly.Msg.LISTS_TOOLTIP = "Вяртае значэньне ісьціна, калі сьпіс пусты.";
...
Blockly.Msg.MATH_CHANGE_TITLE_CHANGE = "зьмяніць";
...
Blockly.Msg.VARIABLES_SET_TITLE = "усталяваць";
