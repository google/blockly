...
messages["ADD_COMMENT"] = "टिप्पणी थप्दे";
...
messages["CHANGE_VALUE_TITLE"] = "मान बदल";
messages["CLEAN_UP"] = "ब्लकनलाई हटाओ";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "ब्लक भत्काओ";
messages["COLLAPSE_BLOCK"] = "ब्लक भत्का";
...
messages["COLOUR_BLEND_TITLE"] = "मिश्रण गर";
messages["COLOUR_BLEND_TOOLTIP"] = "दियाका अनुपात (0.0 - 1.0) का साथ दुई रंगहरूको मिश्रण गरन्छ ।";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["COLOUR_PICKER_TOOLTIP"] = "पैलेट बाट एक रंग चुन ।";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "जुनसुकै रङ्ग";
messages["COLOUR_RANDOM_TOOLTIP"] = "रैन्डम्ली एक रंग चयन गर ।";
messages["COLOUR_RGB_BLUE"] = "निलो";
messages["COLOUR_RGB_GREEN"] = "हरियो";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "रातो";
messages["COLOUR_RGB_TITLE"] = "यै रङ्गको";
messages["COLOUR_RGB_TOOLTIP"] = "रातो, हरियो और नीलोको निर्दिष्ट मात्राकी साथ एक रंग बनाओ । सबै मान ० देखि १०० का बीच हुनु पडन्छ ।";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "लूप बाट भाइर निकलौं";
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "लूपको अर्को आईटरेशन जारी राख";
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "भीत्री लूप बाट बाहिर निस्कने";
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] = "बचेका लूपलाई छोड, और अर्को आईटरेशन जारी राख ।";
messages["CONTROLS_FLOW_STATEMENTS_WARNING"] = "सावधान: यो ब्लक केवल लूप भित्रमात्र प्रयोग गद्द सकिन्छ ।";
messages["CONTROLS_FOREACH_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#for-each";  // untranslated
messages["CONTROLS_FOREACH_TITLE"] = "%2 सूचीमी भयाः प्रत्येक आइटम %1 खिलाइ";
messages["CONTROLS_FOREACH_TOOLTIP"] = "सूचीको प्रत्येक आइटमको लागी, आइटममी चरको मान '%1' राखौं और पाछा क्यै कथन लेख ।";
messages["CONTROLS_FOR_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#count-with";  // untranslated
messages["CONTROLS_FOR_TITLE"] = "गन्ती गर %1 देखी %2 %3 %4 सम्म";
...
messages["CONTROLS_IF_ELSEIF_TOOLTIP"] = "यदि ब्लकमा एक शर्त जोडौं ।";
...
messages["CONTROLS_IF_MSG_ELSE"] = "एल्स";
messages["CONTROLS_IF_MSG_ELSEIF"] = "एल्स इफ";
messages["CONTROLS_IF_MSG_IF"] = "इफ";
messages["CONTROLS_IF_TOOLTIP_1"] = "जब तलक मान सत्य छ, तब तलक क्यै स्टेट्मेंट चलाओ ।";
messages["CONTROLS_IF_TOOLTIP_2"] = "यदि एक मान सत्य छ भण्या कथनहरूको प्रथम खण्ड बणाओ । अन्यथा कथनहरूको अर्को भाग निर्मित गर ।";
...
messages["CONTROLS_REPEAT_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["CONTROLS_REPEAT_INPUT_DO"] = "डू";
messages["CONTROLS_REPEAT_TITLE"] = "%1 पल्ट दोसराओ";
messages["CONTROLS_REPEAT_TOOLTIP"] = "क्यै स्टेट्मन्ट कैयों पल्ट चलाओ ।";
messages["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "दोहराओ जब तलक";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "दोहराओ जब की";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "जब तक मान फॉल्स छ, तब तक क्यै स्टेट्मेंट्स चलाओ ।";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "जब तलक मान सत्य छ, तब तलक क्यै स्टेट्मेंट चलाओ ।";
messages["DELETE_ALL_BLOCKS"] = "सबै %1 ब्लकनलाई हटाउन्या ?";
messages["DELETE_BLOCK"] = "ब्लक हटाउन्या";
messages["DELETE_VARIABLE"] = "'%1' भेरिएबल मेट:";
messages["DELETE_VARIABLE_CONFIRMATION"] = "'%2' भेरिएबला %1 प्रयोग मेट्ट्या?";
messages["DELETE_X_BLOCKS"] = " %1 ब्लकहरू हटाउन्या";
messages["DIALOG_CANCEL"] = "खारेजी";
messages["DIALOG_OK"] = "हुन्छ";
messages["DISABLE_BLOCK"] = "ब्लकलाई निश्क्रिय पाड्डे";
messages["DUPLICATE_BLOCK"] = "कपी गर";
messages["DUPLICATE_COMMENT"] = "हूबहू टिप्पणी";
messages["ENABLE_BLOCK"] = "ब्लकलाई सक्रिय पाड्डे";
messages["EXPAND_ALL"] = "ब्लकनलाई फैलाओ";
messages["EXPAND_BLOCK"] = "ब्लकनलाई फैलाओ";
messages["EXTERNAL_INPUTS"] = "भाइरका इन्पुटहरू";
messages["HELP"] = "सहायता";
messages["INLINE_INPUTS"] = "इनलाइन इन्पुटहरू";
...
messages["LOGIC_BOOLEAN_FALSE"] = "असत्य";
messages["LOGIC_BOOLEAN_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
messages["LOGIC_BOOLEAN_TOOLTIP"] = "सत्य या असत्य फिर्ता अरन्छ।";
messages["LOGIC_BOOLEAN_TRUE"] = "सत्य";
messages["LOGIC_COMPARE_HELPURL"] = "https://en.wikipedia.org/wiki/Inequality_(mathematics)";
messages["LOGIC_COMPARE_TOOLTIP_EQ"] = "यदी दुवै इनपुट एक अर्काका बराबर छन् भण्या टु रिटर्न गर ।";
messages["LOGIC_COMPARE_TOOLTIP_GT"] = "पैल्लो इनपुट दोसरा इनपुट है ठुलो भया ट्रू फिर्ता अर:।";
messages["LOGIC_COMPARE_TOOLTIP_GTE"] = "पैल्लो इनपुट दोसरा इनपुट है ठुलो या उइ सित बराबर भया ट्रू फिर्ता अर:।";
messages["LOGIC_COMPARE_TOOLTIP_LT"] = "पैल्लो इनपुट दोसरा इनपुट है नानो भया ट्रू फिर्ता अर:।";
messages["LOGIC_COMPARE_TOOLTIP_LTE"] = "पैल्लो इनपुट दोसरा इनपुट है नानो या उइ सित बराबर भया ट्रू फिर्ता अर:।";
messages["LOGIC_COMPARE_TOOLTIP_NEQ"] = "यदी दुवै इनपुट एक अर्काको बराबर नाइथिन् भणया टु रिटर्न गर ।";
...
messages["LOGIC_NEGATE_TOOLTIP"] = "इनपुट असत्य भयाले सन्य फिर्ता अरन्छ। इनपुट सत्य भयाले असत्य फिर्ता अरन्छ।";
messages["LOGIC_NULL"] = "शू्य";
messages["LOGIC_NULL_HELPURL"] = "https://en.wikipedia.org/wiki/Nullable_type";  // untranslated
messages["LOGIC_NULL_TOOLTIP"] = "शून्य फिर्ता अरन्छ।";
messages["LOGIC_OPERATION_AND"] = "रे";
messages["LOGIC_OPERATION_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#logical-operations";  // untranslated
messages["LOGIC_OPERATION_OR"] = "या";
messages["LOGIC_OPERATION_TOOLTIP_AND"] = "दुएइ इनपुट ट्रू भया ट्रू फिर्ता अर:।";
messages["LOGIC_OPERATION_TOOLTIP_OR"] = "कम्तीमी लै १ इनपुट सत्य भयाले सत्य फिर्ता अर।";
...
messages["NEW_VARIABLE"] = "भेरिएवल बना:";
messages["NEW_VARIABLE_TITLE"] = "नयाँ भेरिबलको नाम:";
...
messages["REDO"] = "पुन: कायम गद्दे";
messages["REMOVE_COMMENT"] = "टिप्पणी हटाउन्या";
messages["RENAME_VARIABLE"] = "भेरिबललाई पुनः नामांकन गर...";
messages["RENAME_VARIABLE_TITLE"] = "सबै भेरिबलनका %1 नाम बदल्न्या:";
...
messages["VARIABLE_ALREADY_EXISTS"] = "'%1' नाउँ अरियाऽ भेरिएबल पैली बठेइ छ।";
