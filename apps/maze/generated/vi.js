...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">đi tới</span><span id="Maze_turnLeft">quay qua trái</span><span id="Maze_turnRight">quay qua phải</span><span id="Maze_doCode">hãy</span><span id="Maze_elseCode">nếu không</span><span id="Maze_helpIfElse">Mảnh \'nếu-nếu không\' sẽ thực hiện một trong hai nhóm lệnh đưa ra.</span><span id="Maze_pathAhead">nếu có đường phía trước</span><span id="Maze_pathLeft">nếu có đường bên trái</span><span id="Maze_pathRight">nếu có đường bên phải</span><span id="Maze_repeatUntil">lặp lại cho đến</span><span id="Maze_moveForwardTooltip">Di chuyển Pegman tới một bước.</span><span id="Maze_turnTooltip">Quay Pegman qua bên trái hoặc bên phải 90 độ.</span><span id="Maze_ifTooltip">Nếu có đường ở hướng đấy, hãy thực hiện các lệnh đưa ra.</span><span id="Maze_ifelseTooltip">Nếu có đường ở hướng đấy, hãy thực hiện các lệnh thứ nhất. Nếu không, thực hiện các lệnh thứ hai.</span><span id="Maze_whileTooltip">Thực hiện các lệnh được bao gồm cho đến khi đến đích</span><span id="Maze_capacity0">Bạn còn %0 mảnh.</span><span id="Maze_capacity1">Bạn còn %1 mảnh.</span><span id="Maze_capacity2">Bạn còn %2 mảnh.</span><span id="Maze_nextLevel">Chúc mừng! Bạn đã sẵn sàng qua vòng %1?</span><span id="Maze_finalLevel">Chúc mừng! Bạn đã giải xong vòng cuối cùng.</span></div>';
};
