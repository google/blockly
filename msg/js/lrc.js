...
messages["ADD_COMMENT"] = "نٱزٱرتو ناْ اْزاف بٱکؽت";
...
messages["CHANGE_VALUE_TITLE"] = "ٱرزشت آلشت کو:";
...
messages["COLLAPSE_ALL"] = "کوچک کردن برشتؽا";
messages["COLLAPSE_BLOCK"] = "کوچک کردن برشت";
messages["COLOUR_BLEND_COLOUR1"] = "رٱنڳ 1";
messages["COLOUR_BLEND_COLOUR2"] = "رٱنڳ 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "نسڤٱت";
messages["COLOUR_BLEND_TITLE"] = "شؽڤسٱ";
messages["COLOUR_BLEND_TOOLTIP"] = "هٱر کوم د رٱنڳؽا ناْ ڤا نسڤٱت داٛئٱ بٱ بٱشؽڤن(0.0 - 1.0).";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["COLOUR_PICKER_TOOLTIP"] = "یاٛ رٱنڳ د رٱنڳدو اْنتخاو بٱکؽت";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "رٱنڳ بٱختٱکی";
messages["COLOUR_RANDOM_TOOLTIP"] = "یاٛ ٱنڳ بٱختٱکی اْنتخاو بٱکؽت";
messages["COLOUR_RGB_BLUE"] = "آوئی";
messages["COLOUR_RGB_GREEN"] = "سۉز";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "سۏز";
messages["COLOUR_RGB_TITLE"] = "رٱنڳ ڤا";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "هٱلقٱ ناْ خراو کو";
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "continue with next iteration of loop";  // untranslated
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "هٱلقٱ شومل بیٱ ناْ خراو کو";
...
messages["CONTROLS_FOREACH_TITLE"] = "سی هٱر قلٱم %1 د نومگٱ %2";
...
messages["CONTROLS_FOR_TITLE"] = "شماردن وا %1 د %2 سی %3 ڤا %4";
...
messages["CONTROLS_IF_MSG_ELSE"] = "هنی";
messages["CONTROLS_IF_MSG_ELSEIF"] = "هنی ٱر";
messages["CONTROLS_IF_MSG_IF"] = "ٱر";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "ٱنجوم باٛ";
messages["CONTROLS_REPEAT_TITLE"] = "%1 تکرار کو چٱن بار";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "تا تکرار کو";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "تا تکرار کو";
...
messages["DELETE_BLOCK"] = "پاکسا کردن برشت";
...
messages["DELETE_X_BLOCKS"] = "پاکسا کردن%1 د برشتؽا";
messages["DIALOG_CANCEL"] = "رٱد كردن";
messages["DIALOG_OK"] = "خۊئٱ";
messages["DISABLE_BLOCK"] = "ناکشتگر کردن برشت";
messages["DUPLICATE_BLOCK"] = "کپی کردن";
messages["DUPLICATE_COMMENT"] = "نٱزٱر تکراری";
messages["ENABLE_BLOCK"] = "کنشتگر کردن برشت";
messages["EXPAND_ALL"] = "گٱپ کردن برشتؽا";
messages["EXPAND_BLOCK"] = "گٱپ کردن برشت";
messages["EXTERNAL_INPUTS"] = "دادٱیا ڤ دری";
messages["HELP"] = "هومياری";
messages["INLINE_INPUTS"] = "دادٱیا مؽنجا";
messages["LISTS_CREATE_EMPTY_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#create-empty-list";  // untranslated
messages["LISTS_CREATE_EMPTY_TITLE"] = "یاٛ نومگٱ هالٛی دۏرس بٱکؽت";
messages["LISTS_CREATE_EMPTY_TOOLTIP"] = "Returns a list, of length 0, containing no data records";  // untranslated
messages["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "نومگٱ";
...
messages["LISTS_GET_INDEX_FIRST"] = "ٱڤلی";
messages["LISTS_GET_INDEX_FROM_END"] = "# تا آخر";
messages["LISTS_GET_INDEX_FROM_START"] = "#";  // untranslated
messages["LISTS_GET_INDEX_GET"] = "گرتن";
messages["LISTS_GET_INDEX_GET_REMOVE"] = "گرتن ۉ جا ڤ جا بیئن";
messages["LISTS_GET_INDEX_LAST"] = "آخر";
messages["LISTS_GET_INDEX_RANDOM"] = "بٱختٱکی";
messages["LISTS_GET_INDEX_REMOVE"] = "ڤرداشتن";
...
messages["LISTS_GET_SUBLIST_END_FROM_START"] = "سی#";
messages["LISTS_GET_SUBLIST_END_LAST"] = "سی آخر";
...
messages["LISTS_SET_INDEX_INPUT_TO"] = "چی";
messages["LISTS_SET_INDEX_INSERT"] = "بٱنؽ د";
...
messages["LOGIC_BOOLEAN_FALSE"] = "غلٱت";
messages["LOGIC_BOOLEAN_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
messages["LOGIC_BOOLEAN_TOOLTIP"] = "هٱم غلٱت ۉ هٱم دۏرس ڤرگٱردن";
messages["LOGIC_BOOLEAN_TRUE"] = "راس ۉ دۏرس";
...
messages["LOGIC_OPERATION_AND"] = "ۉ";
...
messages["LOGIC_TERNARY_CONDITION"] = "آزماشت کردن";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "ٱر غلٱت بی";
messages["LOGIC_TERNARY_IF_TRUE"] = "ٱر دۏرس بی";
...
messages["MATH_ARITHMETIC_TOOLTIP_ADD"] = "ڤاْ ٱندازٱ دۏ شمارٱ ڤرگٱردن.";
...
messages["MATH_CHANGE_TITLE"] = "آلشت بٱکؽت %1 وا %2";
...
messages["MATH_IS_DIVISIBLE_BY"] = "یٱ ڤا بٱئر بیٱ";
messages["MATH_IS_EVEN"] = "همیشٱ هؽسش";
messages["MATH_IS_NEGATIVE"] = "مٱنفی ٱ";
messages["MATH_IS_ODD"] = "تٱنڳؽا ٱ";
messages["MATH_IS_POSITIVE"] = "موسبٱتٱ";
messages["MATH_IS_PRIME"] = "ڤٱ ٱڤلٱ";
...
messages["MATH_NUMBER_TOOLTIP"] = "یاٛ شمارٱ.";
messages["MATH_ONLIST_HELPURL"] = "";  // untranslated
messages["MATH_ONLIST_OPERATOR_AVERAGE"] = "مؽنجاگٱ نومگٱ";
messages["MATH_ONLIST_OPERATOR_MAX"] = "بؽشترونٱ د نومگٱ";
messages["MATH_ONLIST_OPERATOR_MEDIAN"] = "مؽنجا نومگٱ";
messages["MATH_ONLIST_OPERATOR_MIN"] = "کٱمترونٱ د نومگٱ";
messages["MATH_ONLIST_OPERATOR_MODE"] = "بؽشری د نومگٱ";
...
messages["MATH_ONLIST_OPERATOR_SUM"] = "جٱم کردن نومگٱ";
...
messages["MATH_ROUND_OPERATOR_ROUND"] = "گرد کردن";
messages["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "ڤ هار گرد کردن";
messages["MATH_ROUND_OPERATOR_ROUNDUP"] = "ڤ رۉ گرد کردن";
...
messages["MATH_SINGLE_OP_ABSOLUTE"] = "تموم ۉ کمال";
messages["MATH_SINGLE_OP_ROOT"] = "چارسوک ریشٱ";
...
messages["NEW_VARIABLE"] = "آلشتگر تازٱ...";
messages["NEW_VARIABLE_TITLE"] = "نوم آلشتگر تازٱ:";
messages["NEW_VARIABLE_TYPE_TITLE"] = "نوع آلشتگر تازٱ";
messages["ORDINAL_NUMBER_SUFFIX"] = "";  // untranslated
messages["PROCEDURES_ALLOW_STATEMENTS"] = "allow statements";  // untranslated
messages["PROCEDURES_BEFORE_PARAMS"] = "ڤا:";
...
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "ڤا:";
messages["PROCEDURES_CREATE_DO"] = "دۏرس کردن%1";
...
messages["PROCEDURES_DEFNORETURN_PROCEDURE"] = "یاٛ کار ٱنجوم باٛئؽت";
messages["PROCEDURES_DEFNORETURN_TITLE"] = "سی";
...
messages["PROCEDURES_DEFRETURN_RETURN"] = "ڤرگٱردنیئن";
...
messages["PROCEDURES_MUTATORARG_TITLE"] = "نوم دادٱ:";
messages["PROCEDURES_MUTATORARG_TOOLTIP"] = "Add an input to the function.";  // untranslated
messages["PROCEDURES_MUTATORCONTAINER_TITLE"] = "دادٱیا";
messages["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] = "Add, remove, or reorder inputs to this function.";  // untranslated
messages["REDO"] = "د نۊ ٱنجوم داٛئن";
messages["REMOVE_COMMENT"] = "هٱزف نٱزٱر";
messages["RENAME_VARIABLE"] = "د نۊ نوم نؽاین آلشتگر...";
messages["RENAME_VARIABLE_TITLE"] = "د نو نوم نؽاین %1 د تموم آلشتگریا د:";
...
messages["TEXT_CHANGECASE_OPERATOR_LOWERCASE"] = "سی ڤاج کوچک";
messages["TEXT_CHANGECASE_OPERATOR_TITLECASE"] = "to Title Case";  // untranslated
messages["TEXT_CHANGECASE_OPERATOR_UPPERCASE"] = "سی هٱرف گٱپ";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "پاٛڤٱسن";
messages["TEXT_CREATE_JOIN_TOOLTIP"] = "Add, remove, or reorder sections to reconfigure this text block.";  // untranslated
messages["TEXT_GET_SUBSTRING_END_FROM_END"] = "سی ڤاج# تا آخر";
messages["TEXT_GET_SUBSTRING_END_FROM_START"] = "سی ڤاج#";
messages["TEXT_GET_SUBSTRING_END_LAST"] = "سی آخری ڤاج";
messages["TEXT_GET_SUBSTRING_HELPURL"] = "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";  // untranslated
messages["TEXT_GET_SUBSTRING_INPUT_IN_TEXT"] = "د مٱتن";
...
messages["TEXT_INDEXOF_TITLE"] = "د مٱتن %1 %2 %3";
...
messages["TEXT_ISEMPTY_TITLE"] = "%1 هالٛیٱ";
...
messages["TEXT_JOIN_TITLE_CREATEWITH"] = "دۏرس کردن مٱتن ڤا";
...
messages["TODAY"] = "اؽمرۊ";
messages["UNDO"] = "ٱنجوم نٱداٛئن";
messages["UNNAMED_KEY"] = "unnamed";  // untranslated
messages["VARIABLES_DEFAULT_NAME"] = "قلٱم";
...
messages["VARIABLES_SET"] = "میزوکاری %1 سی %2";
