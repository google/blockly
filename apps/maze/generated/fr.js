...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">avancer</span><span id="Maze_turnLeft">tourner à gauche</span><span id="Maze_turnRight">tourner à droite</span><span id="Maze_doCode">faire</span><span id="Maze_elseCode">sinon</span><span id="Maze_helpIfElse">Un bloc \'Si-Sinon\' exécute une chose ou l\'autre.</span><span id="Maze_pathAhead">si chemin devant</span><span id="Maze_pathLeft">si chemin vers la gauche</span><span id="Maze_pathRight">si chemin vers la droite</span><span id="Maze_repeatUntil">répèter jusqu\'a</span><span id="Maze_moveForwardTooltip">Avance le joueur d\'un espace</span><span id="Maze_turnTooltip">Tourne le joueur à gauche ou à droite de 90 degrés.</span><span id="Maze_ifTooltip">Si il y\'a un chemin dans la direction specifiée, alors effectue ces actions.</span><span id="Maze_ifelseTooltip">Si il y\'a un chemin dans la direction specifiée, alors fais le premier bloc d\'actions. Sinon fais le second bloc d\'actions.</span><span id="Maze_whileTooltip">Répète les blocs qui sont à l\'intérieur jusqu\'à atteindre le but.</span><span id="Maze_capacity0">Il te reste %0 blocs.</span><span id="Maze_capacity1">Il te reste %1 bloc.</span><span id="Maze_capacity2">Il te reste %2 blocs.</span><span id="Maze_nextLevel">Bravo ! Est tu prêt pour le niveau %1?</span><span id="Maze_finalLevel">Bravo ! Tu as fini le dernier niveau.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Labyrinthe</span> &nbsp; ';
