...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Số hàng ghế: %1</span><span id="Plane_getRows">đếm số hàng ghế (%1)</span><span id="Plane_rows1">Hàng hạng nhất: %1</span><span id="Plane_getRows1">số hàng hạng nhất (%1)</span><span id="Plane_rows2">Hàng hạng hai: %1</span><span id="Plane_getRows2">số hàng hạng hai (%1)</span><span id="Plane_seats">Số chỗ ngồi: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">Tính số chỗ ngồi =</span></div>';
};
