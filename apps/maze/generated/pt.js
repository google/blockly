...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">Mover para a frente</span><span id="Maze_turnLeft">gire para a esquerda</span><span id="Maze_turnRight">gire para a direita</span><span id="Maze_doCode">faça</span><span id="Maze_elseCode">senão</span><span id="Maze_helpIfElse">O comando \'Se-senão\' faz uma coisa ou outra.</span><span id="Maze_pathAhead">se existe um caminho em frente</span><span id="Maze_pathLeft">se existe um caminho para a esquerda</span><span id="Maze_pathRight">se existe um caminho para a direita</span><span id="Maze_repeatUntil">repetir até</span><span id="Maze_moveForwardTooltip">Move o Pegman um quadro para frente.</span><span id="Maze_turnTooltip">Gire o Pegman 90 graus para esquerda ou para a direita.</span><span id="Maze_ifTooltip">Se existe um caminho na direção especificada, entao executa algumas ações.</span><span id="Maze_ifelseTooltip">Se não existe um caminho na direção especificada, então execute o primeiro bloco de ações. Senão, execute o segundo bloco de ações.</span><span id="Maze_whileTooltip">Repita as ações seguintes até que o ponto final seja alcançado.</span><span id="Maze_capacity0">Você tem mais %0 blocos.</span><span id="Maze_capacity1">Resta-lhe %1 bloco.</span><span id="Maze_capacity2">Você tem mais %2 blocos.</span><span id="Maze_nextLevel">Parabéns! Você está apto para o nível %1?</span><span id="Maze_finalLevel">Parabéns! Você resolveu o nível final.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = mazepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly</a> : Quebra-cabeça</span> &nbsp; ';
