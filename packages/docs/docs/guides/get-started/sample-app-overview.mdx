...
To get an in-depth overview of the sample app's source code, see the [getting started codelab](/codelabs/getting-started) which goes through the process of creating this app.
