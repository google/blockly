...
suite('Navigation', function() {
  function createNavigationWorkspace(enableKeyboardNav, readOnly) {
    ...
    var workspace = Blockly.inject('blocklyDiv', {toolbox: toolbox, readOnly: readOnly});
  ...
  suite('Tests toolbox keys', function() {
    ...
    var testCases = [
      ['Calls toolbox selectNext_', createKeyDownEvent(Blockly.utils.KeyCodes.S, 'NotAField'), 'selectNext_'],
      ['Calls toolbox selectPrevious_', createKeyDownEvent(Blockly.utils.KeyCodes.W, 'NotAField'), 'selectPrevious_'],
      ['Calls toolbox selectParent_', createKeyDownEvent(Blockly.utils.KeyCodes.D, 'NotAField'), 'selectChild_'],
      ['Calls toolbox selectChild_', createKeyDownEvent(Blockly.utils.KeyCodes.A, 'NotAField'), 'selectParent_']
    ];
    ...
    test('Go to flyout', function() {
      ...
      chai.assert.equal(Blockly.navigation.currentState_, Blockly.navigation.STATE_FLYOUT);
  ...
  suite('Tests flyout keys', function() {
    ...
    test('Out', function() {
      ...
      chai.assert.isTrue(keyDownSpy.returned(true));
      chai.assert.equal(Blockly.navigation.currentState_, Blockly.navigation.STATE_TOOLBOX);
    });
  ...
  suite('Tests workspace keys', function() {
    ...
    test('Toolbox', function() {
      ...
      chai.assert.isTrue(keyDownSpy.returned(true));
      chai.assert.equal(this.workspace.getToolbox().getSelectedItem(), firstCategory);
      chai.assert.equal(Blockly.navigation.currentState_, Blockly.navigation.STATE_TOOLBOX);
    });
  });
