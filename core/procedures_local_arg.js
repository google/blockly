 ...
 */
  ...
  * @const {string}
  * @alias Blockly.ProceduresLocalArg.CATEGORY_NAME
  */
  ...
  * @type {string}
  * @alias Blockly.ProceduresLocalArg.DEFAULT_ARG
  */
 const DEFAULT_ARG = 'x';
  ...
  * }}
  * @alias Blockly.ProceduresLocalArg.ProcedureBlock
  */
 let ProcedureBlock;
  ...
  * @alias Blockly.ProceduresLocalArg.allProcedures
  */
 const allProcedures = function(root) {
   const proceduresLocalNoReturn =
       root.getBlocksByType('procedures_local_defnoreturn', false).map(function(block) {
  ...
  * @alias Blockly.ProceduresLocalArg.findLegalName
  */
  ...
  * @alias Blockly.ProceduresLocalArg.isNameUsed
  */
  ...
  * @this {Field}
  * @alias Blockly.ProceduresLocalArg.rename
  */
  ...
  * @alias Blockly.ProceduresLocalArg.flyoutCategory
  */
 const flyoutCategory = function(workspace) {
   const xmlList = [];
   if (Blocks['procedures_local_defnoreturn']) {
     // <block type="procedures_defnoreturn" gap="16">
     //     <field name="NAME">do something</field>
     // </block>
     const block = utilsXml.createElement('block');
     block.setAttribute('type', 'procedures_local_defnoreturn');
 ...
 const updateMutatorFlyout = function(workspace) {
   const usedNames = [];
   const blocks = workspace.getBlocksByType('procedures_local_mutatorarg', false);
  ...
  * @alias Blockly.ProceduresLocalArg.mutatorOpenListener
  * @package
  */
 const mutatorOpenListener = function(e) {
   ...
   if (type !== 'procedures_local_defnoreturn' && type !== 'procedures_local_defreturn') {
     return;
   }
  ...
  * @alias Blockly.ProceduresLocalArg.getCallers
  */
  ...
  * @alias Blockly.ProceduresLocalArg.mutateCallers
  */
  ...
  * @alias Blockly.ProceduresLocalArg.getDefinition
  */
