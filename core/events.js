...
Blockly.Events.VarCreate.prototype.run = function(forward) {
  var workspace = Blockly.Workspace.getById(this.workspaceId);
  if (forward) {
    workspace.createVariable(this.name, this.varType, this.id);
  } else {
    workspace.deleteVariableById(this.id);
  }
};
...
Blockly.Events.VarRename.prototype.run = function(forward) {
  var workspace = Blockly.Workspace.getById(this.workspaceId);
  if (forward) {
    workspace.renameVariableById(this.id, this.newName);
  } else {
    workspace.renameVariableById(this.id, this.oldName);
  }
};
