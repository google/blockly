...
appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">Εφαρμογές Blockly</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>Το Blockly είναι ένα γραφικό περιβάλλον προγραμματισμού. Παρακάτω είναι μερικά δείγματα εφαρμογών που χρησιμοποιούν το Μπλόκλι.</td></tr></table><table><tr><td><a href="maze/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/maze.png" height=80 width=100></a></td><td><div><a href="maze/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Λαβύρινθος</a></div><div>Χρησιμοποίησε το Blockly για να λύσεις έναν λαβύρινθο.</div></td></tr><tr><td><a href="turtle/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/turtle.png" height=80 width=100></a></td><td><div><a href="turtle/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Γραφικά Με Τη Χελώνα</a></div><div>Χρησιμοποίησε το Blockly για σχεδίαση.</div></td></tr><tr><td><a href="graph/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/graph.png" height=80 width=100></a></td><td><div><a href="graph/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Αριθμομηχανή Γραφικών Παραστάσεων</a></div><div>Σχεδίασε μαθηματικές παραστάσεις με το Blockly.</div></td></tr><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Κώδικας</a></div><div>Για να εξάγεις πρόγραμμα γραμμένο σε Μπλόκλι στις γλώσσες JavaScript, Python, Dart ή XML.</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Υπολογισμός Θέσεων Σε Αεροπλάνο</a></div><div>Λύσε μαθηματικό πρόβλημα με μία ή δύο μεταβλητές.</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
