 ...
 * @override
 */
WorkspaceSvg.prototype.newBlock = function(prototypeName, opt_id, moduleId) {
...
WorkspaceSvg.prototype.pasteBlock_ = function(xmlBlock, jsonBlock, {dontSelectNewBLock} = {}) {
  ...
  try {
    ...
    if (!isNaN(blockX) && !isNaN(blockY)) {
      ...
      do {
        collide = false;
        const allBlocks = this.getAllBlocks(false, true);
 ...
 * @override
 */
WorkspaceSvg.prototype.getTopBlocks = function(ordered, inActiveModule) {
  return WorkspaceSvg.superClass_.getTopBlocks.call(this, ordered, inActiveModule);
};
