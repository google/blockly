...
function test_varCreate_toJson() {
  ...
  var expectedJson = ({type: "var_create", id: "id1", varType: "type1",
    name: "name1"});
...
function test_varCreate_runForward() {
  eventTest_setUp();
  var json = {type: "var_create", id: "id1", varType: "type1",
    name: "name1"};
...
function test_varDelete_toJson() {
  ...
  var event = new Blockly.Events.VarDelete(variable);
  var json = event.toJson();
  var expectedJson = ({type: "var_delete", id: "id1", varType: "type1",
    name: "name1"});
...
function test_varDelete_runBackwards() {
  eventTest_setUp();
  var json = {type: "var_delete", id: "id1", varType: "type1",
    name: "name1"};
  var event = Blockly.Events.fromJson(json, workspace);
  assertNull(workspace.getVariableById('id1'));
  event.run(false);
...
function test_varRename_constructor() {
  ...
  checkExactEventValues(event, {'id': 'id1', 'oldName': 'name1',
...
function test_varRename_toJson() {
  ...
  var event = new Blockly.Events.VarRename(variable, 'name2');
  var json = event.toJson();
  var expectedJson = ({type: "var_rename", id: "id1", oldName: "name1",
    newName: "name2"});
