...
messages["ADD_COMMENT"] = "კომენტარიშ გეძინა";
...
messages["CHANGE_VALUE_TITLE"] = "შანულობაშ თირუა:";
messages["CLEAN_UP"] = "ბლოკეფიშ გოუქვაფა";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "ბლოკეფიშ ინოკიჩუა";
messages["COLLAPSE_BLOCK"] = "ბლოკიშ ტყობინაფა";
messages["COLOUR_BLEND_COLOUR1"] = "ფერი 1";
messages["COLOUR_BLEND_COLOUR2"] = "ფერი 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "ფერი 1-შ წილი";
messages["COLOUR_BLEND_TITLE"] = "ესვარუა";
messages["COLOUR_BLEND_TOOLTIP"] = "ჟირ ფერს ართიანს უწყორუანს მოჩამილი ზჷმათ (0.0 - 1.0).";
messages["COLOUR_PICKER_HELPURL"] = "https://xmf.wikipedia.org/wiki/ფერი";
messages["COLOUR_PICKER_TOOLTIP"] = "გეგშაგორით ფერი პალიტრაშე.";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "შემთხვევითი ფერი";
messages["COLOUR_RANDOM_TOOLTIP"] = "ფერიშ შემთხვევითო გიშაგორუა.";
messages["COLOUR_RGB_BLUE"] = "ლენი";
messages["COLOUR_RGB_GREEN"] = "წვანე";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "ჭითა";
messages["COLOUR_RGB_TITLE"] = "ფერიː";
messages["COLOUR_RGB_TOOLTIP"] = "აკოქიმინით ფერი მოჩამილი ჭითა, წვანე დო ლენი ფერეფიშ პროპორციეფით. არძა შანულობა 0 დო 100 შქას ოკო რდას.";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "ციკლშე გიშულა";
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "ციკლიშ გეჸვენჯი ბიჯგშა გინულა";
messages["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "თე ციკლიშ მეჭყორიდუა.";
...
messages["CONTROLS_FLOW_STATEMENTS_WARNING"] = "ხვილაფა: თე ბლოკიშ გჷმორინაფა ხვალე ციკლიშ დინოხოლე შილებე.";
...
messages["CONTROLS_FOR_TOOLTIP"] = "მათირეფონი '%1'-ის მითმურჩქინანს შანულობას მოჩამილი ბიჯგეფით დუდშე ბოლოშა დო მეწურაფილ ზოჯუეფს არსულენს.";
...
messages["CONTROLS_IF_MSG_ELSE"] = "შხვანერო";
messages["CONTROLS_IF_MSG_ELSEIF"] = "შხვანერო თუ";
messages["CONTROLS_IF_MSG_IF"] = "თუ";
messages["CONTROLS_IF_TOOLTIP_1"] = "პიჯალეფი ნანდული ქორე-და, ზოჯუეფს არსულენს.";
...
messages["CONTROLS_REPEAT_HELPURL"] = "https://ru.wikipedia.org/wiki/ციკლი_(პროგრამირაფა)";
messages["CONTROLS_REPEAT_INPUT_DO"] = "რსულება";
messages["CONTROLS_REPEAT_TITLE"] = "%1 შა გომაჟირაფა";
messages["CONTROLS_REPEAT_TOOLTIP"] = "მუსხირენ ზოჯუაშ მუსხირენშა რსულება.";
messages["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "გომაჟირაფა, სოიშახ ვა";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "გომაჟირაფა, სოიშახ";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "სოიშახ შანულობა ტყურა რე, ზოჯუეფიშ რსულება";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "სოიშახ შანულობა ნანდული რე, ზოჯუეფიშ რსულება.";
messages["DELETE_ALL_BLOCKS"] = "არძა (%1) ბლოკი ბლასათო?";
messages["DELETE_BLOCK"] = "ბლოკიშ ლასუა";
messages["DELETE_VARIABLE"] = "'%1' მათირეფონიშ ლასუა";
messages["DELETE_VARIABLE_CONFIRMATION"] = "'%2' მათირეფონიშ გჷმორინაფა %1 ბლასათო?";
messages["DELETE_X_BLOCKS"] = "%1 ბლოკიშ ლასუა";
messages["DIALOG_CANCEL"] = "გოუქვაფა";
messages["DIALOG_OK"] = "OK";  // untranslated
messages["DISABLE_BLOCK"] = "ბლოკიშ თიშუა";
messages["DUPLICATE_BLOCK"] = "კოპირაფა";
messages["DUPLICATE_COMMENT"] = "კომენტარიშ დუბლირაფა";
messages["ENABLE_BLOCK"] = "ბლოკიშ ჩართება";
messages["EXPAND_ALL"] = "ბლოკეფიშ გჷმოფაჩუა";
messages["EXPAND_BLOCK"] = "ბლოკიშ გჷმოფაჩუა";
messages["EXTERNAL_INPUTS"] = "გალეშე დინოხუნაფა";
messages["HELP"] = "მოხვარა";
messages["INLINE_INPUTS"] = "დინოხოლე დინოხუნაფა";
...
messages["LISTS_ISEMPTY_TITLE"] = "%1 ცარიელი რე";
...
messages["LOGIC_BOOLEAN_FALSE"] = "ტყურა";
...
messages["MATH_ARITHMETIC_HELPURL"] = "https://xmf.wikipedia.org/wiki/არითმეტიკა";
...
messages["MATH_IS_EVEN"] = "ჭკობა რე";
messages["MATH_IS_NEGATIVE"] = "უარყოფითი რე";
messages["MATH_IS_ODD"] = "ცანდი რე";
messages["MATH_IS_POSITIVE"] = "დადებითი რე";
messages["MATH_IS_PRIME"] = "უკაჭული რე";
...
messages["MATH_IS_WHOLE"] = "ნთელი რე";
...
messages["MATH_NUMBER_HELPURL"] = "https://xmf.wikipedia.org/wiki/რიცხუ";
messages["MATH_NUMBER_TOOLTIP"] = "რიცხუ.";
...
messages["MATH_SINGLE_OP_ABSOLUTE"] = "მოდული";
messages["MATH_SINGLE_OP_ROOT"] = "კვადრატული ჯინჯი";
...
messages["NEW_VARIABLE"] = "აკოქიმინი მათირეფონი...";
messages["NEW_VARIABLE_TITLE"] = "ახალი მათირეფონიშ ჯოხო:";
...
messages["REDO"] = "ოშხონაფა";
messages["REMOVE_COMMENT"] = "კომენტარიშ გოუქვაფა";
messages["RENAME_VARIABLE"] = "ჯოხოშ თირუა მათირეფონი…";
messages["RENAME_VARIABLE_TITLE"] = "არძა მათირეფონი '%1' ჯოხოშ თირუა -შა:";
...
messages["TODAY"] = "ამდღა";
messages["UNDO"] = "გოუქვაფა";
messages["UNNAMED_KEY"] = "ჯოხოშ უმუშო";
messages["VARIABLES_DEFAULT_NAME"] = "ელემენტი";
...
messages["VARIABLE_ALREADY_EXISTS"] = "მათირეფონი ჯოხოთი '%1' უკვე არსენებს.";
