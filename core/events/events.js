...
const {CtrlClick} = goog.require('Blockly.Events.CtrlClick');
...
const {FlyoutShow} = goog.require('Blockly.Events.FlyoutShow');
const {FlyoutHide} = goog.require('Blockly.Events.FlyoutHide');
const {FlyoutZoom} = goog.require('Blockly.Events.FlyoutZoom');
const {LoadingError} = goog.require('Blockly.Events.LoadingError');
...
exports.CTRL_CLICK = eventUtils.CTRL_CLICK;
...
exports.FLYOUT_SHOW = eventUtils.FLYOUT_SHOW;
exports.FLYOUT_HIDE = eventUtils.FLYOUT_HIDE;
exports.FLYOUT_ZOOM = eventUtils.FLYOUT_ZOOM;
exports.LOADING_ERROR = eventUtils.LOADING_ERROR;
exports.MARKER_MOVE = eventUtils.MARKER_MOVE;
exports.MODULE_CREATE = eventUtils.MODULE_CREATE;
exports.MODULE_DELETE = eventUtils.MODULE_DELETE;
exports.MODULE_ACTIVATE = eventUtils.MODULE_ACTIVATE;
exports.MODULE_RENAME = eventUtils.MODULE_RENAME;
exports.MODULE_MOVE = eventUtils.MODULE_MOVE;
exports.MOVE_BLOCK_TO_MODULE = eventUtils.MOVE_BLOCK_TO_MODULE;
