...
Blockly.Msg["CONTROLS_FOR_TOOLTIP"] = "Прысвойвае зьменнай \"%1\" значэньні ад пачатковага да канчатковага, з увагай на зададзены крок, і выконвае абраныя блёкі.";
...
Blockly.Msg["LOGIC_COMPARE_EQ_ARIA"] = "роўна";
Blockly.Msg["LOGIC_COMPARE_GTE_ARIA"] = "больш або роўна";
Blockly.Msg["LOGIC_COMPARE_GT_ARIA"] = "больш за";
Blockly.Msg["LOGIC_COMPARE_HELPURL"] = "https://be-tarask.wikipedia.org/wiki/Няроўнасьць";
Blockly.Msg["LOGIC_COMPARE_LTE_ARIA"] = "менш або роўна";
Blockly.Msg["LOGIC_COMPARE_LT_ARIA"] = "меней за";
Blockly.Msg["LOGIC_COMPARE_NEQ_ARIA"] = "ня роўна";
...
Blockly.Msg["MATH_DIVISION_SYMBOL_ARIA"] = "падзяліць на";
...
Blockly.Msg["MATH_SUBTRACTION_SYMBOL_ARIA"] = "мінус";
...
Blockly.Msg["RENAME_VARIABLE"] = "Перайменаваць зьменную „%1“";
