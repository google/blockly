...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">avantiar</span><span id="Maze_turnLeft">girar a sinistra</span><span id="Maze_turnRight">girar a dextra</span><span id="Maze_doCode">face</span><span id="Maze_elseCode">si non</span><span id="Maze_helpIfElse">Un bloco "si/si non" face o le prime cosa o le altere.</span><span id="Maze_pathAhead">si cammino avante</span><span id="Maze_pathLeft">si cammino a sinistra</span><span id="Maze_pathRight">si cammino a dextra</span><span id="Maze_repeatUntil">repeter usque a</span><span id="Maze_moveForwardTooltip">Face le jocator avantiar un spatio.</span><span id="Maze_turnTooltip">Gira le jocator a sinistra o a dextra de 90 grados.</span><span id="Maze_ifTooltip">Si existe un cammino in le direction specificate, alora face certe actiones.</span><span id="Maze_ifelseTooltip">Si existe un cammino in le direction specificate, alora face le prime bloco de actiones. Si non, face le secunde bloco de actiones.</span><span id="Maze_whileTooltip">Repeter le actiones continite usque al puncto de fin.</span><span id="Maze_capacity0">Te resta %0 blocos.</span><span id="Maze_capacity1">Te resta %1 bloco.</span><span id="Maze_capacity2">Te resta %2 blocos.</span><span id="Maze_nextLevel">Felicitationes! Es tu preste pro le nivello %1?</span><span id="Maze_finalLevel">Felicitationes! Tu ha resolvite le nivello final.</span></div>';
};
