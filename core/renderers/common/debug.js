...
const isDebuggerEnabled = function() {
  console.warn(
      'Blockly.blockRendering.isDebuggerEnabled() functionality has been removed. Please see https://www.npmjs.com/package/@blockly/dev-tools for more information on how you can use the debug renderer.');
  return useDebugger;
};
...
const startDebugger = function() {
  console.warn(
      'Blockly.blockRendering.startDebugger() functionality has been removed. Please see https://www.npmjs.com/package/@blockly/dev-tools for more information on how you can use the debug renderer.');
  useDebugger = true;
};
...
const stopDebugger = function() {
  console.warn(
      'Blockly.blockRendering.stopDebugger() functionality has been removed. Please see https://www.npmjs.com/package/@blockly/dev-tools for more information on how you can use the debug renderer.');
  useDebugger = false;
};
