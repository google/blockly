...
PHP['math_number'] = function(block) {
  ...
  const order = code >= 0 ? PHP.ORDER_ATOMIC :
              PHP.ORDER_UNARY_NEGATION;
  if (code === Infinity) {
    code = 'INF';
...
PHP['math_single'] = function(block) {
  ...
  if (operator === 'NEG') {
    ...
    arg = PHP.valueToCode(block, 'NUM',
        PHP.ORDER_UNARY_NEGATION) || '0';
    if (arg[0] === '-') {
...
PHP['math_number_property'] = function(block) {
  ...
  const number_to_check = PHP.valueToCode(block, 'NUMBER_TO_CHECK',
      PHP.ORDER_MODULUS) || '0';
...
PHP['math_change'] = function(block) {
  ...
  const argument0 = PHP.valueToCode(block, 'DELTA',
...
PHP['math_on_list'] = function(block) {
  ...
  switch (func) {
    case 'SUM':
      list = PHP.valueToCode(block, 'LIST',
...
PHP['math_modulo'] = function(block) {
  ...
  const argument0 = PHP.valueToCode(block, 'DIVIDEND',
      PHP.ORDER_MODULUS) || '0';
  const argument1 = PHP.valueToCode(block, 'DIVISOR',
      PHP.ORDER_MODULUS) || '0';
...
PHP['math_constrain'] = function(block) {
  ...
  const argument0 = PHP.valueToCode(block, 'VALUE',
      PHP.ORDER_NONE) || '0';
  const argument1 = PHP.valueToCode(block, 'LOW',
      PHP.ORDER_NONE) || '0';
  const argument2 = PHP.valueToCode(block, 'HIGH',
      PHP.ORDER_NONE) || 'Infinity';
...
PHP['math_atan2'] = function(block) {
  ...
  const argument0 = PHP.valueToCode(block, 'X',
      PHP.ORDER_NONE) || '0';
  const argument1 = PHP.valueToCode(block, 'Y',
      PHP.ORDER_NONE) || '0';
