...
appsIndex.start = function(opt_data, opt_ignored, opt_ijData) {
  return appsIndex.messages(null, null, opt_ijData) + '<table><tr><td><h1><span id="title">โปรแกรมประยุกต์ Blockly</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>Blockly คือระบบการเขียนโปรแกรมด้วยภาพ ด้านล่างนี้คือตัวอย่างโปรแกรมประยุกต์ที่ใช้ Blockly</td></tr></table><table><tr><td><a href="maze/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/maze.png" height=80 width=100></a></td><td><div><a href="maze/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">เขาวงกต</a></div><div>ใช้ Blockly แก้ปัญหาเขาวงกต</div></td></tr><tr><td><a href="turtle/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/turtle.png" height=80 width=100></a></td><td><div><a href="turtle/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">เต่าสร้างภาพ</a></div><div>ใช้ Blockly วาดภาพ</div></td></tr><tr><td><a href="graph/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/graph.png" height=80 width=100></a></td><td><div><a href="graph/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">ระบบคำนวณเชิงกราฟ</a></div><div>ใช้ Blockly สร้างกราฟ</div></td></tr><tr><td><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">เขียนโปรแกรม</a></div><div>เขียนโปรแกรมทั่วไป และสามารถแปลง Blockly ให้เป็นภาษา JavaScript, Python, Dart และ XML ได้</div></td></tr><tr><td><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/plane.png" height=80 width=100></a></td><td><div><a href="plane/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">ระบบคำนวณที่นั่งบนเครื่องบิน</a></div><div>แก้ปัญหาทางคณิตศาสตร์ด้วยการสร้างสูตรคำนวณที่มีหนึ่งหรือสองตัวแปร</div></td></tr><tr><td><a href="blockfactory/index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"><img src="index/blockfactory.png" height=80 width=100></a></td><td><div><a href="blockfactory/index.html">โรงงานผลิตบล็อก</a></div><div>สร้างบล็อกของคุณเองด้วย Blockly</div></td></tr></table><p><span id="footer_prefix"></span><a href="https://developers.google.com/blockly/">developers.google.com/blockly</a><span id="footer_suffix"></span>';
};
