...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Maze_moveForward">Menj előre</span><span id="Maze_turnLeft">Fordulj balra</span><span id="Maze_turnRight">Fordulj jobbra</span><span id="Maze_doCode">végrehajt</span><span id="Maze_elseCode">egyébként</span><span id="Maze_helpIfElse">A Ha-egyébként feltétel esetén vagy az egyik, vagy a másik utasítás-csoport kerül végrehajtásra.</span><span id="Maze_pathAhead">Ha szabad az út előtted</span><span id="Maze_pathLeft">Ha szabad az út balra</span><span id="Maze_pathRight">Ha szabad az út jobbra</span><span id="Maze_repeatUntil">Ismételd amíg eljutː</span><span id="Maze_moveForwardTooltip">A figura előre lép egy mezőt.</span><span id="Maze_turnTooltip">A figura 90 fokot fordul balra, vagy jobbra.</span><span id="Maze_ifTooltip">Ha szabad az út a megadott irányban, akkor végrehajtja az utasításokat.</span><span id="Maze_ifelseTooltip">Ha szabad az út a megadott irányban, akkor végrehajtja az első blokkban megadott utasításokat. Egyébként a második blokkban szereplő utasításokat hajtja végre.</span><span id="Maze_whileTooltip">A beágyazott utasításokat hajtja végre a cél eléréséig.</span><span id="Maze_capacity0">Nem használhatsz fel több blokkot.</span><span id="Maze_capacity1">Még %1 blokkot használhatsz fel.</span><span id="Maze_capacity2">Még %2 blokkot használhatsz fel.</span><span id="Maze_nextLevel">Gratulálok! Kész vagy megoldani a(z) %1. szintet?</span><span id="Maze_finalLevel">Gratulálok! Sikeresen megoldottad az utolsó szintet.</span></div>';
};
