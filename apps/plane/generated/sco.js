...
planepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Plane_rows">Rows: %1</span><span id="Plane_getRows">rows (%1)</span><span id="Plane_rows1">1st claiss rows: %1</span><span id="Plane_getRows1">1st claiss rows (%1)</span><span id="Plane_rows2">2nt claiss rows: %1</span><span id="Plane_getRows2">2nt claiss rows (%1)</span><span id="Plane_seats">Seats: %1</span><span id="Plane_placeholder">?</span><span id="Plane_setSeats">seats =</span></div>';
};


planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = planepage.messages(null, null, opt_ijData) + '<table width="100%"><tr><td><h1><span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">Blockly (Blocklie)</a> : Airplane Seat Calculater</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    case 1:
      output += 'Aen airplane haes ae nummer o rows o passenger seats.  Ilka row contains fower seats.';
      break;
    case 2:
      output += 'Aen airplane haes twa seats in the flicht deck (fer the pilot n co-pilot), n ae nummer o rows o passenger seats.  Ilka row contains fower seats.';
      break;
    case 3:
      output += 'Aen airplane haes twa seats oan the flicht deck (fer the pilot n co-pilot), n ae nummer o rows o 1st claiss n 2nt claiss passenger seats.  Ilka 1st claiss row contains fower seats. Ilka 2nt claiss row contains five seats.';
      break;
  }
  output += '</p><p>Big ae formula (ablo) that calculates the total nummer o seats oan the airplane aes the rows ar chynged (abuin).</p><script type="text/javascript" src="../../blockly_compressed.js"><\/script><script type="text/javascript" src="../../blocks_compressed.js"><\/script><script type="text/javascript" src="../../javascript_compressed.js"><\/script><script type="text/javascript" src="../../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script>' + planepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>';
  return output;
};
